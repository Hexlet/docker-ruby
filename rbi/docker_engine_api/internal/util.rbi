      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            DockerEngineAPI::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: DockerEngineAPI::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: DockerEngineAPI::Internal::Util::ParsedUri,
            rhs: DockerEngineAPI::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[DockerEngineAPI::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  DockerEngineAPI::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
