...
module DockerEngineAPI
  module Models
    class Version < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngineAPI::Version, DockerEngineAPI::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(T::Array[DockerEngineAPI::Version::Component])) }
      attr_reader :components

      sig do
        params(
          components: T::Array[DockerEngineAPI::Version::Component::OrHash]
        ).void
      end
      ...
      sig { returns(T.nilable(DockerEngineAPI::Version::Platform)) }
      attr_reader :platform

      sig { params(platform: DockerEngineAPI::Version::Platform::OrHash).void }
      ...
      sig do
        params(
          ...
          os: String,
          platform: DockerEngineAPI::Version::Platform::OrHash,
          version: String
        ...
        override.returns(
          {
            ...
            arch: String,
            build_time: String,
            components: T::Array[DockerEngineAPI::Version::Component],
            experimental: T::Boolean,
            git_commit: String,
            go_version: String,
            kernel_version: String,
            min_api_version: String,
            os: String,
            platform: DockerEngineAPI::Version::Platform,
            version: String
          }
        )
      end
      ...
      class Component < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Version::Component,
      ...
      class Platform < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Version::Platform,
              DockerEngineAPI::Internal::AnyHash
            )
          end
