...
module DockerEngineAPI
  module Models
    class Inspect < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngineAPI::Inspect, DockerEngineAPI::Internal::AnyHash)
        end
      ...
      sig { returns(DockerEngineAPI::Inspect::Descriptor) }
      attr_reader :descriptor

      sig do
        params(descriptor: DockerEngineAPI::Inspect::Descriptor::OrHash).void
      end
      attr_writer :descriptor

      # An array containing all platforms supported by the image.
      sig { returns(T::Array[T.nilable(DockerEngineAPI::Inspect::Platform)]) }
      ...
      sig do
        params(
          descriptor: DockerEngineAPI::Inspect::Descriptor::OrHash,
          platforms:
            T::Array[T.nilable(DockerEngineAPI::Inspect::Platform::OrHash)]
        ...
        override.returns(
          {
            ...
            platforms: T::Array[T.nilable(DockerEngineAPI::Inspect::Platform)]
          }
        )
      end
      def to_hash
      ...
      class Descriptor < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Inspect::Descriptor,
        ...
        sig do
          returns(T.nilable(DockerEngineAPI::Inspect::Descriptor::Platform))
        end
        ...
        sig do
          params(
            platform:
              T.nilable(DockerEngineAPI::Inspect::Descriptor::Platform::OrHash)
          ).void
        end
          ...
          override.returns(
            {
              ...
              media_type: String,
              platform:
                T.nilable(DockerEngineAPI::Inspect::Descriptor::Platform),
              size: Integer,
              urls: T.nilable(T::Array[String])
            }
          )
        ...
        class Platform < DockerEngineAPI::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                DockerEngineAPI::Inspect::Descriptor::Platform,
                DockerEngineAPI::Internal::AnyHash
              )
            end
      ...
      class Platform < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Inspect::Platform,
              DockerEngineAPI::Internal::AnyHash
            )
          end
