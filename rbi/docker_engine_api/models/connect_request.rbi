  ...
  module Models
    class ConnectRequest < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            DockerEngineAPI::ConnectRequest,
      ...
      sig do
        returns(T.nilable(DockerEngineAPI::ConnectRequest::EndpointConfig))
      end
      ...
      sig do
        params(
          endpoint_config:
            DockerEngineAPI::ConnectRequest::EndpointConfig::OrHash
        ).void
      end
      ...
      sig do
        override.returns(
          {
            container: String,
            endpoint_config: DockerEngineAPI::ConnectRequest::EndpointConfig
          }
        )
      end
      def to_hash
      ...
      class EndpointConfig < DockerEngineAPI::Internal::Type::BaseModel
        ...
        sig do
          params(
            ipam_config:
              T.nilable(
                DockerEngineAPI::ConnectRequest::EndpointConfig::IpamConfig::OrHash
              )
          ).void
        end
