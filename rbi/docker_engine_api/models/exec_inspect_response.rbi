  ...
  module Models
    class ExecInspectResponse < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            DockerEngineAPI::Models::ExecInspectResponse,
      ...
      sig { returns(T.nilable(DockerEngineAPI::InspectResponse)) }
      attr_reader :process_config

      sig do
        params(process_config: DockerEngineAPI::InspectResponse::OrHash).void
      end
      ...
      sig do
        params(
          ...
          pid: Integer,
          process_config: DockerEngineAPI::InspectResponse::OrHash,
          running: T::Boolean
        ...
        override.returns(
          {
            ...
            open_stdout: T::Boolean,
            pid: Integer,
            process_config: DockerEngineAPI::InspectResponse,
            running: T::Boolean
          }
        )
      end
