  ...
  module Models
    class ImageBuildParams < DockerEngineAPI::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            DockerEngineAPI::ImageBuildParams,
      ...
      sig do
        returns(T.nilable(DockerEngineAPI::ImageBuildParams::Version::OrSymbol))
      end
      attr_reader :version
      ...
      module Version
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, DockerEngineAPI::ImageBuildParams::Version)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        VERSION_1 =
          T.let(:"1", DockerEngineAPI::ImageBuildParams::Version::TaggedSymbol)
        VERSION_2 =
          T.let(:"2", DockerEngineAPI::ImageBuildParams::Version::TaggedSymbol)

        sig do
          override.returns(
            T::Array[DockerEngineAPI::ImageBuildParams::Version::TaggedSymbol]
          )
        end
        def self.values
        end
