...
module DockerEngineAPI
  module Models
    class SwarmAPI < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngineAPI::SwarmAPI, DockerEngineAPI::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(DockerEngineAPI::SwarmAPI::JoinTokens)) }
      attr_reader :join_tokens

      sig do
        params(join_tokens: DockerEngineAPI::SwarmAPI::JoinTokens::OrHash).void
      end
      ...
      # certificate.
      sig { returns(T.nilable(DockerEngineAPI::SwarmAPI::TlsInfo)) }
      attr_reader :tls_info

      sig { params(tls_info: DockerEngineAPI::SwarmAPI::TlsInfo::OrHash).void }
      ...
      sig { returns(T.nilable(DockerEngineAPI::SwarmAPI::Version)) }
      attr_reader :version

      sig { params(version: DockerEngineAPI::SwarmAPI::Version::OrHash).void }
      attr_writer :version
      ...
      sig do
        params(
          ...
          id: String,
          join_tokens: DockerEngineAPI::SwarmAPI::JoinTokens::OrHash,
          root_rotation_in_progress: T::Boolean,
          spec: DockerEngineAPI::Spec::OrHash,
          subnet_size: Integer,
          tls_info: DockerEngineAPI::SwarmAPI::TlsInfo::OrHash,
          updated_at: String,
          version: DockerEngineAPI::SwarmAPI::Version::OrHash
        ...
        override.returns(
          {
            ...
            default_addr_pool: T::Array[String],
            id: String,
            join_tokens: DockerEngineAPI::SwarmAPI::JoinTokens,
            root_rotation_in_progress: T::Boolean,
            spec: DockerEngineAPI::Spec,
            subnet_size: Integer,
            tls_info: DockerEngineAPI::SwarmAPI::TlsInfo,
            updated_at: String,
            version: DockerEngineAPI::SwarmAPI::Version
          }
        )
      end
      def to_hash
      ...
      class JoinTokens < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::SwarmAPI::JoinTokens,
      ...
      class TlsInfo < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::SwarmAPI::TlsInfo,
              DockerEngineAPI::Internal::AnyHash
            )
          end
      ...
      class Version < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::SwarmAPI::Version,
              DockerEngineAPI::Internal::AnyHash
            )
          end
