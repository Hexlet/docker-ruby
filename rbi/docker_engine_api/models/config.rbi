...
module DockerEngineAPI
  module Models
    class Config < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngineAPI::Config, DockerEngineAPI::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(DockerEngineAPI::Config::Healthcheck)) }
      attr_reader :healthcheck

      sig do
        params(healthcheck: DockerEngineAPI::Config::Healthcheck::OrHash).void
      end
        ...
        override.returns(
          {
            ...
            env: T::Array[String],
            exposed_ports: T.nilable(T::Hash[Symbol, T.anything]),
            healthcheck: DockerEngineAPI::Config::Healthcheck,
            hostname: String,
            image: String,
            labels: T::Hash[Symbol, String],
            network_disabled: T.nilable(T::Boolean),
      ...
      class Healthcheck < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Config::Healthcheck,
