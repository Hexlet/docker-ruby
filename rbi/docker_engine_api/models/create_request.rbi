...
module DockerEngineAPI
  module Models
    class CreateRequest < DockerEngineAPI::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(DockerEngineAPI::CreateRequest::ClusterVolumeSpec))
      end
      ...
      sig do
        params(
          cluster_volume_spec:
            DockerEngineAPI::CreateRequest::ClusterVolumeSpec::OrHash
        ).void
      end
      ...
      class ClusterVolumeSpec < DockerEngineAPI::Internal::Type::BaseModel
        ...
        sig do
          params(
            access_mode:
              DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::OrHash
          ).void
        end
        ...
        class AccessMode < DockerEngineAPI::Internal::Type::BaseModel
          ...
          sig do
            params(
              accessibility_requirements:
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Availability::OrSymbol
              )
            )
          end
          ...
          sig do
            params(
              capacity_range:
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Scope::OrSymbol
              )
            )
          end
          attr_reader :scope
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Secret
                ]
              )
            )
          end
          ...
          sig do
            params(
              secrets:
                T::Array[
                  DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Secret::OrHash
                ]
            ).void
          end
          attr_writer :secrets
          ...
          sig do
            returns(
              T.nilable(
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing::OrSymbol
              )
            )
          end
          attr_reader :sharing
          ...
          module Availability
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Availability
                )
              end
            ...
            ACTIVE =
              T.let(
                :active,
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Availability::TaggedSymbol
              )
            PAUSE =
              T.let(
                :pause,
          ...
          module Scope
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Scope
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            SINGLE =
              T.let(
                :single,
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Scope::TaggedSymbol
              )
            MULTI =
              T.let(
                :multi,
          ...
          module Sharing
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NONE =
              T.let(
                :none,
                DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing::TaggedSymbol
              )
            READONLY =
              T.let(
                :readonly,
