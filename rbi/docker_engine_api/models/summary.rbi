...
module DockerEngineAPI
  module Models
    class Summary < DockerEngineAPI::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngineAPI::Summary, DockerEngineAPI::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(DockerEngineAPI::Summary::Health)) }
      attr_reader :health

      sig { params(health: DockerEngineAPI::Summary::Health::OrHash).void }
      attr_writer :health
      ...
      # "inspect" response.
      sig { returns(T.nilable(DockerEngineAPI::Summary::HostConfig)) }
      attr_reader :host_config

      sig do
        params(host_config: DockerEngineAPI::Summary::HostConfig::OrHash).void
      end
      ...
      sig do
        returns(T.nilable(DockerEngineAPI::Summary::ImageManifestDescriptor))
      end
      ...
      sig do
        params(
          image_manifest_descriptor:
            DockerEngineAPI::Summary::ImageManifestDescriptor::OrHash
        ).void
      end
      ...
      sig { returns(T.nilable(T::Array[DockerEngineAPI::Summary::Mount])) }
      attr_reader :mounts

      sig do
        params(mounts: T::Array[DockerEngineAPI::Summary::Mount::OrHash]).void
      end
      attr_writer :mounts
      ...
      sig { returns(T.nilable(DockerEngineAPI::Summary::NetworkSettings)) }
      attr_reader :network_settings

      sig do
        params(
          network_settings: DockerEngineAPI::Summary::NetworkSettings::OrHash
        ).void
      end
      attr_writer :network_settings

      # Port-mappings for the container.
      sig { returns(T.nilable(T::Array[DockerEngineAPI::Summary::Port])) }
      attr_reader :ports

      sig do
        params(ports: T::Array[DockerEngineAPI::Summary::Port::OrHash]).void
      end
      attr_writer :ports
      ...
      sig { returns(T.nilable(DockerEngineAPI::Summary::State::TaggedSymbol)) }
      attr_reader :state

      sig { params(state: DockerEngineAPI::Summary::State::OrSymbol).void }
      attr_writer :state
      ...
      sig do
        params(
          command: String,
          created: Integer,
          health: DockerEngineAPI::Summary::Health::OrHash,
          host_config: DockerEngineAPI::Summary::HostConfig::OrHash,
          id: String,
          image: String,
          image_id: String,
          image_manifest_descriptor:
          ...
          mounts: T::Array[DockerEngineAPI::Summary::Mount::OrHash],
          names: T::Array[String],
          network_settings: DockerEngineAPI::Summary::NetworkSettings::OrHash,
          ports: T::Array[DockerEngineAPI::Summary::Port::OrHash],
          size_root_fs: T.nilable(Integer),
          size_rw: T.nilable(Integer),
          state: DockerEngineAPI::Summary::State::OrSymbol,
          status: String
        ...
        override.returns(
          {
            command: String,
            created: Integer,
            health: DockerEngineAPI::Summary::Health,
            host_config: DockerEngineAPI::Summary::HostConfig,
            id: String,
            image: String,
            image_id: String,
            image_manifest_descriptor:
            ...
            labels: T::Hash[Symbol, String],
            mounts: T::Array[DockerEngineAPI::Summary::Mount],
            names: T::Array[String],
            network_settings: DockerEngineAPI::Summary::NetworkSettings,
            ports: T::Array[DockerEngineAPI::Summary::Port],
            size_root_fs: T.nilable(Integer),
            size_rw: T.nilable(Integer),
            state: DockerEngineAPI::Summary::State::TaggedSymbol,
            status: String
          }
        )
      end
      ...
      class Health < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Summary::Health,
        ...
        sig do
          returns(
            T.nilable(DockerEngineAPI::Summary::Health::Status::TaggedSymbol)
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: DockerEngineAPI::Summary::Health::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          override.returns(
            {
              failing_streak: Integer,
              status: DockerEngineAPI::Summary::Health::Status::TaggedSymbol
            }
          )
        end
        def to_hash
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, DockerEngineAPI::Summary::Health::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          NONE =
            T.let(:none, DockerEngineAPI::Summary::Health::Status::TaggedSymbol)
          STARTING =
            T.let(
              :starting,
              DockerEngineAPI::Summary::Health::Status::TaggedSymbol
            )
          HEALTHY =
            T.let(
              :healthy,
          ...
          sig do
            override.returns(
              T::Array[DockerEngineAPI::Summary::Health::Status::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      class HostConfig < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Summary::HostConfig,
              DockerEngineAPI::Internal::AnyHash
            )
          end
      ...
      class ImageManifestDescriptor < DockerEngineAPI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              DockerEngineAPI::Summary::ImageManifestDescriptor::Platform
            )
          )
        end
        ...
        sig do
          params(
            platform:
              T.nilable(
                DockerEngineAPI::Summary::ImageManifestDescriptor::Platform::OrHash
              )
          ).void
        end
      ...
      class Mount < DockerEngineAPI::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)
          )
        end
        attr_reader :type

        sig do
          params(type: DockerEngineAPI::Summary::Mount::Type::OrSymbol).void
        end
        attr_writer :type
        ...
        sig do
          params(
            ...
            rw: T::Boolean,
            source: String,
            type: DockerEngineAPI::Summary::Mount::Type::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # Destination is the path relative to the container root (`/`) where the `Source`
          ...
          override.returns(
            {
              ...
              rw: T::Boolean,
              source: String,
              type: DockerEngineAPI::Summary::Mount::Type::TaggedSymbol
            }
          )
        end
        def to_hash
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, DockerEngineAPI::Summary::Mount::Type)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          BIND =
            T.let(:bind, DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)
          CLUSTER =
            T.let(:cluster, DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)
          IMAGE =
            T.let(:image, DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)
          NPIPE =
            T.let(:npipe, DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)
          TMPFS =
            T.let(:tmpfs, DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)
          VOLUME =
            T.let(:volume, DockerEngineAPI::Summary::Mount::Type::TaggedSymbol)

          sig do
            override.returns(
              T::Array[DockerEngineAPI::Summary::Mount::Type::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      class NetworkSettings < DockerEngineAPI::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngineAPI::Summary::NetworkSettings,
              DockerEngineAPI::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Hash[
                Symbol,
                DockerEngineAPI::Summary::NetworkSettings::Network
              ]
            )
          )
        end
        ...
        sig do
          params(
            networks:
              T::Hash[
                Symbol,
                DockerEngineAPI::Summary::NetworkSettings::Network::OrHash
              ]
          ).void
        end
        ...
        class Network < DockerEngineAPI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                DockerEngineAPI::Summary::NetworkSettings::Network::IpamConfig
              )
            )
          end
          ...
          sig do
            params(
              ipam_config:
                T.nilable(
                  DockerEngineAPI::Summary::NetworkSettings::Network::IpamConfig::OrHash
                )
            ).void
          end
      ...
      class Port < DockerEngineAPI::Internal::Type::BaseModel
        ...
        sig { returns(DockerEngineAPI::Summary::Port::Type::TaggedSymbol) }
        attr_accessor :type
        ...
        sig do
          params(
            ...
            type: DockerEngineAPI::Summary::Port::Type::OrSymbol,
            ip: String,
            public_port: Integer
          ).returns(T.attached_class)
        end
        ...
        sig do
          override.returns(
            {
              private_port: Integer,
              type: DockerEngineAPI::Summary::Port::Type::TaggedSymbol,
              ip: String,
              public_port: Integer
            }
          )
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, DockerEngineAPI::Summary::Port::Type) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          TCP = T.let(:tcp, DockerEngineAPI::Summary::Port::Type::TaggedSymbol)
          UDP = T.let(:udp, DockerEngineAPI::Summary::Port::Type::TaggedSymbol)
          SCTP =
            T.let(:sctp, DockerEngineAPI::Summary::Port::Type::TaggedSymbol)

          sig do
            override.returns(
              T::Array[DockerEngineAPI::Summary::Port::Type::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      module State
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, DockerEngineAPI::Summary::State) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        CREATED = T.let(:created, DockerEngineAPI::Summary::State::TaggedSymbol)
        RUNNING = T.let(:running, DockerEngineAPI::Summary::State::TaggedSymbol)
        PAUSED = T.let(:paused, DockerEngineAPI::Summary::State::TaggedSymbol)
        RESTARTING =
          T.let(:restarting, DockerEngineAPI::Summary::State::TaggedSymbol)
        EXITED = T.let(:exited, DockerEngineAPI::Summary::State::TaggedSymbol)
        REMOVING =
          T.let(:removing, DockerEngineAPI::Summary::State::TaggedSymbol)
        DEAD = T.let(:dead, DockerEngineAPI::Summary::State::TaggedSymbol)

        sig do
          override.returns(
            T::Array[DockerEngineAPI::Summary::State::TaggedSymbol]
          )
        end
        def self.values
        end
