  ...
  module Resources
    class System
      ...
      sig do
        ...
        ).returns(DockerEngineAPI::Models::SystemDataUsageResponse)
      end
      def data_usage(
      ...
      sig do
        params(
          ...
          until_: String,
          request_options: DockerEngineAPI::RequestOptions::OrHash
        ).returns(DockerEngineAPI::Models::SystemEventsResponse)
      end
      def events(
      ...
      sig do
        params(
          request_options: DockerEngineAPI::RequestOptions::OrHash
        ).returns(DockerEngineAPI::Version)
      end
