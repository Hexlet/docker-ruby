  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(DockerEngine::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              DockerEngine::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: DockerEngine::Internal::Type::Converter::Input,
              value: T.anything,
              state: DockerEngine::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
