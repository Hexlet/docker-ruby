...
module DockerEngine
  module Models
    class Version < DockerEngine::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngine::Version, DockerEngine::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(T::Array[DockerEngine::Version::Component])) }
      attr_reader :components

      sig do
        params(
          components: T::Array[DockerEngine::Version::Component::OrHash]
        ).void
      end
      ...
      sig { returns(T.nilable(DockerEngine::Version::Platform)) }
      attr_reader :platform

      sig { params(platform: DockerEngine::Version::Platform::OrHash).void }
      ...
      sig do
        params(
          ...
          os: String,
          platform: DockerEngine::Version::Platform::OrHash,
          version: String
        ...
        override.returns(
          {
            ...
            arch: String,
            build_time: String,
            components: T::Array[DockerEngine::Version::Component],
            experimental: T::Boolean,
            git_commit: String,
            go_version: String,
            kernel_version: String,
            min_api_version: String,
            os: String,
            platform: DockerEngine::Version::Platform,
            version: String
          }
        )
      end
      ...
      class Component < DockerEngine::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              DockerEngine::Version::Component,
