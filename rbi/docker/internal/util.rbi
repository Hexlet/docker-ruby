      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Docker::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Docker::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: Docker::Internal::Util::ParsedUri,
            rhs: Docker::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Docker::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Docker::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
