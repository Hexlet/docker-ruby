...
module Docker
  module Models
    class Network < Docker::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Docker::Network, Docker::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Docker::Network::ConfigFrom)) }
      attr_reader :config_from

      sig { params(config_from: Docker::Network::ConfigFrom::OrHash).void }
      ...
      sig { returns(T.nilable(Docker::Network::Ipam)) }
      attr_reader :ipam

      sig { params(ipam: Docker::Network::Ipam::OrHash).void }
      attr_writer :ipam
      ...
      sig { returns(T.nilable(T::Array[Docker::Network::Peer])) }
      attr_reader :peers

      sig { params(peers: T::Array[Docker::Network::Peer::OrHash]).void }
      attr_writer :peers
      ...
      sig do
        params(
          ...
          config_from: Docker::Network::ConfigFrom::OrHash,
          ...
          ingress: T::Boolean,
          internal: T::Boolean,
          ipam: Docker::Network::Ipam::OrHash,
          labels: T::Hash[Symbol, String],
          name: String,
          options: T::Hash[Symbol, String],
          peers: T::Array[Docker::Network::Peer::OrHash],
          scope: String
        ...
        override.returns(
          {
            ...
            name: String,
            options: T::Hash[Symbol, String],
            peers: T::Array[Docker::Network::Peer],
            scope: String
          }
        )
      end
      ...
      class ConfigFrom < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Network::ConfigFrom, Docker::Internal::AnyHash)
          end
      ...
      class Ipam < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Network::Ipam, Docker::Internal::AnyHash)
          end
        ...
        # ```
        sig { returns(T.nilable(T::Array[Docker::Network::Ipam::Config])) }
        attr_reader :config

        sig do
          params(config: T::Array[Docker::Network::Ipam::Config::OrHash]).void
        end
        attr_writer :config
        ...
        sig do
          params(
            config: T::Array[Docker::Network::Ipam::Config::OrHash],
            driver: String,
            options: T::Hash[Symbol, String]
          ).returns(T.attached_class)
        end
        ...
        sig do
          override.returns(
            {
              config: T::Array[Docker::Network::Ipam::Config],
              driver: String,
              options: T::Hash[Symbol, String]
            }
          )
        ...
        class Config < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(Docker::Network::Ipam::Config, Docker::Internal::AnyHash)
            end
      ...
      class Peer < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Network::Peer, Docker::Internal::AnyHash)
          end
