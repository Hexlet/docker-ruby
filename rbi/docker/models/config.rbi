...
module Docker
  module Models
    class Config < Docker::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Docker::Config, Docker::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Docker::Config::Healthcheck)) }
      attr_reader :healthcheck

      sig { params(healthcheck: Docker::Config::Healthcheck::OrHash).void }
      ...
      sig do
        params(
          ...
          healthcheck: Docker::Config::Healthcheck::OrHash,
          hostname: String,
          image: String,
        ...
        override.returns(
          {
            ...
            env: T::Array[String],
            exposed_ports: T.nilable(T::Hash[Symbol, T.anything]),
            healthcheck: Docker::Config::Healthcheck,
            hostname: String,
            image: String,
            labels: T::Hash[Symbol, String],
            network_disabled: T.nilable(T::Boolean),
      ...
      class Healthcheck < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Config::Healthcheck, Docker::Internal::AnyHash)
          end
