...
module Docker
  module Models
    class SystemVersionResponse < Docker::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Docker::Models::SystemVersionResponse::Component])
        )
      end
      ...
      sig do
        params(
          components:
            T::Array[Docker::Models::SystemVersionResponse::Component::OrHash]
        ).void
      end
      ...
      sig do
        returns(T.nilable(Docker::Models::SystemVersionResponse::Platform))
      end
      attr_reader :platform

      sig do
        params(
          platform: Docker::Models::SystemVersionResponse::Platform::OrHash
        ).void
      end
        ...
        override.returns(
          {
            ...
            build_time: String,
            components:
              T::Array[Docker::Models::SystemVersionResponse::Component],
            experimental: T::Boolean,
            git_commit: String,
            go_version: String,
            kernel_version: String,
            min_api_version: String,
            os: String,
            platform: Docker::Models::SystemVersionResponse::Platform,
            version: String
          }
        )
      end
      ...
      class Component < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Docker::Models::SystemVersionResponse::Component,
              Docker::Internal::AnyHash
            )
          end
      ...
      class Platform < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Docker::Models::SystemVersionResponse::Platform,
              Docker::Internal::AnyHash
            )
          end
