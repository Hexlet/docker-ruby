...
module Docker
  module Models
    class Summary < Docker::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Docker::Summary, Docker::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Docker::Summary::Health)) }
      attr_reader :health

      sig { params(health: Docker::Summary::Health::OrHash).void }
      attr_writer :health
      ...
      # "inspect" response.
      sig { returns(T.nilable(Docker::Summary::HostConfig)) }
      attr_reader :host_config

      sig { params(host_config: Docker::Summary::HostConfig::OrHash).void }
      ...
      sig { returns(T.nilable(Docker::Summary::ImageManifestDescriptor)) }
      attr_reader :image_manifest_descriptor

      sig do
        params(
          image_manifest_descriptor:
            Docker::Summary::ImageManifestDescriptor::OrHash
        ).void
      end
      ...
      sig { returns(T.nilable(T::Array[Docker::Summary::Mount])) }
      attr_reader :mounts

      sig { params(mounts: T::Array[Docker::Summary::Mount::OrHash]).void }
      attr_writer :mounts
      ...
      sig { returns(T.nilable(Docker::Summary::NetworkSettings)) }
      attr_reader :network_settings

      sig do
        params(network_settings: Docker::Summary::NetworkSettings::OrHash).void
      end
      attr_writer :network_settings

      # Port-mappings for the container.
      sig { returns(T.nilable(T::Array[Docker::Summary::Port])) }
      attr_reader :ports

      sig { params(ports: T::Array[Docker::Summary::Port::OrHash]).void }
      attr_writer :ports
      ...
      sig { returns(T.nilable(Docker::Summary::State::TaggedSymbol)) }
      attr_reader :state

      sig { params(state: Docker::Summary::State::OrSymbol).void }
      attr_writer :state
      ...
      sig do
        params(
          command: String,
          created: Integer,
          health: Docker::Summary::Health::OrHash,
          host_config: Docker::Summary::HostConfig::OrHash,
          id: String,
          image: String,
          image_id: String,
          image_manifest_descriptor:
          ...
          mounts: T::Array[Docker::Summary::Mount::OrHash],
          names: T::Array[String],
          network_settings: Docker::Summary::NetworkSettings::OrHash,
          ports: T::Array[Docker::Summary::Port::OrHash],
          size_root_fs: T.nilable(Integer),
          size_rw: T.nilable(Integer),
          state: Docker::Summary::State::OrSymbol,
          status: String
        ...
        override.returns(
          {
            command: String,
            created: Integer,
            health: Docker::Summary::Health,
            host_config: Docker::Summary::HostConfig,
            id: String,
            image: String,
            image_id: String,
            image_manifest_descriptor: Docker::Summary::ImageManifestDescriptor,
            labels: T::Hash[Symbol, String],
            mounts: T::Array[Docker::Summary::Mount],
            names: T::Array[String],
            network_settings: Docker::Summary::NetworkSettings,
            ports: T::Array[Docker::Summary::Port],
            size_root_fs: T.nilable(Integer),
            size_rw: T.nilable(Integer),
            state: Docker::Summary::State::TaggedSymbol,
            status: String
          }
        )
      end
      ...
      class Health < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Summary::Health, Docker::Internal::AnyHash)
          end
        ...
        sig do
          returns(T.nilable(Docker::Summary::Health::Status::TaggedSymbol))
        end
        attr_reader :status

        sig { params(status: Docker::Summary::Health::Status::OrSymbol).void }
        attr_writer :status
        ...
        sig do
          params(
            ...
            status: Docker::Summary::Health::Status::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # FailingStreak is the number of consecutive failures
        ...
        sig do
          override.returns(
            {
              failing_streak: Integer,
              status: Docker::Summary::Health::Status::TaggedSymbol
            }
          )
        end
        def to_hash
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Docker::Summary::Health::Status) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          NONE = T.let(:none, Docker::Summary::Health::Status::TaggedSymbol)
          STARTING =
            T.let(:starting, Docker::Summary::Health::Status::TaggedSymbol)
          HEALTHY =
            T.let(:healthy, Docker::Summary::Health::Status::TaggedSymbol)
          UNHEALTHY =
            T.let(:unhealthy, Docker::Summary::Health::Status::TaggedSymbol)

          sig do
            override.returns(
              T::Array[Docker::Summary::Health::Status::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      class HostConfig < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Summary::HostConfig, Docker::Internal::AnyHash)
          end
      ...
      class ImageManifestDescriptor < Docker::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Docker::Summary::ImageManifestDescriptor::Platform))
        end
        ...
        sig do
          params(
            platform:
              T.nilable(
                Docker::Summary::ImageManifestDescriptor::Platform::OrHash
              )
          ).void
        end
          ...
          override.returns(
            {
              ...
              media_type: String,
              platform:
                T.nilable(Docker::Summary::ImageManifestDescriptor::Platform),
              size: Integer,
              urls: T.nilable(T::Array[String])
            }
          )
        ...
        class Platform < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Summary::ImageManifestDescriptor::Platform,
                Docker::Internal::AnyHash
              )
            end
      ...
      class Mount < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Summary::Mount, Docker::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Docker::Summary::Mount::Type::TaggedSymbol)) }
        attr_reader :type

        sig { params(type: Docker::Summary::Mount::Type::OrSymbol).void }
        attr_writer :type
        ...
        sig do
          params(
            ...
            rw: T::Boolean,
            source: String,
            type: Docker::Summary::Mount::Type::OrSymbol
          ).returns(T.attached_class)
        end
        def self.new(
          # Destination is the path relative to the container root (`/`) where the `Source`
          ...
          override.returns(
            {
              ...
              rw: T::Boolean,
              source: String,
              type: Docker::Summary::Mount::Type::TaggedSymbol
            }
          )
        end
        def to_hash
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Docker::Summary::Mount::Type) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          BIND = T.let(:bind, Docker::Summary::Mount::Type::TaggedSymbol)
          CLUSTER = T.let(:cluster, Docker::Summary::Mount::Type::TaggedSymbol)
          IMAGE = T.let(:image, Docker::Summary::Mount::Type::TaggedSymbol)
          NPIPE = T.let(:npipe, Docker::Summary::Mount::Type::TaggedSymbol)
          TMPFS = T.let(:tmpfs, Docker::Summary::Mount::Type::TaggedSymbol)
          VOLUME = T.let(:volume, Docker::Summary::Mount::Type::TaggedSymbol)

          sig do
            override.returns(
              T::Array[Docker::Summary::Mount::Type::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      class NetworkSettings < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Summary::NetworkSettings, Docker::Internal::AnyHash)
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Hash[Symbol, Docker::Summary::NetworkSettings::Network]
            )
          )
        end
        ...
        sig do
          params(
            networks:
              T::Hash[Symbol, Docker::Summary::NetworkSettings::Network::OrHash]
          ).void
        end
        ...
        class Network < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Summary::NetworkSettings::Network,
                Docker::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(Docker::Summary::NetworkSettings::Network::IpamConfig)
            )
          end
          ...
          sig do
            params(
              ipam_config:
                T.nilable(
                  Docker::Summary::NetworkSettings::Network::IpamConfig::OrHash
                )
            ).void
          end
            ...
            override.returns(
              {
                ...
                ipam_config:
                  T.nilable(
                    Docker::Summary::NetworkSettings::Network::IpamConfig
                  ),
                ip_prefix_len: Integer,
                i_pv6_gateway: String,
                links: T::Array[String],
      ...
      class Port < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Summary::Port, Docker::Internal::AnyHash)
          end
        ...
        sig { returns(Docker::Summary::Port::Type::TaggedSymbol) }
        attr_accessor :type
        ...
        sig do
          params(
            ...
            type: Docker::Summary::Port::Type::OrSymbol,
            ip: String,
            public_port: Integer
          ).returns(T.attached_class)
        end
        ...
        sig do
          override.returns(
            {
              private_port: Integer,
              type: Docker::Summary::Port::Type::TaggedSymbol,
              ip: String,
              public_port: Integer
            }
          )
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Docker::Summary::Port::Type) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          TCP = T.let(:tcp, Docker::Summary::Port::Type::TaggedSymbol)
          UDP = T.let(:udp, Docker::Summary::Port::Type::TaggedSymbol)
          SCTP = T.let(:sctp, Docker::Summary::Port::Type::TaggedSymbol)

          sig do
            override.returns(
              T::Array[Docker::Summary::Port::Type::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      module State
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Docker::Summary::State) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        CREATED = T.let(:created, Docker::Summary::State::TaggedSymbol)
        RUNNING = T.let(:running, Docker::Summary::State::TaggedSymbol)
        PAUSED = T.let(:paused, Docker::Summary::State::TaggedSymbol)
        RESTARTING = T.let(:restarting, Docker::Summary::State::TaggedSymbol)
        EXITED = T.let(:exited, Docker::Summary::State::TaggedSymbol)
        REMOVING = T.let(:removing, Docker::Summary::State::TaggedSymbol)
        DEAD = T.let(:dead, Docker::Summary::State::TaggedSymbol)

        sig { override.returns(T::Array[Docker::Summary::State::TaggedSymbol]) }
        def self.values
        end
      end
    end
