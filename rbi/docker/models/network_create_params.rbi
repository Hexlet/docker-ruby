...
module Docker
  module Models
    class NetworkCreateParams < Docker::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Docker::NetworkCreateParams, Docker::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Docker::NetworkCreateParams::ConfigFrom)) }
      ...
      sig { returns(T.nilable(Docker::NetworkCreateParams::Ipam)) }
      attr_reader :ipam

      sig { params(ipam: Docker::NetworkCreateParams::Ipam::OrHash).void }
      attr_writer :ipam
        ...
        override.returns(
          {
            name: String,
            attachable: T::Boolean,
            config_from: Docker::NetworkCreateParams::ConfigFrom,
            config_only: T::Boolean,
            driver: String,
            enable_i_pv4: T::Boolean,
            enable_i_pv6: T::Boolean,
            ingress: T::Boolean,
            internal: T::Boolean,
            ipam: Docker::NetworkCreateParams::Ipam,
            labels: T::Hash[Symbol, String],
            options: T::Hash[Symbol, String],
            scope: String,
      ...
      class ConfigFrom < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Docker::NetworkCreateParams::ConfigFrom,
      ...
      class Ipam < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::NetworkCreateParams::Ipam, Docker::Internal::AnyHash)
          end
        ...
        sig do
          returns(
            T.nilable(T::Array[Docker::NetworkCreateParams::Ipam::Config])
          )
        end
        attr_reader :config
        ...
        sig do
          params(
            config: T::Array[Docker::NetworkCreateParams::Ipam::Config::OrHash]
          ).void
        end
        attr_writer :config
        ...
        sig do
          override.returns(
            {
              config: T::Array[Docker::NetworkCreateParams::Ipam::Config],
              driver: String,
              options: T::Hash[Symbol, String]
            }
          )
        ...
        class Config < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::NetworkCreateParams::Ipam::Config,
                Docker::Internal::AnyHash
              )
            end
