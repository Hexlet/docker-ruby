...
module Docker
  module Models
    class CreateRequest < Docker::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Docker::CreateRequest, Docker::Internal::AnyHash) }

      # Cluster-specific options used to create the volume.
      sig { returns(T.nilable(Docker::CreateRequest::ClusterVolumeSpec)) }
      attr_reader :cluster_volume_spec

      sig do
        params(
          cluster_volume_spec: Docker::CreateRequest::ClusterVolumeSpec::OrHash
        ).void
      end
      ...
      sig do
        override.returns(
          {
            cluster_volume_spec: Docker::CreateRequest::ClusterVolumeSpec,
            driver: String,
            driver_opts: T::Hash[Symbol, String],
            labels: T::Hash[Symbol, String],
            name: String
      ...
      class ClusterVolumeSpec < Docker::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Docker::CreateRequest::ClusterVolumeSpec::AccessMode)
          )
        end
        ...
        sig do
          params(
            access_mode:
              Docker::CreateRequest::ClusterVolumeSpec::AccessMode::OrHash
          ).void
        end
        ...
        sig do
          override.returns(
            {
              access_mode: Docker::CreateRequest::ClusterVolumeSpec::AccessMode,
              group: String
            }
          )
        end
        ...
        class AccessMode < Docker::Internal::Type::BaseModel
          ...
          sig do
            params(
              accessibility_requirements:
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Availability::OrSymbol
              )
            )
          end
          ...
          sig do
            params(
              capacity_range:
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Scope::OrSymbol
              )
            )
          end
          attr_reader :scope
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Secret
                ]
              )
            )
          end
          ...
          sig do
            params(
              secrets:
                T::Array[
                  Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Secret::OrHash
                ]
            ).void
          end
          attr_writer :secrets
          ...
          sig do
            returns(
              T.nilable(
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing::OrSymbol
              )
            )
          end
          attr_reader :sharing
          ...
          module Availability
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Availability
                )
              end
            ...
            ACTIVE =
              T.let(
                :active,
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Availability::TaggedSymbol
              )
            PAUSE =
              T.let(
                :pause,
          ...
          module Scope
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Scope
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            SINGLE =
              T.let(
                :single,
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Scope::TaggedSymbol
              )
            MULTI =
              T.let(
                :multi,
          ...
          module Sharing
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NONE =
              T.let(
                :none,
                Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing::TaggedSymbol
              )
            READONLY =
              T.let(
                :readonly,
