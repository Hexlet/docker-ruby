  ...
  module Models
    class NetworkInspectResponse < Docker::Models::Network
      OrHash =
        T.type_alias do
          T.any(
            Docker::Models::NetworkInspectResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Hash[Symbol, Docker::Models::NetworkInspectResponse::Container]
          )
        )
      end
      ...
      sig do
        params(
          containers:
            T::Hash[
              Symbol,
              Docker::Models::NetworkInspectResponse::Container::OrHash
            ]
        ).void
      end
      ...
      # IPs.
      sig { returns(T.nilable(Docker::Models::NetworkInspectResponse::Status)) }
      attr_reader :status

      sig do
        params(
          status: Docker::Models::NetworkInspectResponse::Status::OrHash
        ).void
      end
      attr_writer :status
        ...
        override.returns(
          {
            containers:
              T::Hash[
                Symbol,
                Docker::Models::NetworkInspectResponse::Container
              ],
            services: T::Hash[Symbol, T.anything],
            status: Docker::Models::NetworkInspectResponse::Status
          }
        )
      end
      def to_hash
      ...
      class Status < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Docker::Models::NetworkInspectResponse::Status,
              Docker::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Docker::Models::NetworkInspectResponse::Status::Ipam)
          )
        end
        attr_reader :ipam
        ...
        sig do
          params(
            ipam: Docker::Models::NetworkInspectResponse::Status::Ipam::OrHash
          ).void
        end
        attr_writer :ipam
        ...
        sig do
          override.returns(
            { ipam: Docker::Models::NetworkInspectResponse::Status::Ipam }
          )
        end
        def to_hash
        end
        ...
        class Ipam < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Models::NetworkInspectResponse::Status::Ipam,
                Docker::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Hash[
                  Symbol,
                  Docker::Models::NetworkInspectResponse::Status::Ipam::Subnet
                ]
              )
            )
          end
          ...
          sig do
            params(
              subnets:
                T::Hash[
                  Symbol,
                  Docker::Models::NetworkInspectResponse::Status::Ipam::Subnet::OrHash
                ]
            ).void
          end
          attr_writer :subnets
