...
module Docker
  module Models
    class Volume < Docker::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Docker::Volume, Docker::Internal::AnyHash) }
      ...
      sig { returns(Docker::Volume::Scope::TaggedSymbol) }
      attr_accessor :scope

      # Options and information specific to, and only present on, Swarm CSI cluster
      # volumes.
      sig { returns(T.nilable(Docker::Volume::ClusterVolume)) }
      attr_reader :cluster_volume

      sig { params(cluster_volume: Docker::Volume::ClusterVolume::OrHash).void }
      ...
      sig { returns(T.nilable(Docker::Volume::UsageData)) }
      attr_reader :usage_data

      sig do
        params(usage_data: T.nilable(Docker::Volume::UsageData::OrHash)).void
      end
      ...
      sig do
        params(
          ...
          scope: Docker::Volume::Scope::OrSymbol,
          cluster_volume: Docker::Volume::ClusterVolume::OrHash,
          created_at: String,
          status: T::Hash[Symbol, T.anything],
          usage_data: T.nilable(Docker::Volume::UsageData::OrHash)
        ...
        override.returns(
          {
            ...
            name: String,
            options: T::Hash[Symbol, String],
            scope: Docker::Volume::Scope::TaggedSymbol,
            cluster_volume: Docker::Volume::ClusterVolume,
            created_at: String,
            status: T::Hash[Symbol, T.anything],
            usage_data: T.nilable(Docker::Volume::UsageData)
          }
        )
      end
      def to_hash
      ...
      module Scope
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Docker::Volume::Scope) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        LOCAL = T.let(:local, Docker::Volume::Scope::TaggedSymbol)
        GLOBAL = T.let(:global, Docker::Volume::Scope::TaggedSymbol)

        sig { override.returns(T::Array[Docker::Volume::Scope::TaggedSymbol]) }
        def self.values
        end
      end
      ...
      class ClusterVolume < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Volume::ClusterVolume, Docker::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Docker::Volume::ClusterVolume::Info)) }
        attr_reader :info

        sig { params(info: Docker::Volume::ClusterVolume::Info::OrHash).void }
        attr_writer :info
        ...
        sig do
          returns(
            T.nilable(T::Array[Docker::Volume::ClusterVolume::PublishStatus])
          )
        end
        ...
        sig do
          params(
            publish_status:
              T::Array[Docker::Volume::ClusterVolume::PublishStatus::OrHash]
          ).void
        end
        attr_writer :publish_status

        # Cluster-specific options used to create the volume.
        sig { returns(T.nilable(Docker::Volume::ClusterVolume::Spec)) }
        attr_reader :spec

        sig { params(spec: Docker::Volume::ClusterVolume::Spec::OrHash).void }
        attr_writer :spec
        ...
        sig { returns(T.nilable(Docker::Volume::ClusterVolume::Version)) }
        attr_reader :version

        sig do
          params(version: Docker::Volume::ClusterVolume::Version::OrHash).void
        end
        attr_writer :version
        ...
        sig do
          params(
            created_at: String,
            id: String,
            info: Docker::Volume::ClusterVolume::Info::OrHash,
            publish_status:
              T::Array[Docker::Volume::ClusterVolume::PublishStatus::OrHash],
            spec: Docker::Volume::ClusterVolume::Spec::OrHash,
            updated_at: String,
            version: Docker::Volume::ClusterVolume::Version::OrHash
          ).returns(T.attached_class)
        end
        def self.new(
          created_at: nil,
          ...
          override.returns(
            {
              created_at: String,
              id: String,
              info: Docker::Volume::ClusterVolume::Info,
              publish_status:
                T::Array[Docker::Volume::ClusterVolume::PublishStatus],
              spec: Docker::Volume::ClusterVolume::Spec,
              updated_at: String,
              version: Docker::Volume::ClusterVolume::Version
            }
          )
        end
        def to_hash
        ...
        class Info < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Volume::ClusterVolume::Info,
        ...
        class PublishStatus < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Volume::ClusterVolume::PublishStatus,
                Docker::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Docker::Volume::ClusterVolume::PublishStatus::State::TaggedSymbol
              )
            )
          end
          attr_reader :state
          ...
          sig do
            params(
              state:
                Docker::Volume::ClusterVolume::PublishStatus::State::OrSymbol
            ).void
          end
          attr_writer :state
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Docker::Volume::ClusterVolume::PublishStatus::State
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Spec < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Volume::ClusterVolume::Spec,
                Docker::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(T.nilable(Docker::Volume::ClusterVolume::Spec::AccessMode))
          end
          ...
          sig do
            params(
              access_mode:
                Docker::Volume::ClusterVolume::Spec::AccessMode::OrHash
            ).void
          end
          ...
          sig do
            override.returns(
              {
                access_mode: Docker::Volume::ClusterVolume::Spec::AccessMode,
                group: String
              }
            )
          end
          ...
          class AccessMode < Docker::Internal::Type::BaseModel
            ...
            sig do
              params(
                accessibility_requirements:
                  Docker::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Docker::Volume::ClusterVolume::Spec::AccessMode::Availability::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                availability:
                  Docker::Volume::ClusterVolume::Spec::AccessMode::Availability::OrSymbol
              ).void
            end
            ...
            sig do
              params(
                capacity_range:
                  Docker::Volume::ClusterVolume::Spec::AccessMode::CapacityRange::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Docker::Volume::ClusterVolume::Spec::AccessMode::Scope::TaggedSymbol
                )
              )
            end
            attr_reader :scope
            ...
            sig do
              params(
                scope:
                  Docker::Volume::ClusterVolume::Spec::AccessMode::Scope::OrSymbol
              ).void
            end
            attr_writer :scope
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Docker::Volume::ClusterVolume::Spec::AccessMode::Secret
                  ]
                )
              )
            end
            ...
            sig do
              params(
                secrets:
                  T::Array[
                    Docker::Volume::ClusterVolume::Spec::AccessMode::Secret::OrHash
                  ]
              ).void
            end
            attr_writer :secrets
            ...
            sig do
              returns(
                T.nilable(
                  Docker::Volume::ClusterVolume::Spec::AccessMode::Sharing::TaggedSymbol
                )
              )
            end
            attr_reader :sharing
            ...
            sig do
              params(
                sharing:
                  Docker::Volume::ClusterVolume::Spec::AccessMode::Sharing::OrSymbol
              ).void
            end
            attr_writer :sharing
            ...
            module Availability
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Docker::Volume::ClusterVolume::Spec::AccessMode::Availability
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Sharing
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Docker::Volume::ClusterVolume::Spec::AccessMode::Sharing
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Version < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Volume::ClusterVolume::Version,
                Docker::Internal::AnyHash
              )
            end
      ...
      class UsageData < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Volume::UsageData, Docker::Internal::AnyHash)
          end
