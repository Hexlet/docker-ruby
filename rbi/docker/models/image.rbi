...
module Docker
  module Models
    class Image < Docker::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Docker::Image, Docker::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Docker::Image::Config)) }
      attr_reader :config

      sig { params(config: Docker::Image::Config::OrHash).void }
      attr_writer :config
      ...
      sig { returns(T.nilable(Docker::Image::Descriptor)) }
      attr_reader :descriptor

      sig { params(descriptor: Docker::Image::Descriptor::OrHash).void }
      attr_writer :descriptor

      # Information about the storage driver used to store the container's and image's
      # filesystem.
      sig { returns(T.nilable(Docker::Image::GraphDriver)) }
      attr_reader :graph_driver

      sig { params(graph_driver: Docker::Image::GraphDriver::OrHash).void }
      ...
      sig { returns(T.nilable(Docker::Image::Identity)) }
      attr_reader :identity

      sig { params(identity: Docker::Image::Identity::OrHash).void }
      ...
      # compatibility.
      sig { returns(T.nilable(T::Array[Docker::Image::Manifest])) }
      ...
      sig { returns(T.nilable(Docker::Image::Metadata)) }
      attr_reader :metadata

      sig { params(metadata: Docker::Image::Metadata::OrHash).void }
      ...
      sig { returns(T.nilable(Docker::Image::RootFs)) }
      attr_reader :root_fs

      sig { params(root_fs: Docker::Image::RootFs::OrHash).void }
      attr_writer :root_fs
      ...
      sig do
        params(
          ...
          config: Docker::Image::Config::OrHash,
          created: T.nilable(String),
          descriptor: Docker::Image::Descriptor::OrHash,
          graph_driver: Docker::Image::GraphDriver::OrHash,
          id: String,
          identity: Docker::Image::Identity::OrHash,
          manifests: T.nilable(T::Array[Docker::Image::Manifest::OrHash]),
          metadata: Docker::Image::Metadata::OrHash,
          os: String,
          os_version: T.nilable(String),
          repo_digests: T::Array[String],
          repo_tags: T::Array[String],
          root_fs: Docker::Image::RootFs::OrHash,
          size: Integer,
        ...
        override.returns(
          {
            ...
            author: T.nilable(String),
            comment: T.nilable(String),
            config: Docker::Image::Config,
            created: T.nilable(String),
            descriptor: Docker::Image::Descriptor,
            graph_driver: Docker::Image::GraphDriver,
            id: String,
            identity: Docker::Image::Identity,
            manifests: T.nilable(T::Array[Docker::Image::Manifest]),
            metadata: Docker::Image::Metadata,
            os: String,
            os_version: T.nilable(String),
            repo_digests: T::Array[String],
            repo_tags: T::Array[String],
            root_fs: Docker::Image::RootFs,
            size: Integer,
            variant: T.nilable(String)
          }
        )
      ...
      class Config < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::Config, Docker::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Docker::Image::Config::Healthcheck)) }
        attr_reader :healthcheck

        sig do
          params(healthcheck: Docker::Image::Config::Healthcheck::OrHash).void
        end
        ...
        sig do
          params(
            ...
            healthcheck: Docker::Image::Config::Healthcheck::OrHash,
          ...
          override.returns(
            {
              ...
              env: T::Array[String],
              exposed_ports: T.nilable(T::Hash[Symbol, T.anything]),
              healthcheck: Docker::Image::Config::Healthcheck,
              labels: T::Hash[Symbol, String],
              on_build: T.nilable(T::Array[String]),
              shell: T.nilable(T::Array[String]),
              stop_signal: T.nilable(String),
      ...
      class Descriptor < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::Descriptor, Docker::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Docker::Image::Descriptor::Platform)) }
        attr_reader :platform

        sig do
          params(
            platform: T.nilable(Docker::Image::Descriptor::Platform::OrHash)
          ).void
        end
          ...
          override.returns(
            {
              ...
              digest: String,
              media_type: String,
              platform: T.nilable(Docker::Image::Descriptor::Platform),
              size: Integer,
              urls: T.nilable(T::Array[String])
            }
          )
        ...
        class Platform < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Image::Descriptor::Platform,
                Docker::Internal::AnyHash
              )
            end
      ...
      class GraphDriver < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::GraphDriver, Docker::Internal::AnyHash)
          end
      ...
      class Identity < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::Identity, Docker::Internal::AnyHash)
          end

        # Build contains build reference information if image was created via build.
        sig { returns(T.nilable(T::Array[Docker::Image::Identity::Build])) }
        attr_reader :build

        sig do
          params(build: T::Array[Docker::Image::Identity::Build::OrHash]).void
        end
        attr_writer :build
        ...
        sig { returns(T.nilable(T::Array[Docker::Image::Identity::Pull])) }
        attr_reader :pull

        sig do
          params(pull: T::Array[Docker::Image::Identity::Pull::OrHash]).void
        end
        attr_writer :pull

        # Signature contains the properties of verified signatures for the image.
        sig { returns(T.nilable(T::Array[Docker::Image::Identity::Signature])) }
        attr_reader :signature

        sig do
          params(
            signature: T::Array[Docker::Image::Identity::Signature::OrHash]
          ).void
        end
        ...
        sig do
          params(
            build: T::Array[Docker::Image::Identity::Build::OrHash],
            pull: T::Array[Docker::Image::Identity::Pull::OrHash],
            signature: T::Array[Docker::Image::Identity::Signature::OrHash]
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        sig do
          override.returns(
            {
              build: T::Array[Docker::Image::Identity::Build],
              pull: T::Array[Docker::Image::Identity::Pull],
              signature: T::Array[Docker::Image::Identity::Signature]
            }
          )
        end
        def to_hash
        ...
        class Build < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(Docker::Image::Identity::Build, Docker::Internal::AnyHash)
            end
        ...
        class Pull < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(Docker::Image::Identity::Pull, Docker::Internal::AnyHash)
            end
        ...
        class Signature < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Image::Identity::Signature,
                Docker::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Docker::Image::Identity::Signature::KnownSigner::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              known_signer:
                Docker::Image::Identity::Signature::KnownSigner::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Docker::Image::Identity::Signature::SignatureType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              signature_type:
                Docker::Image::Identity::Signature::SignatureType::OrSymbol
            ).void
          end
          ...
          # the image.
          sig { returns(T.nilable(Docker::Image::Identity::Signature::Signer)) }
          attr_reader :signer

          sig do
            params(
              signer: Docker::Image::Identity::Signature::Signer::OrHash
            ).void
          end
          attr_writer :signer
          ...
          sig do
            returns(
              T.nilable(T::Array[Docker::Image::Identity::Signature::Timestamp])
            )
          end
          ...
          sig do
            params(
              timestamps:
                T::Array[Docker::Image::Identity::Signature::Timestamp::OrHash]
            ).void
          end
            ...
            override.returns(
              {
                ...
                signature_type:
                  Docker::Image::Identity::Signature::SignatureType::TaggedSymbol,
                signer: Docker::Image::Identity::Signature::Signer,
                timestamps:
                  T::Array[Docker::Image::Identity::Signature::Timestamp],
                warnings: T::Array[String]
              }
            )
          end
          ...
          module KnownSigner
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, Docker::Image::Identity::Signature::KnownSigner)
              end
          ...
          module SignatureType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, Docker::Image::Identity::Signature::SignatureType)
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Signer < Docker::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Docker::Image::Identity::Signature::Signer,
                  Docker::Internal::AnyHash
                )
              end
          ...
          class Timestamp < Docker::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Docker::Image::Identity::Signature::Timestamp,
                  Docker::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                T.nilable(
                  Docker::Image::Identity::Signature::Timestamp::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  Docker::Image::Identity::Signature::Timestamp::Type::OrSymbol
              ).void
            end
            attr_writer :type
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Docker::Image::Identity::Signature::Timestamp::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Manifest < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::Manifest, Docker::Internal::AnyHash)
          end
        ...
        # A descriptor struct containing digest, media type, and size, as defined in the
        # [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
        sig { returns(Docker::Image::Manifest::Descriptor) }
        attr_reader :descriptor

        sig do
          params(descriptor: Docker::Image::Manifest::Descriptor::OrHash).void
        end
        attr_writer :descriptor
        ...
        sig { returns(Docker::Image::Manifest::Kind::TaggedSymbol) }
        attr_accessor :kind

        sig { returns(Docker::Image::Manifest::Size) }
        attr_reader :size

        sig { params(size: Docker::Image::Manifest::Size::OrHash).void }
        attr_writer :size

        # The image data for the attestation manifest. This field is only populated when
        # Kind is "attestation".
        sig { returns(T.nilable(Docker::Image::Manifest::AttestationData)) }
        attr_reader :attestation_data

        sig do
          params(
            attestation_data:
              T.nilable(Docker::Image::Manifest::AttestationData::OrHash)
          ).void
        end
        ...
        # "image".
        sig { returns(T.nilable(Docker::Image::Manifest::ImageData)) }
        attr_reader :image_data

        sig do
          params(
            image_data: T.nilable(Docker::Image::Manifest::ImageData::OrHash)
          ).void
        end
        ...
        sig do
          params(
            available: T::Boolean,
            descriptor: Docker::Image::Manifest::Descriptor::OrHash,
            id: String,
            kind: Docker::Image::Manifest::Kind::OrSymbol,
            size: Docker::Image::Manifest::Size::OrHash,
            attestation_data:
              T.nilable(Docker::Image::Manifest::AttestationData::OrHash),
            image_data: T.nilable(Docker::Image::Manifest::ImageData::OrHash)
          ).returns(T.attached_class)
        ...
        sig do
          override.returns(
            {
              available: T::Boolean,
              descriptor: Docker::Image::Manifest::Descriptor,
              id: String,
              kind: Docker::Image::Manifest::Kind::TaggedSymbol,
              size: Docker::Image::Manifest::Size,
              attestation_data:
                T.nilable(Docker::Image::Manifest::AttestationData),
              image_data: T.nilable(Docker::Image::Manifest::ImageData)
            }
          )
        end
        def to_hash
        ...
        class Descriptor < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Image::Manifest::Descriptor,
                Docker::Internal::AnyHash
              )
            end
          ...
          # [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
          sig do
            returns(T.nilable(Docker::Image::Manifest::Descriptor::Platform))
          end
          attr_reader :platform
          ...
          sig do
            params(
              platform:
                T.nilable(Docker::Image::Manifest::Descriptor::Platform::OrHash)
            ).void
          end
          attr_writer :platform
          ...
          sig do
            params(
              ...
              platform:
                T.nilable(
                  Docker::Image::Manifest::Descriptor::Platform::OrHash
                ),
              size: Integer,
              urls: T.nilable(T::Array[String])
            ).returns(T.attached_class)
            ...
            override.returns(
              {
                ...
                media_type: String,
                platform:
                  T.nilable(Docker::Image::Manifest::Descriptor::Platform),
                size: Integer,
                urls: T.nilable(T::Array[String])
              }
            )
          ...
          class Platform < Docker::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Docker::Image::Manifest::Descriptor::Platform,
                  Docker::Internal::AnyHash
                )
              end
        ...
        module Kind
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Docker::Image::Manifest::Kind) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          IMAGE = T.let(:image, Docker::Image::Manifest::Kind::TaggedSymbol)
          ATTESTATION =
            T.let(:attestation, Docker::Image::Manifest::Kind::TaggedSymbol)
          UNKNOWN = T.let(:unknown, Docker::Image::Manifest::Kind::TaggedSymbol)

          sig do
            override.returns(
              T::Array[Docker::Image::Manifest::Kind::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        class Size < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(Docker::Image::Manifest::Size, Docker::Internal::AnyHash)
            end
        ...
        class ImageData < Docker::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Docker::Image::Manifest::ImageData,
                Docker::Internal::AnyHash
              )
            end
          ...
          # [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
          sig do
            returns(T.nilable(Docker::Image::Manifest::ImageData::Platform))
          end
          attr_reader :platform
          ...
          sig do
            params(
              platform:
                T.nilable(Docker::Image::Manifest::ImageData::Platform::OrHash)
            ).void
          end
          attr_writer :platform

          sig { returns(Docker::Image::Manifest::ImageData::Size) }
          attr_reader :size

          sig do
            params(size: Docker::Image::Manifest::ImageData::Size::OrHash).void
          end
          attr_writer :size
          ...
          sig do
            params(
              ...
              platform:
                T.nilable(Docker::Image::Manifest::ImageData::Platform::OrHash),
              size: Docker::Image::Manifest::ImageData::Size::OrHash
            ).returns(T.attached_class)
          end
          def self.new(
            # The IDs of the containers that are using this image.
            ...
            override.returns(
              {
                containers: T::Array[String],
                platform:
                  T.nilable(Docker::Image::Manifest::ImageData::Platform),
                size: Docker::Image::Manifest::ImageData::Size
              }
            )
          end
          def to_hash
          ...
          class Size < Docker::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Docker::Image::Manifest::ImageData::Size,
                  Docker::Internal::AnyHash
                )
              end
      ...
      class Metadata < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::Metadata, Docker::Internal::AnyHash)
          end
      ...
      class RootFs < Docker::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Docker::Image::RootFs, Docker::Internal::AnyHash)
          end
