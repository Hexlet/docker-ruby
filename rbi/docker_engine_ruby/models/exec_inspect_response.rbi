  ...
  module Models
    class ExecInspectResponse < DockerEngineRuby::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            DockerEngineRuby::Models::ExecInspectResponse,
      ...
      sig { returns(T.nilable(DockerEngineRuby::InspectResponse)) }
      attr_reader :process_config

      sig do
        params(process_config: DockerEngineRuby::InspectResponse::OrHash).void
      end
      ...
      sig do
        params(
          ...
          pid: Integer,
          process_config: DockerEngineRuby::InspectResponse::OrHash,
          running: T::Boolean
        ...
        override.returns(
          {
            ...
            open_stdout: T::Boolean,
            pid: Integer,
            process_config: DockerEngineRuby::InspectResponse,
            running: T::Boolean
          }
        )
      end
