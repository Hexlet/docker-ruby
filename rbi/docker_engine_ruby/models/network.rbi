...
module DockerEngineRuby
  module Models
    class Network < DockerEngineRuby::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(DockerEngineRuby::Network, DockerEngineRuby::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(DockerEngineRuby::Network::ConfigFrom)) }
      attr_reader :config_from

      sig do
        params(config_from: DockerEngineRuby::Network::ConfigFrom::OrHash).void
      end
      ...
      sig { params(ipam: DockerEngineRuby::Network::Ipam::OrHash).void }
      attr_writer :ipam
      ...
      sig { returns(T.nilable(T::Array[DockerEngineRuby::Network::Peer])) }
      attr_reader :peers

      sig do
        params(peers: T::Array[DockerEngineRuby::Network::Peer::OrHash]).void
      end
      attr_writer :peers
      ...
      sig do
        params(
          ...
          ingress: T::Boolean,
          internal: T::Boolean,
          ipam: DockerEngineRuby::Network::Ipam::OrHash,
          labels: T::Hash[Symbol, String],
          name: String,
          options: T::Hash[Symbol, String],
          peers: T::Array[DockerEngineRuby::Network::Peer::OrHash],
          scope: String
        ...
        override.returns(
          {
            ...
            name: String,
            options: T::Hash[Symbol, String],
            peers: T::Array[DockerEngineRuby::Network::Peer],
            scope: String
          }
        )
      end
      ...
      class Ipam < DockerEngineRuby::Internal::Type::BaseModel
        ...
        # ```
        sig do
          returns(T.nilable(T::Array[DockerEngineRuby::Network::Ipam::Config]))
        end
        attr_reader :config
        ...
        sig do
          override.returns(
            {
              config: T::Array[DockerEngineRuby::Network::Ipam::Config],
              driver: String,
              options: T::Hash[Symbol, String]
            }
          )
        ...
        class Config < DockerEngineRuby::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                DockerEngineRuby::Network::Ipam::Config,
                DockerEngineRuby::Internal::AnyHash
              )
            end
