  ...
  module Models
    class SystemDataUsageResponse < DockerEngineRuby::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            DockerEngineRuby::Models::SystemDataUsageResponse,
      ...
      sig do
        params(
          build_cache_disk_usage:
            DockerEngineRuby::Models::SystemDataUsageResponse::BuildCacheDiskUsage::OrHash
        ).void
      end
      ...
      sig do
        params(
          containers_disk_usage:
            DockerEngineRuby::Models::SystemDataUsageResponse::ContainersDiskUsage::OrHash
        ).void
      end
      ...
      sig do
        params(
          images_disk_usage:
            DockerEngineRuby::Models::SystemDataUsageResponse::ImagesDiskUsage::OrHash
        ).void
      end
      ...
      sig do
        params(
          volumes_disk_usage:
            DockerEngineRuby::Models::SystemDataUsageResponse::VolumesDiskUsage::OrHash
        ).void
      end
