  ...
  module Models
    class CreateRequest < DockerEngineRuby::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            DockerEngineRuby::CreateRequest,
      ...
      sig do
        returns(T.nilable(DockerEngineRuby::CreateRequest::ClusterVolumeSpec))
      end
      ...
      class ClusterVolumeSpec < DockerEngineRuby::Internal::Type::BaseModel
        ...
        sig do
          params(
            access_mode:
              DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::OrHash
          ).void
        end
        ...
        class AccessMode < DockerEngineRuby::Internal::Type::BaseModel
          ...
          sig do
            params(
              accessibility_requirements:
                DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Secret
                ]
              )
            )
          end
          ...
          sig do
            params(
              secrets:
                T::Array[
                  DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Secret::OrHash
                ]
            ).void
          end
          attr_writer :secrets
          ...
          sig do
            returns(
              T.nilable(
                DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing::OrSymbol
              )
            )
          end
          attr_reader :sharing
          ...
          module Availability
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Availability
                )
              end
            ...
            ACTIVE =
              T.let(
                :active,
                DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Availability::TaggedSymbol
              )
            PAUSE =
              T.let(
                :pause,
          ...
          module Scope
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Scope
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            SINGLE =
              T.let(
                :single,
                DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Scope::TaggedSymbol
              )
            MULTI =
              T.let(
                :multi,
          ...
          module Sharing
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NONE =
              T.let(
                :none,
                DockerEngineRuby::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing::TaggedSymbol
              )
            READONLY =
              T.let(
                :readonly,
