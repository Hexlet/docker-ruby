...
class DockerEngine::Test::PrimitiveModelTest < Minitest::Test
  A = DockerEngine::Internal::Type::ArrayOf[-> { Integer }]
  H = DockerEngine::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < DockerEngine::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      DockerEngine::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => DockerEngine::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [DockerEngine::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [DockerEngine::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [DockerEngine::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = DockerEngine::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        DockerEngine::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [DockerEngine::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [DockerEngine::Internal::Type::Boolean, true] => true,
      [DockerEngine::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => DockerEngine::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        DockerEngine::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = DockerEngine::Internal::Type::Converter.new_coerce_state
      DockerEngine::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        DockerEngine::Internal::Type::Converter.dump(target, input, state: state)
...
class DockerEngine::Test::EnumModelTest < Minitest::Test
  class E0
    include DockerEngine::Internal::Type::Enum
...
class DockerEngine::Test::CollectionModelTest < Minitest::Test
  A1 = DockerEngine::Internal::Type::ArrayOf[-> { Integer }]
  H1 = DockerEngine::Internal::Type::HashOf[Integer]

  A2 = DockerEngine::Internal::Type::ArrayOf[H1]
  H2 = DockerEngine::Internal::Type::HashOf[-> { A1 }]

  A3 = DockerEngine::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = DockerEngine::Internal::Type::HashOf[Integer, nil?: true]
...
class DockerEngine::Test::BaseModelTest < Minitest::Test
  class M1 < DockerEngine::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < DockerEngine::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < DockerEngine::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, DockerEngine::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = DockerEngine::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = DockerEngine::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(DockerEngine::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue DockerEngine::Errors::ConversionError => e
...
class DockerEngine::Test::UnionTest < Minitest::Test
  class U0
    include DockerEngine::Internal::Type::Union
  ...
  class M2 < DockerEngine::Internal::Type::BaseModel
  ...
  class M4 < DockerEngine::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, DockerEngine::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < DockerEngine::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, DockerEngine::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class DockerEngine::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include DockerEngine::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [DockerEngine::Internal::Type::Unknown, DockerEngine::Internal::Type::Unknown] => true,
      [DockerEngine::Internal::Type::Boolean, DockerEngine::Internal::Type::Boolean] => true,
      [DockerEngine::Internal::Type::Unknown, DockerEngine::Internal::Type::Boolean] => false,
...
class DockerEngine::Test::MetaInfoTest < Minitest::Test
  A1 = DockerEngine::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = DockerEngine::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
