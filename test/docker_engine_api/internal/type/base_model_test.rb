...
class DockerEngineAPI::Test::PrimitiveModelTest < Minitest::Test
  A = DockerEngineAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = DockerEngineAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend DockerEngineAPI::Internal::Type::Union
  end

  class B < DockerEngineAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      DockerEngineAPI::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => DockerEngineAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [DockerEngineAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [DockerEngineAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [DockerEngineAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = DockerEngineAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        DockerEngineAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [DockerEngineAPI::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [DockerEngineAPI::Internal::Type::Boolean, true] => true,
      [DockerEngineAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => DockerEngineAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        DockerEngineAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = DockerEngineAPI::Internal::Type::Converter.new_coerce_state
      DockerEngineAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        DockerEngineAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class DockerEngineAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include DockerEngineAPI::Internal::Type::Enum
...
class DockerEngineAPI::Test::CollectionModelTest < Minitest::Test
  A1 = DockerEngineAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = DockerEngineAPI::Internal::Type::HashOf[Integer]

  A2 = DockerEngineAPI::Internal::Type::ArrayOf[H1]
  H2 = DockerEngineAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = DockerEngineAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = DockerEngineAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class DockerEngineAPI::Test::BaseModelTest < Minitest::Test
  class M1 < DockerEngineAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < DockerEngineAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < DockerEngineAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, DockerEngineAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = DockerEngineAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = DockerEngineAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(DockerEngineAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue DockerEngineAPI::Errors::ConversionError => e
...
class DockerEngineAPI::Test::UnionTest < Minitest::Test
  class U0
    include DockerEngineAPI::Internal::Type::Union
  ...
  class M2 < DockerEngineAPI::Internal::Type::BaseModel
  ...
  class M4 < DockerEngineAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, DockerEngineAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < DockerEngineAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, DockerEngineAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class DockerEngineAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include DockerEngineAPI::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [DockerEngineAPI::Internal::Type::Unknown, DockerEngineAPI::Internal::Type::Unknown] => true,
      [DockerEngineAPI::Internal::Type::Boolean, DockerEngineAPI::Internal::Type::Boolean] => true,
      [DockerEngineAPI::Internal::Type::Unknown, DockerEngineAPI::Internal::Type::Boolean] => false,
...
class DockerEngineAPI::Test::MetaInfoTest < Minitest::Test
  A1 = DockerEngineAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = DockerEngineAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
