...
class Docker::Test::PrimitiveModelTest < Minitest::Test
  A = Docker::Internal::Type::ArrayOf[-> { Integer }]
  H = Docker::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Docker::Internal::Type::Union
  end

  class B < Docker::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Docker::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Docker::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Docker::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Docker::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Docker::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Docker::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Docker::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Docker::Internal::Type::Boolean, true] => true,
      [Docker::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Docker::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Docker::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Docker::Internal::Type::Converter.new_coerce_state
      Docker::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Docker::Internal::Type::Converter.dump(target, input, state: state)
...
class Docker::Test::EnumModelTest < Minitest::Test
  class E0
    include Docker::Internal::Type::Enum
...
class Docker::Test::CollectionModelTest < Minitest::Test
  A1 = Docker::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Docker::Internal::Type::HashOf[Integer]

  A2 = Docker::Internal::Type::ArrayOf[H1]
  H2 = Docker::Internal::Type::HashOf[-> { A1 }]

  A3 = Docker::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Docker::Internal::Type::HashOf[Integer, nil?: true]
...
class Docker::Test::BaseModelTest < Minitest::Test
  class M1 < Docker::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Docker::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Docker::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Docker::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Docker::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Docker::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Docker::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Docker::Errors::ConversionError => e
...
class Docker::Test::UnionTest < Minitest::Test
  class U0
    include Docker::Internal::Type::Union
  ...
  class M2 < Docker::Internal::Type::BaseModel
  ...
  class M4 < Docker::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Docker::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Docker::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Docker::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Docker::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Docker::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Docker::Internal::Type::Unknown, Docker::Internal::Type::Unknown] => true,
      [Docker::Internal::Type::Boolean, Docker::Internal::Type::Boolean] => true,
      [Docker::Internal::Type::Unknown, Docker::Internal::Type::Boolean] => false,
...
class Docker::Test::MetaInfoTest < Minitest::Test
  A1 = Docker::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Docker::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
