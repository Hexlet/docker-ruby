...
class DockerEngineRuby::Test::PrimitiveModelTest < Minitest::Test
  A = DockerEngineRuby::Internal::Type::ArrayOf[-> { Integer }]
  H = DockerEngineRuby::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < DockerEngineRuby::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => DockerEngineRuby::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [DockerEngineRuby::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [DockerEngineRuby::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [DockerEngineRuby::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = DockerEngineRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        DockerEngineRuby::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [DockerEngineRuby::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [DockerEngineRuby::Internal::Type::Boolean, true] => true,
      [DockerEngineRuby::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => DockerEngineRuby::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        DockerEngineRuby::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = DockerEngineRuby::Internal::Type::Converter.new_coerce_state
      DockerEngineRuby::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        DockerEngineRuby::Internal::Type::Converter.dump(target, input, state: state)
...
class DockerEngineRuby::Test::EnumModelTest < Minitest::Test
  class E0
    include DockerEngineRuby::Internal::Type::Enum
...
class DockerEngineRuby::Test::CollectionModelTest < Minitest::Test
  A1 = DockerEngineRuby::Internal::Type::ArrayOf[-> { Integer }]
  H1 = DockerEngineRuby::Internal::Type::HashOf[Integer]

  A2 = DockerEngineRuby::Internal::Type::ArrayOf[H1]
  H2 = DockerEngineRuby::Internal::Type::HashOf[-> { A1 }]

  A3 = DockerEngineRuby::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = DockerEngineRuby::Internal::Type::HashOf[Integer, nil?: true]
...
class DockerEngineRuby::Test::BaseModelTest < Minitest::Test
  class M1 < DockerEngineRuby::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < DockerEngineRuby::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < DockerEngineRuby::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, DockerEngineRuby::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = DockerEngineRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = DockerEngineRuby::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(DockerEngineRuby::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue DockerEngineRuby::Errors::ConversionError => e
...
class DockerEngineRuby::Test::UnionTest < Minitest::Test
  class U0
    include DockerEngineRuby::Internal::Type::Union
  ...
  class M2 < DockerEngineRuby::Internal::Type::BaseModel
  ...
  class M4 < DockerEngineRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, DockerEngineRuby::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < DockerEngineRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, DockerEngineRuby::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class DockerEngineRuby::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include DockerEngineRuby::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [DockerEngineRuby::Internal::Type::Unknown, DockerEngineRuby::Internal::Type::Unknown] => true,
      [DockerEngineRuby::Internal::Type::Boolean, DockerEngineRuby::Internal::Type::Boolean] => true,
      [DockerEngineRuby::Internal::Type::Unknown, DockerEngineRuby::Internal::Type::Boolean] => false,
...
class DockerEngineRuby::Test::MetaInfoTest < Minitest::Test
  A1 = DockerEngineRuby::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = DockerEngineRuby::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
