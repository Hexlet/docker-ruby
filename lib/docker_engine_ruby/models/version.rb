...
module DockerEngineRuby
  module Models
    # @see DockerEngineRuby::Resources::System#version
    class Version < DockerEngineRuby::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<DockerEngineRuby::Models::Version::Component>, nil]
      optional :components,
      ...
      # @!attribute platform
      #
      #   @return [DockerEngineRuby::Models::Version::Platform, nil]
      ...
      #   {DockerEngineRuby::Models::Version} for more details.
      #
      ...
      #
      #   @param components [Array<DockerEngineRuby::Models::Version::Component>] Information about system components
      #
      ...
      #
      #   @param platform [DockerEngineRuby::Models::Version::Platform]
      #
