...
module DockerEngineRuby
  module Models
    class Config < DockerEngineRuby::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineRuby::Models::Config::Healthcheck, nil]
      ...
      #   {DockerEngineRuby::Models::Config} for more details.
      #
      ...
      # @see DockerEngineRuby::Models::Config#healthcheck
      class Healthcheck < DockerEngineRuby::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineRuby::Models::Config::Healthcheck} for more details.
        #
        #   A test to perform to check that the container is healthy. Healthcheck commands
        #   should be side-effect free.
        #
