...
module DockerEngineRuby
  module Models
    class Network < DockerEngineRuby::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineRuby::Models::Network::ConfigFrom, nil]
      optional :config_from, -> { DockerEngineRuby::Network::ConfigFrom }, api_name: :ConfigFrom
      ...
      #
      #   @return [Array<DockerEngineRuby::Models::Network::Peer>, nil]
      optional :peers,
               -> { DockerEngineRuby::Internal::Type::ArrayOf[DockerEngineRuby::Network::Peer] },
               api_name: :Peers
      ...
      #   {DockerEngineRuby::Models::Network} for more details.
      #
      #   @param attachable [Boolean] Whether a global / swarm scope network is manually attachable by regular
      #
      #   @param config_from [DockerEngineRuby::Models::Network::ConfigFrom] The config-only network source to provide the configuration for
      #
      ...
      #
      #   @param peers [Array<DockerEngineRuby::Models::Network::Peer>] List of peer nodes for an overlay network. This field is only present
      #
      #   @param scope [String] The level at which the network exists (e.g. `swarm` for cluster-wide

      # @see DockerEngineRuby::Models::Network#config_from
      class ConfigFrom < DockerEngineRuby::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineRuby::Models::Network::ConfigFrom} for more details.
        #
        #   The config-only network source to provide the configuration for this network.
        #
      ...
      # @see DockerEngineRuby::Models::Network#ipam
      class Ipam < DockerEngineRuby::Internal::Type::BaseModel
        ...
        #   ```
        #
        #   @return [Array<DockerEngineRuby::Models::Network::Ipam::Config>, nil]
        optional :config,
                 -> { DockerEngineRuby::Internal::Type::ArrayOf[DockerEngineRuby::Network::Ipam::Config] },
                 api_name: :Config
