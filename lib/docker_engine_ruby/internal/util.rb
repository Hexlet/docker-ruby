    ...
    module Util
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [DockerEngineRuby::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [DockerEngineRuby::Internal::Util::JSONL_CONTENT, Enumerable] unless DockerEngineRuby::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | DockerEngineRuby::Internal::Type::FileInput]
          ...
          in [_, StringIO]
            [headers, body.string]
          in [_, DockerEngineRuby::FilePart]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in DockerEngineRuby::Internal::Util::JSON_CONTENT
          ...
          in DockerEngineRuby::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [DockerEngineRuby::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in DockerEngineRuby::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
