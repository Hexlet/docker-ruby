  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => DockerEngineRuby::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => DockerEngineRuby::Internal::Util.os,
            "x-stainless-package-version" => DockerEngineRuby::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = DockerEngineRuby::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise DockerEngineRuby::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if DockerEngineRuby::Internal::Util.uri_origin(url) != DockerEngineRuby::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, DockerEngineRuby::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in DockerEngineRuby::Errors::APIConnectionError | (500..)
              DockerEngineRuby::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [DockerEngineRuby::Internal::Transport::PooledNetRequester]
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{DockerEngineRuby::VERSION}"
        ...
        #
        #   @option req [Class<DockerEngineRuby::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<DockerEngineRuby::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [DockerEngineRuby::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = DockerEngineRuby::Internal::Util.interpolate_path(uninterpolated_path)

          query = DockerEngineRuby::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              DockerEngineRuby::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          url = DockerEngineRuby::Internal::Util.join_parsed_uri(
            @base_url_components,
            {**req, path: path, query: query}
          )
          headers, encoded = DockerEngineRuby::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [DockerEngineRuby::Errors::APIError]
        # @return [Array(Integer, Net::HTTPResponse, Enumerable<String>)]
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          url, headers, max_retries, timeout = request.fetch_values(:url, :headers, :max_retries, :timeout)
          input = {**request.except(:timeout), deadline: DockerEngineRuby::Internal::Util.monotonic_secs + timeout}
          ...
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            ...
            raise DockerEngineRuby::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | DockerEngineRuby::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: DockerEngineRuby::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<DockerEngineRuby::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<DockerEngineRuby::Internal::Type::BaseStream>, nil]
        #
        # @param model [DockerEngineRuby::Internal::Type::Converter, Class, nil]
        #
        # @param options [DockerEngineRuby::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { DockerEngineRuby::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          DockerEngineRuby::RequestOptions.validate!(opts)
          ...
          in {page: Class => page}
            ...
            unwrapped = DockerEngineRuby::Internal::Util.dig(decoded, unwrap)
            DockerEngineRuby::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(
                T::Class[DockerEngineRuby::Internal::Type::BasePage[DockerEngineRuby::Internal::Type::BaseModel]]
              ),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(DockerEngineRuby::Internal::Type::Converter::Input),
              options: T.nilable(DockerEngineRuby::RequestOptions::OrHash)
            }
          end
        end
