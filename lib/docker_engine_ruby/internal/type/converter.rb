    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { DockerEngineRuby::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { DockerEngineRuby::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            DockerEngineRuby::FilePart.new(value)
          in DockerEngineRuby::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in DockerEngineRuby::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [DockerEngineRuby::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: DockerEngineRuby::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in DockerEngineRuby::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in DockerEngineRuby::Internal::Type::Converter
              ...
              DockerEngineRuby::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(DockerEngineRuby::Internal::Type::Converter, T::Class[T.anything]) }
        end
