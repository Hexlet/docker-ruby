    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { DockerEngineAPI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { DockerEngineAPI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            DockerEngineAPI::FilePart.new(value)
          in DockerEngineAPI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in DockerEngineAPI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [DockerEngineAPI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: DockerEngineAPI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in DockerEngineAPI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in DockerEngineAPI::Internal::Type::Converter
              ...
              DockerEngineAPI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(DockerEngineAPI::Internal::Type::Converter, T::Class[T.anything]) }
        end
