...
module DockerEngineAPI
  module Resources
    class Secrets
      ...
      #
      # @return [DockerEngineAPI::Models::SecretCreateResponse]
      #
      # @see DockerEngineAPI::Models::SecretCreateParams
      def create(params = {})
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::SecretUpdateParams
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<DockerEngineAPI::Models::Secret>]
      #
      # @see DockerEngineAPI::Models::SecretListParams
      def list(params = {})
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::SecretDeleteParams
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngineAPI::Models::Secret]
      #
      # @see DockerEngineAPI::Models::SecretInspectParams
