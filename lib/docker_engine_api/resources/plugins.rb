...
module DockerEngineAPI
  module Resources
    class Plugins
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginCreateParams
      def create(params)
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<DockerEngineAPI::Models::Plugin>]
      #
      # @see DockerEngineAPI::Models::PluginListParams
      def list(params = {})
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngineAPI::Models::Plugin]
      #
      # @see DockerEngineAPI::Models::PluginDeleteParams
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginDisableParams
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngineAPI::Models::PluginEnableParams} for more details.
      #
      # Enable a plugin
      #
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginEnableParams
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngineAPI::Models::PluginInspectParams} for more details.
      #
      # Inspect a plugin
      #
      ...
      # @return [DockerEngineAPI::Models::Plugin]
      #
      # @see DockerEngineAPI::Models::PluginInspectParams
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<DockerEngineAPI::Models::Privilege>]
      #
      # @see DockerEngineAPI::Models::PluginPrivilegesParams
      ...
      #
      # @param body [Array<DockerEngineAPI::Models::Privilege>] Body param
      #
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginPullParams
      def pull(params)
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngineAPI::Models::PluginPushParams} for more details.
      #
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginPushParams
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngineAPI::Models::PluginSetParams} for more details.
      #
      # Configure a plugin
      #
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginSetParams
      def set(name, params = {})
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::PluginUpgradeParams
