...
module DockerEngineAPI
  module Resources
    class Swarm
      ...
      # {DockerEngineAPI::Models::SwarmUpdateParams} for more details.
      #
      # Update a swarm
      #
      ...
      #
      # @param spec [DockerEngineAPI::Models::Spec] Body param: User modifiable swarm configuration.
      #
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::SwarmUpdateParams
      def update(params)
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngineAPI::Models::SwarmInitParams} for more details.
      #
      ...
      # @return [String]
      #
      # @see DockerEngineAPI::Models::SwarmInitParams
      def init(params = {})
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngineAPI::Models::SwarmAPI]
      #
      # @see DockerEngineAPI::Models::SwarmInspectParams
      def inspect_(params = {})
        @client.request(
          method: :get,
          path: "swarm",
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngineAPI::Models::SwarmJoinParams} for more details.
      #
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::SwarmJoinParams
      def join(params = {})
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::SwarmLeaveParams
      def leave(params = {})
      ...
      # @return [nil]
      #
      # @see DockerEngineAPI::Models::SwarmUnlockParams
      def unlock(params = {})
      ...
      # @param request_options [DockerEngineAPI::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngineAPI::Models::SwarmUnlockKeyResponse]
      #
      # @see DockerEngineAPI::Models::SwarmUnlockKeyParams
