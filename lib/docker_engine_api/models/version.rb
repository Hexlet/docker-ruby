...
module DockerEngineAPI
  module Models
    # @see DockerEngineAPI::Resources::System#version
    class Version < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<DockerEngineAPI::Models::Version::Component>, nil]
      optional :components,
               -> { DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::Version::Component] },
               api_name: :Components
      ...
      #
      #   @return [Boolean, nil]
      optional :experimental, DockerEngineAPI::Internal::Type::Boolean, api_name: :Experimental
      ...
      # @!attribute platform
      #
      #   @return [DockerEngineAPI::Models::Version::Platform, nil]
      optional :platform, -> { DockerEngineAPI::Version::Platform }, api_name: :Platform
      ...
      #   {DockerEngineAPI::Models::Version} for more details.
      #
      ...
      #
      #   @param components [Array<DockerEngineAPI::Models::Version::Component>] Information about system components
      #
      ...
      #
      #   @param platform [DockerEngineAPI::Models::Version::Platform]
      #
      ...
      # @see DockerEngineAPI::Models::Version#platform
