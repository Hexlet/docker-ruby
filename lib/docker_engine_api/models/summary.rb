...
module DockerEngineAPI
  module Models
    class Summary < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::Summary::Health, nil]
      ...
      #   "inspect" response.
      #
      #   @return [DockerEngineAPI::Models::Summary::HostConfig, nil]
      ...
      #
      #   @return [DockerEngineAPI::Models::Summary::ImageManifestDescriptor, nil]
      ...
      #
      #   @return [Array<DockerEngineAPI::Models::Summary::Mount>, nil]
      optional :mounts,
      ...
      #
      #   @return [DockerEngineAPI::Models::Summary::NetworkSettings, nil]
      optional :network_settings, -> { DockerEngineAPI::Summary::NetworkSettings }, api_name: :NetworkSettings

      # @!attribute ports
      #   Port-mappings for the container.
      #
      #   @return [Array<DockerEngineAPI::Models::Summary::Port>, nil]
      optional :ports,
      ...
      #
      #   @return [Symbol, DockerEngineAPI::Models::Summary::State, nil]
      ...
      #   {DockerEngineAPI::Models::Summary} for more details.
      #
      ...
      #
      #   @param health [DockerEngineAPI::Models::Summary::Health] Summary of health status
      #
      #   @param host_config [DockerEngineAPI::Models::Summary::HostConfig] Summary of host-specific runtime information of the container. This
      #
      ...
      #
      #   @param image_manifest_descriptor [DockerEngineAPI::Models::Summary::ImageManifestDescriptor] A descriptor struct containing digest, media type, and size, as defined in
      #
      #   @param labels [Hash{Symbol=>String}] User-defined key/value metadata.
      #
      #   @param mounts [Array<DockerEngineAPI::Models::Summary::Mount>] List of mounts used by the container.
      #
      #   @param names [Array<String>] The names associated with this container. Most containers have a single
      #
      #   @param network_settings [DockerEngineAPI::Models::Summary::NetworkSettings] Summary of the container's network settings
      #
      #   @param ports [Array<DockerEngineAPI::Models::Summary::Port>] Port-mappings for the container.
      #
      ...
      #
      #   @param state [Symbol, DockerEngineAPI::Models::Summary::State] The state of this container.
      #
      #   @param status [String] Additional human-readable status of this container (e.g. `Exit 0`)

      # @see DockerEngineAPI::Models::Summary#health
      class Health < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, DockerEngineAPI::Models::Summary::Health::Status, nil]
        ...
        #
        #   @param status [Symbol, DockerEngineAPI::Models::Summary::Health::Status] the health status of the container

        # the health status of the container
        #
        # @see DockerEngineAPI::Models::Summary::Health#status
        module Status
      ...
      # @see DockerEngineAPI::Models::Summary#host_config
      class HostConfig < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Summary::HostConfig} for more details.
        #
        #   Summary of host-specific runtime information of the container. This is a reduced
        #   set of information in the container's "HostConfig" as available in the container
        #   "inspect" response.
      ...
      # @see DockerEngineAPI::Models::Summary#image_manifest_descriptor
      class ImageManifestDescriptor < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [DockerEngineAPI::Models::Summary::ImageManifestDescriptor::Platform, nil]
        optional :platform, -> { DockerEngineAPI::Summary::ImageManifestDescriptor::Platform }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Summary::ImageManifestDescriptor} for more details.
        #
        #   A descriptor struct containing digest, media type, and size, as defined in the
        #   [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
        #
        ...
        #
        #   @param platform [DockerEngineAPI::Models::Summary::ImageManifestDescriptor::Platform, nil] Describes the platform which the image in the manifest runs on, as defined
        #
        ...
        # @see DockerEngineAPI::Models::Summary::ImageManifestDescriptor#platform
        class Platform < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Summary::ImageManifestDescriptor::Platform} for more
          #   details.
          #
          #   Describes the platform which the image in the manifest runs on, as defined in
          #   the
      ...
      class Mount < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, DockerEngineAPI::Models::Summary::Mount::Type, nil]
        optional :type, enum: -> { DockerEngineAPI::Summary::Mount::Type }, api_name: :Type

        # @!method initialize(destination: nil, driver: nil, mode: nil, name: nil, propagation: nil, rw: nil, source: nil, type: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Summary::Mount} for more details.
        #
        ...
        #
        #   @param type [Symbol, DockerEngineAPI::Models::Summary::Mount::Type] The mount type. Available types:
        ...
        # - `volume` a docker volume with the given `Name`.
        #
        # @see DockerEngineAPI::Models::Summary::Mount#type
        module Type
          extend DockerEngineAPI::Internal::Type::Enum
      ...
      # @see DockerEngineAPI::Models::Summary#network_settings
      class NetworkSettings < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [Hash{Symbol=>DockerEngineAPI::Models::Summary::NetworkSettings::Network}, nil]
        optional :networks,
                 -> {
                   DockerEngineAPI::Internal::Type::HashOf[DockerEngineAPI::Summary::NetworkSettings::Network]
                 },
                 api_name: :Networks

        # @!method initialize(networks: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Summary::NetworkSettings} for more details.
        #
        #   Summary of the container's network settings
        #
        #   @param networks [Hash{Symbol=>DockerEngineAPI::Models::Summary::NetworkSettings::Network}] Summary of network-settings for each network the container is
        ...
        class Network < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #
          #   @return [DockerEngineAPI::Models::Summary::NetworkSettings::Network::IpamConfig, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Summary::NetworkSettings::Network} for more details.
          #
          ...
          #
          #   @param ipam_config [DockerEngineAPI::Models::Summary::NetworkSettings::Network::IpamConfig, nil] EndpointIPAMConfig represents an endpoint's IPAM configuration.
          #
          ...
          # @see DockerEngineAPI::Models::Summary::NetworkSettings::Network#ipam_config
      ...
      class Port < DockerEngineAPI::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, DockerEngineAPI::Models::Summary::Port::Type]
        required :type, enum: -> { DockerEngineAPI::Summary::Port::Type }, api_name: :Type
      ...
      # The state of this container.
      #
      # @see DockerEngineAPI::Models::Summary#state
      module State
        extend DockerEngineAPI::Internal::Type::Enum
