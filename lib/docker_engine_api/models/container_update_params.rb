...
module DockerEngineAPI
  module Models
    ...
    class ContainerUpdateParams < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #   ```
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::BlkioDeviceReadBp>, nil]
      optional :blkio_device_read_bps,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::BlkioDeviceReadBp]
               },
      ...
      #   ```
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::BlkioDeviceReadIOp>, nil]
      optional :blkio_device_read_i_ops,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::BlkioDeviceReadIOp]
               },
      ...
      #   ```
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::BlkioDeviceWriteBp>, nil]
      optional :blkio_device_write_bps,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::BlkioDeviceWriteBp]
               },
      ...
      #   ```
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::BlkioDeviceWriteIOp>, nil]
      optional :blkio_device_write_i_ops,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::BlkioDeviceWriteIOp]
               },
      ...
      #   ```
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::BlkioWeightDevice>, nil]
      optional :blkio_weight_device,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::BlkioWeightDevice]
               },
      ...
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::DeviceRequest>, nil]
      optional :device_requests,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::DeviceRequest]
               },
      ...
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::Device>, nil]
      optional :devices,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::Device]
               },
               api_name: :Devices
      ...
      #
      #   @return [DockerEngineAPI::Models::ContainerUpdateParams::RestartPolicy, nil]
      ...
      #   ```
      #
      #   @return [Array<DockerEngineAPI::Models::ContainerUpdateParams::Ulimit>, nil]
      optional :ulimits,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::ContainerUpdateParams::Ulimit]
               },
               api_name: :Ulimits
      ...
      class DeviceRequest < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::ContainerUpdateParams::DeviceRequest} for more
        #   details.
        #
      ...
      class RestartPolicy < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, DockerEngineAPI::Models::ContainerUpdateParams::RestartPolicy::Name, nil]
        optional :name,
                 enum: -> {
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::ContainerUpdateParams::RestartPolicy} for more
        #   details.
        #
        #   The behavior to apply when the container exits. The default is not to restart.
        #
        ...
        #
        #   @param name [Symbol, DockerEngineAPI::Models::ContainerUpdateParams::RestartPolicy::Name] - Empty string means not to restart
        ...
        # - `on-failure` Restart only when the container exit code is non-zero
        #
        # @see DockerEngineAPI::Models::ContainerUpdateParams::RestartPolicy#name
        module Name
