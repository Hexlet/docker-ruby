...
module DockerEngineAPI
  module Models
    ...
    class Volume < DockerEngineAPI::Internal::Type::BaseModel
      ...
      required :labels, DockerEngineAPI::Internal::Type::HashOf[String], api_name: :Labels
      ...
      #
      #   @return [Hash{Symbol=>String}]
      required :options, DockerEngineAPI::Internal::Type::HashOf[String], api_name: :Options

      # @!attribute scope
      #   The level at which the volume exists. Either `global` for cluster-wide, or
      #   `local` for machine level.
      #
      #   @return [Symbol, DockerEngineAPI::Models::Volume::Scope]
      required :scope, enum: -> { DockerEngineAPI::Volume::Scope }, api_name: :Scope

      # @!attribute cluster_volume
      #   Options and information specific to, and only present on, Swarm CSI cluster
      #   volumes.
      #
      #   @return [DockerEngineAPI::Models::Volume::ClusterVolume, nil]
      optional :cluster_volume, -> { DockerEngineAPI::Volume::ClusterVolume }, api_name: :ClusterVolume
      ...
      #
      #   @return [DockerEngineAPI::Models::Volume::UsageData, nil]
      optional :usage_data, -> { DockerEngineAPI::Volume::UsageData }, api_name: :UsageData, nil?: true
      ...
      #   {DockerEngineAPI::Models::Volume} for more details.
      #
      ...
      #
      #   @param scope [Symbol, DockerEngineAPI::Models::Volume::Scope] The level at which the volume exists. Either `global` for cluster-wide,
      #
      #   @param cluster_volume [DockerEngineAPI::Models::Volume::ClusterVolume] Options and information specific to, and only present on, Swarm CSI
      #
      ...
      #
      #   @param usage_data [DockerEngineAPI::Models::Volume::UsageData, nil] Usage details about the volume. This information is used by the

      # The level at which the volume exists. Either `global` for cluster-wide, or
      # `local` for machine level.
      #
      # @see DockerEngineAPI::Models::Volume#scope
      module Scope
      ...
      # @see DockerEngineAPI::Models::Volume#cluster_volume
      class ClusterVolume < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [DockerEngineAPI::Models::Volume::ClusterVolume::Info, nil]
        optional :info, -> { DockerEngineAPI::Volume::ClusterVolume::Info }, api_name: :Info

        # @!attribute publish_status
        #   The status of the volume as it pertains to its publishing and use on specific
        #   nodes
        #
        #   @return [Array<DockerEngineAPI::Models::Volume::ClusterVolume::PublishStatus>, nil]
        optional :publish_status,
                 -> {
                   DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::Volume::ClusterVolume::PublishStatus]
                 },
        ...
        #
        #   @return [DockerEngineAPI::Models::Volume::ClusterVolume::Spec, nil]
        optional :spec, -> { DockerEngineAPI::Volume::ClusterVolume::Spec }, api_name: :Spec
        ...
        #
        #   @return [DockerEngineAPI::Models::Volume::ClusterVolume::Version, nil]
        optional :version, -> { DockerEngineAPI::Volume::ClusterVolume::Version }, api_name: :Version

        # @!method initialize(created_at: nil, id: nil, info: nil, publish_status: nil, spec: nil, updated_at: nil, version: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Volume::ClusterVolume} for more details.
        #
        #   Options and information specific to, and only present on, Swarm CSI cluster
        #   volumes.
        #
        ...
        #
        #   @param info [DockerEngineAPI::Models::Volume::ClusterVolume::Info] Information about the global status of the volume.
        #
        #   @param publish_status [Array<DockerEngineAPI::Models::Volume::ClusterVolume::PublishStatus>] The status of the volume as it pertains to its publishing and use on
        #
        #   @param spec [DockerEngineAPI::Models::Volume::ClusterVolume::Spec] Cluster-specific options used to create the volume.
        #
        #   @param updated_at [String]
        #
        #   @param version [DockerEngineAPI::Models::Volume::ClusterVolume::Version] The version number of the object such as node, service, etc. This is needed

        # @see DockerEngineAPI::Models::Volume::ClusterVolume#info
        class Info < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Volume::ClusterVolume::Info} for more details.
          #
          #   Information about the global status of the volume.
          #
        ...
        class PublishStatus < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::PublishStatus::State, nil]
          optional :state,
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Volume::ClusterVolume::PublishStatus} for more
          #   details.
          #
          ...
          #
          #   @param state [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::PublishStatus::State] The published state of the volume.
          ...
          #   node, but has not yet been successfully unpublished on the controller.
          #
          # @see DockerEngineAPI::Models::Volume::ClusterVolume::PublishStatus#state
          module State
            extend DockerEngineAPI::Internal::Type::Enum
        ...
        # @see DockerEngineAPI::Models::Volume::ClusterVolume#spec
        class Spec < DockerEngineAPI::Internal::Type::BaseModel
          # @!attribute access_mode
          #   Defines how the volume is used by tasks.
          #
          #   @return [DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Volume::ClusterVolume::Spec} for more details.
          #
          #   Cluster-specific options used to create the volume.
          #
          #   @param access_mode [DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode] Defines how the volume is used by tasks.
          #
          #   @param group [String] Group defines the volume group of this volume. Volumes belonging to

          # @see DockerEngineAPI::Models::Volume::ClusterVolume::Spec#access_mode
          class AccessMode < DockerEngineAPI::Internal::Type::BaseModel
            ...
            #   specification.
            #
            #   @return [DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements, nil]
            ...
            #
            #   @return [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Availability, nil]
            ...
            #
            #   @return [DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::CapacityRange, nil]
            ...
            #     time.
            #
            #   @return [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Scope, nil]
            optional :scope,
            ...
            #   volume.
            #
            #   @return [Array<DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Secret>, nil]
            optional :secrets,
                     -> {
            ...
            #
            #   @return [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Sharing, nil]
            optional :sharing,
            ...
            #   Some parameter documentations has been truncated, see
            #   {DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode} for more
            #   details.
            #
            #   Defines how the volume is used by tasks.
            #
            #   @param accessibility_requirements [DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements] Requirements for the accessible topology of the volume. These
            #
            #   @param availability [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Availability] The availability of the volume for use in tasks.
            #
            #   @param capacity_range [DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::CapacityRange] The desired capacity that the volume should be created with. If
            #
            #   @param mount_volume [Object] Options for using this volume as a Mount-type volume.
            #
            #   @param scope [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Scope] The set of nodes this volume can be used on at one time.
            #
            #   @param secrets [Array<DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Secret>] Swarm Secrets that are passed to the CSI storage plugin when
            #
            #   @param sharing [Symbol, DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Sharing] The number and way that different tasks can use this volume

            # @see DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode#accessibility_requirements
            class AccessibilityRequirements < DockerEngineAPI::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements}
              #   for more details.
              #
              #   Requirements for the accessible topology of the volume. These fields are
              #   optional. For an in-depth description of what these fields mean, see the CSI
            ...
            #   no new ones should be started.
            #
            # @see DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode#availability
            module Availability
              extend DockerEngineAPI::Internal::Type::Enum
            ...
            # @see DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode#capacity_range
            class CapacityRange < DockerEngineAPI::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::CapacityRange}
              #   for more details.
              #
              #   The desired capacity that the volume should be created with. If empty, the
              #   plugin will decide the capacity.
            ...
            #   time.
            #
            # @see DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode#scope
            module Scope
              extend DockerEngineAPI::Internal::Type::Enum
            ...
            class Secret < DockerEngineAPI::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode::Secret} for
              #   more details.
              #
            ...
            # - `all` The volume may have any number of readers and writers.
            #
            # @see DockerEngineAPI::Models::Volume::ClusterVolume::Spec::AccessMode#sharing
            module Sharing
              extend DockerEngineAPI::Internal::Type::Enum
        ...
        # @see DockerEngineAPI::Models::Volume::ClusterVolume#version
      ...
      # @see DockerEngineAPI::Models::Volume#usage_data
      class UsageData < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Volume::UsageData} for more details.
        #
        #   Usage details about the volume. This information is used by the `GET /system/df`
        #   endpoint, and omitted in other endpoints.
        #
