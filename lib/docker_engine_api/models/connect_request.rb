...
module DockerEngineAPI
  module Models
    class ConnectRequest < DockerEngineAPI::Internal::Type::BaseModel
      # @!attribute container
      ...
      #
      #   @return [DockerEngineAPI::Models::ConnectRequest::EndpointConfig, nil]
      optional :endpoint_config,
               -> { DockerEngineAPI::ConnectRequest::EndpointConfig },
      ...
      # @see DockerEngineAPI::Models::ConnectRequest#endpoint_config
      class EndpointConfig < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute aliases
        #
        ...
        #
        #   @return [DockerEngineAPI::Models::ConnectRequest::EndpointConfig::IpamConfig, nil]
        optional :ipam_config,
                 -> { DockerEngineAPI::ConnectRequest::EndpointConfig::IpamConfig },
                 api_name: :IPAMConfig,
                 nil?: true
        ...
        #   {DockerEngineAPI::Models::ConnectRequest::EndpointConfig} for more details.
        #
        #   Configuration for a network endpoint.
        #
        ...
        #
        #   @param ipam_config [DockerEngineAPI::Models::ConnectRequest::EndpointConfig::IpamConfig, nil] EndpointIPAMConfig represents an endpoint's IPAM configuration.
        #
        ...
        # @see DockerEngineAPI::Models::ConnectRequest::EndpointConfig#ipam_config
        class IpamConfig < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<String>, nil]
          optional :link_local_ips, DockerEngineAPI::Internal::Type::ArrayOf[String], api_name: :LinkLocalIPs
