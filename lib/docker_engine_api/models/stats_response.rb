...
module DockerEngineAPI
  module Models
    ...
    class StatsResponse < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::StatsResponse::BlkioStats, nil]
      optional :blkio_stats, -> { DockerEngineAPI::StatsResponse::BlkioStats }, nil?: true

      # @!attribute cpu_stats
      #   CPU related info of the container
      #
      #   @return [DockerEngineAPI::Models::StatsResponse::CPUStats, nil]
      ...
      #
      #   @return [DockerEngineAPI::Models::StatsResponse::MemoryStats, nil]
      ...
      #
      #   @return [DockerEngineAPI::Models::StatsResponse::PidsStats, nil]
      optional :pids_stats, -> { DockerEngineAPI::StatsResponse::PidsStats }, nil?: true

      # @!attribute precpu_stats
      #   CPU related info of the container
      #
      #   @return [DockerEngineAPI::Models::StatsResponse::PrecpuStats, nil]
      ...
      #
      #   @return [DockerEngineAPI::Models::StatsResponse::StorageStats, nil]
      ...
      #   {DockerEngineAPI::Models::StatsResponse} for more details.
      #
      #   Statistics sample for a container.
      #
      #   @param id [String, nil] ID of the container for which the stats were collected.
      #
      #   @param blkio_stats [DockerEngineAPI::Models::StatsResponse::BlkioStats, nil] BlkioStats stores all IO service stats for data read and write.
      #
      #   @param cpu_stats [DockerEngineAPI::Models::StatsResponse::CPUStats, nil] CPU related info of the container
      #
      #   @param memory_stats [DockerEngineAPI::Models::StatsResponse::MemoryStats] Aggregates all memory stats since container inception on Linux.
      #
      ...
      #
      #   @param pids_stats [DockerEngineAPI::Models::StatsResponse::PidsStats, nil] PidsStats contains Linux-specific stats of a container's process-IDs (PIDs).
      #
      #   @param precpu_stats [DockerEngineAPI::Models::StatsResponse::PrecpuStats, nil] CPU related info of the container
      #
      ...
      #
      #   @param storage_stats [DockerEngineAPI::Models::StatsResponse::StorageStats, nil] StorageStats is the disk I/O stats for read/write on Windows.

      # @see DockerEngineAPI::Models::StatsResponse#blkio_stats
      class BlkioStats < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoMergedRecursive, nil>, nil]
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoQueueRecursive, nil>, nil]
        ...
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoServiceBytesRecursive, nil>, nil]
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoServiceTimeRecursive, nil>, nil]
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoServicedRecursive, nil>, nil]
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoTimeRecursive, nil>, nil]
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoWaitTimeRecursive, nil>, nil]
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::SectorsRecursive, nil>, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::StatsResponse::BlkioStats} for more details.
        #
        #   BlkioStats stores all IO service stats for data read and write.
        #
        #   This type is Linux-specific and holds many fields that are specific to cgroups
        ...
        #   This type is only populated on Linux and omitted for Windows containers.
        #
        #   @param io_merged_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoMergedRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_queue_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoQueueRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_service_bytes_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoServiceBytesRecursive, nil>]
        #
        #   @param io_service_time_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoServiceTimeRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_serviced_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoServicedRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_time_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoTimeRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_wait_time_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::IoWaitTimeRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param sectors_recursive [Array<DockerEngineAPI::Models::StatsResponse::BlkioStats::SectorsRecursive, nil>, nil] This field is only available when using Linux containers with
      ...
      # @see DockerEngineAPI::Models::StatsResponse#cpu_stats
      class CPUStats < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute cpu_usage
        #   All CPU stats aggregated since container inception.
        #
        #   @return [DockerEngineAPI::Models::StatsResponse::CPUStats::CPUUsage, nil]
        optional :cpu_usage, -> { DockerEngineAPI::StatsResponse::CPUStats::CPUUsage }, nil?: true
        ...
        #   This type is Linux-specific and omitted for Windows containers.
        #
        #   @return [DockerEngineAPI::Models::StatsResponse::CPUStats::ThrottlingData, nil]
        optional :throttling_data, -> { DockerEngineAPI::StatsResponse::CPUStats::ThrottlingData }, nil?: true

        # @!method initialize(cpu_usage: nil, online_cpus: nil, system_cpu_usage: nil, throttling_data: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::StatsResponse::CPUStats} for more details.
        #
        #   CPU related info of the container
        #
        #   @param cpu_usage [DockerEngineAPI::Models::StatsResponse::CPUStats::CPUUsage, nil] All CPU stats aggregated since container inception.
        #
        #   @param online_cpus [Integer, nil] Number of online CPUs.
        #
        #   @param system_cpu_usage [Integer, nil] System Usage.
        #
        #   @param throttling_data [DockerEngineAPI::Models::StatsResponse::CPUStats::ThrottlingData, nil] CPU throttling stats of the container.

        # @see DockerEngineAPI::Models::StatsResponse::CPUStats#cpu_usage
        class CPUUsage < DockerEngineAPI::Internal::Type::BaseModel
          ...
          optional :percpu_usage, DockerEngineAPI::Internal::Type::ArrayOf[Integer], nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::StatsResponse::CPUStats::CPUUsage} for more details.
          #
          #   All CPU stats aggregated since container inception.
          #
        ...
        # @see DockerEngineAPI::Models::StatsResponse::CPUStats#throttling_data
        class ThrottlingData < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::StatsResponse::CPUStats::ThrottlingData} for more
          #   details.
          #
          #   CPU throttling stats of the container.
          #
      ...
      # @see DockerEngineAPI::Models::StatsResponse#memory_stats
      class MemoryStats < DockerEngineAPI::Internal::Type::BaseModel
        ...
        optional :stats, DockerEngineAPI::Internal::Type::HashOf[Integer]
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::StatsResponse::MemoryStats} for more details.
        #
        #   Aggregates all memory stats since container inception on Linux. Windows returns
        #   stats for commit and private working set only.
        #
      ...
      # @see DockerEngineAPI::Models::StatsResponse#pids_stats
      class PidsStats < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::StatsResponse::PidsStats} for more details.
        #
        #   PidsStats contains Linux-specific stats of a container's process-IDs (PIDs).
        #
        #   This type is Linux-specific and omitted for Windows containers.
      ...
      # @see DockerEngineAPI::Models::StatsResponse#precpu_stats
      class PrecpuStats < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute cpu_usage
        #   All CPU stats aggregated since container inception.
        #
        #   @return [DockerEngineAPI::Models::StatsResponse::PrecpuStats::CPUUsage, nil]
        optional :cpu_usage, -> { DockerEngineAPI::StatsResponse::PrecpuStats::CPUUsage }, nil?: true
        ...
        #   This type is Linux-specific and omitted for Windows containers.
        #
        #   @return [DockerEngineAPI::Models::StatsResponse::PrecpuStats::ThrottlingData, nil]
        ...
        # @!method initialize(cpu_usage: nil, online_cpus: nil, system_cpu_usage: nil, throttling_data: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::StatsResponse::PrecpuStats} for more details.
        #
        #   CPU related info of the container
        #
        #   @param cpu_usage [DockerEngineAPI::Models::StatsResponse::PrecpuStats::CPUUsage, nil] All CPU stats aggregated since container inception.
        #
        #   @param online_cpus [Integer, nil] Number of online CPUs.
        #
        #   @param system_cpu_usage [Integer, nil] System Usage.
        #
        #   @param throttling_data [DockerEngineAPI::Models::StatsResponse::PrecpuStats::ThrottlingData, nil] CPU throttling stats of the container.

        # @see DockerEngineAPI::Models::StatsResponse::PrecpuStats#cpu_usage
        class CPUUsage < DockerEngineAPI::Internal::Type::BaseModel
          # @!attribute percpu_usage
          #   Total CPU time (in nanoseconds) consumed per core (Linux).
          #
          ...
          # @!method initialize(percpu_usage: nil, total_usage: nil, usage_in_kernelmode: nil, usage_in_usermode: nil)
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::StatsResponse::PrecpuStats::CPUUsage} for more
          #   details.
          #
          #   All CPU stats aggregated since container inception.
          #
        ...
        # @see DockerEngineAPI::Models::StatsResponse::PrecpuStats#throttling_data
        class ThrottlingData < DockerEngineAPI::Internal::Type::BaseModel
          # @!attribute periods
          #   Number of periods with throttling active.
          #
          ...
          # @!method initialize(periods: nil, throttled_periods: nil, throttled_time: nil)
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::StatsResponse::PrecpuStats::ThrottlingData} for more
          #   details.
          #
          #   CPU throttling stats of the container.
          #
      ...
      # @see DockerEngineAPI::Models::StatsResponse#storage_stats
