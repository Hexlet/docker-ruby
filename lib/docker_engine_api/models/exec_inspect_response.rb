...
module DockerEngineAPI
  module Models
    # @see DockerEngineAPI::Resources::Exec#inspect_
    class ExecInspectResponse < DockerEngineAPI::Internal::Type::BaseModel
      # @!attribute can_remove
      #
      #   @return [Boolean, nil]
      optional :can_remove, DockerEngineAPI::Internal::Type::Boolean, api_name: :CanRemove
      ...
      #
      #   @return [Boolean, nil]
      optional :open_stderr, DockerEngineAPI::Internal::Type::Boolean, api_name: :OpenStderr

      # @!attribute open_stdin
      #
      #   @return [Boolean, nil]
      optional :open_stdin, DockerEngineAPI::Internal::Type::Boolean, api_name: :OpenStdin

      # @!attribute open_stdout
      #
      #   @return [Boolean, nil]
      optional :open_stdout, DockerEngineAPI::Internal::Type::Boolean, api_name: :OpenStdout
      ...
      #
      #   @return [DockerEngineAPI::Models::InspectResponse, nil]
      optional :process_config, -> { DockerEngineAPI::InspectResponse }, api_name: :ProcessConfig
      ...
      #
      #   @param process_config [DockerEngineAPI::Models::InspectResponse]
      #
