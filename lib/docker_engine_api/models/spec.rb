...
module DockerEngineAPI
  module Models
    class Spec < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::Spec::EndpointSpec, nil]
      ...
      #
      #   @return [DockerEngineAPI::Models::Spec::Mode, nil]
      ...
      #
      #   @return [Array<DockerEngineAPI::Models::Spec::Network>, nil]
      optional :networks,
      ...
      #
      #   @return [DockerEngineAPI::Models::Spec::RollbackConfig, nil]
      ...
      #
      #   @return [DockerEngineAPI::Models::Spec::UpdateConfig, nil]
      ...
      #   {DockerEngineAPI::Models::Spec} for more details.
      #
      #   User modifiable configuration for a service.
      #
      #   @param endpoint_spec [DockerEngineAPI::Models::Spec::EndpointSpec] Properties that can be configured to access and load balance a service.
      #
      #   @param labels [Hash{Symbol=>String}] User-defined key/value metadata.
      #
      #   @param mode [DockerEngineAPI::Models::Spec::Mode] Scheduling mode for the service.
      #
      #   @param name [String] Name of the service.
      #
      #   @param networks [Array<DockerEngineAPI::Models::Spec::Network>] Specifies which networks the service should attach to.
      #
      #   @param rollback_config [DockerEngineAPI::Models::Spec::RollbackConfig] Specification for the rollback strategy of the service.
      #
      #   @param task_template [DockerEngineAPI::Models::Spec] User modifiable task configuration.
      #
      #   @param update_config [DockerEngineAPI::Models::Spec::UpdateConfig] Specification for the update strategy of the service.

      # @see DockerEngineAPI::Models::Spec#endpoint_spec
      class EndpointSpec < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute mode
        #   The mode of resolution to use for internal load balancing between tasks.
        #
        #   @return [Symbol, DockerEngineAPI::Models::Spec::EndpointSpec::Mode, nil]
        optional :mode, enum: -> { DockerEngineAPI::Spec::EndpointSpec::Mode }, api_name: :Mode
        ...
        #
        #   @return [Array<DockerEngineAPI::Models::Spec::EndpointSpec::Port>, nil]
        optional :ports,
                 -> { DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::Spec::EndpointSpec::Port] },
                 api_name: :Ports

        # @!method initialize(mode: nil, ports: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Spec::EndpointSpec} for more details.
        #
        #   Properties that can be configured to access and load balance a service.
        #
        #   @param mode [Symbol, DockerEngineAPI::Models::Spec::EndpointSpec::Mode] The mode of resolution to use for internal load balancing between tasks.
        #
        #   @param ports [Array<DockerEngineAPI::Models::Spec::EndpointSpec::Port>] List of exposed ports that this service is accessible on from the

        # The mode of resolution to use for internal load balancing between tasks.
        #
        # @see DockerEngineAPI::Models::Spec::EndpointSpec#mode
        module Mode
        ...
        class Port < DockerEngineAPI::Internal::Type::BaseModel
          ...
          # @!attribute protocol
          #
          #   @return [Symbol, DockerEngineAPI::Models::Spec::EndpointSpec::Port::Protocol, nil]
          optional :protocol,
                   enum: -> {
          ...
          #
          #   @return [Symbol, DockerEngineAPI::Models::Spec::EndpointSpec::Port::PublishMode, nil]
          optional :publish_mode,
                   enum: -> { DockerEngineAPI::Spec::EndpointSpec::Port::PublishMode },
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Spec::EndpointSpec::Port} for more details.
          #
          #   @param name [String]
          #
          #   @param protocol [Symbol, DockerEngineAPI::Models::Spec::EndpointSpec::Port::Protocol]
          #
          #   @param published_port [Integer] The port on the swarm hosts.
          #
          #   @param publish_mode [Symbol, DockerEngineAPI::Models::Spec::EndpointSpec::Port::PublishMode] The mode in which port is published.
          #
          #   @param target_port [Integer] The port inside the container.

          # @see DockerEngineAPI::Models::Spec::EndpointSpec::Port#protocol
          module Protocol
            extend DockerEngineAPI::Internal::Type::Enum
          ...
          #   node where that service is running.
          #
          # @see DockerEngineAPI::Models::Spec::EndpointSpec::Port#publish_mode
          module PublishMode
            extend DockerEngineAPI::Internal::Type::Enum
      ...
      # @see DockerEngineAPI::Models::Spec#mode
      class Mode < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute global
        #
        #   @return [Object, nil]
        optional :global, DockerEngineAPI::Internal::Type::Unknown, api_name: :Global
        ...
        #
        #   @return [Object, nil]
        optional :global_job, DockerEngineAPI::Internal::Type::Unknown, api_name: :GlobalJob

        # @!attribute replicated
        #
        #   @return [DockerEngineAPI::Models::Spec::Mode::Replicated, nil]
        optional :replicated, -> { DockerEngineAPI::Spec::Mode::Replicated }, api_name: :Replicated

        # @!attribute replicated_job
        #   The mode used for services with a finite number of tasks that run to a completed
        #   state.
        #
        #   @return [DockerEngineAPI::Models::Spec::Mode::ReplicatedJob, nil]
        optional :replicated_job, -> { DockerEngineAPI::Spec::Mode::ReplicatedJob }, api_name: :ReplicatedJob

        # @!method initialize(global: nil, global_job: nil, replicated: nil, replicated_job: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Spec::Mode} for more details.
        #
        #   Scheduling mode for the service.
        #
        #   @param global [Object]
        ...
        #
        #   @param replicated [DockerEngineAPI::Models::Spec::Mode::Replicated]
        #
        #   @param replicated_job [DockerEngineAPI::Models::Spec::Mode::ReplicatedJob] The mode used for services with a finite number of tasks that run

        # @see DockerEngineAPI::Models::Spec::Mode#replicated
        ...
        # @see DockerEngineAPI::Models::Spec::Mode#replicated_job
        class ReplicatedJob < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Spec::Mode::ReplicatedJob} for more details.
          #
          #   The mode used for services with a finite number of tasks that run to a completed
          #   state.
          #
      ...
      class Network < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Spec::Network} for more details.
        #
      ...
      # @see DockerEngineAPI::Models::Spec#rollback_config
      class RollbackConfig < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   rollback.
        #
        #   @return [Symbol, DockerEngineAPI::Models::Spec::RollbackConfig::FailureAction, nil]
        ...
        #   task is shut down.
        #
        #   @return [Symbol, DockerEngineAPI::Models::Spec::RollbackConfig::Order, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Spec::RollbackConfig} for more details.
        #
        #   Specification for the rollback strategy of the service.
        #
        #   @param delay [Integer] Amount of time between rollback iterations, in nanoseconds.
        #
        #   @param failure_action [Symbol, DockerEngineAPI::Models::Spec::RollbackConfig::FailureAction] Action to take if an rolled back task fails to run, or stops
        #
        ...
        #
        #   @param order [Symbol, DockerEngineAPI::Models::Spec::RollbackConfig::Order] The order of operations when rolling back a task. Either the old
        #
        ...
        # rollback.
        #
        # @see DockerEngineAPI::Models::Spec::RollbackConfig#failure_action
        ...
        # task is shut down.
        #
        # @see DockerEngineAPI::Models::Spec::RollbackConfig#order
        module Order
          extend DockerEngineAPI::Internal::Type::Enum
      ...
      # @see DockerEngineAPI::Models::Spec#update_config
      class UpdateConfig < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   update.
        #
        #   @return [Symbol, DockerEngineAPI::Models::Spec::UpdateConfig::FailureAction, nil]
        optional :failure_action,
        ...
        #
        #   @return [Symbol, DockerEngineAPI::Models::Spec::UpdateConfig::Order, nil]
        ...
        # @!method initialize(delay: nil, failure_action: nil, max_failure_ratio: nil, monitor: nil, order: nil, parallelism: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Spec::UpdateConfig} for more details.
        #
        #   Specification for the update strategy of the service.
        #
        #   @param delay [Integer] Amount of time between updates, in nanoseconds.
        #
        #   @param failure_action [Symbol, DockerEngineAPI::Models::Spec::UpdateConfig::FailureAction] Action to take if an updated task fails to run, or stops running
        #
        ...
        #
        #   @param order [Symbol, DockerEngineAPI::Models::Spec::UpdateConfig::Order] The order of operations when rolling out an updated task. Either
        #
        ...
        # update.
        #
        # @see DockerEngineAPI::Models::Spec::UpdateConfig#failure_action
        module FailureAction
          extend DockerEngineAPI::Internal::Type::Enum
        ...
        # old task is shut down.
        #
        # @see DockerEngineAPI::Models::Spec::UpdateConfig#order
        module Order
          extend DockerEngineAPI::Internal::Type::Enum
