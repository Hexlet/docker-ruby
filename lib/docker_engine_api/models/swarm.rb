...
module DockerEngineAPI
  module Models
    # @see DockerEngineAPI::Resources::Swarm#inspect_
    class SwarmAPI < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::SwarmAPI::JoinTokens, nil]
      optional :join_tokens, -> { DockerEngineAPI::SwarmAPI::JoinTokens }, api_name: :JoinTokens
      ...
      #   certificate.
      #
      #   @return [DockerEngineAPI::Models::SwarmAPI::TlsInfo, nil]
      optional :tls_info, -> { DockerEngineAPI::SwarmAPI::TlsInfo }, api_name: :TLSInfo
      ...
      #
      #   @return [DockerEngineAPI::Models::SwarmAPI::Version, nil]
      optional :version, -> { DockerEngineAPI::SwarmAPI::Version }, api_name: :Version
      ...
      #   {DockerEngineAPI::Models::SwarmAPI} for more details.
      #
      ...
      #
      #   @param join_tokens [DockerEngineAPI::Models::SwarmAPI::JoinTokens] JoinTokens contains the tokens workers and managers need to join the swarm.
      #
      ...
      #
      #   @param tls_info [DockerEngineAPI::Models::SwarmAPI::TlsInfo] Information about the issuer of leaf TLS certificates and the trusted root
      #
      #   @param updated_at [String] Date and time at which the swarm was last updated in
      #
      #   @param version [DockerEngineAPI::Models::SwarmAPI::Version] The version number of the object such as node, service, etc. This is needed

      # @see DockerEngineAPI::Models::SwarmAPI#join_tokens
      class JoinTokens < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute manager
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::SwarmAPI::JoinTokens} for more details.
        #
        #   JoinTokens contains the tokens workers and managers need to join the swarm.
        #
      ...
      # @see DockerEngineAPI::Models::SwarmAPI#tls_info
      class TlsInfo < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::SwarmAPI::TlsInfo} for more details.
        #
        #   Information about the issuer of leaf TLS certificates and the trusted root CA
        #   certificate.
        #
      ...
      # @see DockerEngineAPI::Models::SwarmAPI#version
