...
module DockerEngineAPI
  module Models
    # @see DockerEngineAPI::Resources::Swarm#update
    class SwarmUpdateParams < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :rotate_manager_token, DockerEngineAPI::Internal::Type::Boolean

      # @!attribute rotate_manager_unlock_key
      #   Rotate the manager unlock key.
      #
      #   @return [Boolean, nil]
      optional :rotate_manager_unlock_key, DockerEngineAPI::Internal::Type::Boolean

      # @!attribute rotate_worker_token
      #   Rotate the worker join token.
      #
      #   @return [Boolean, nil]
      optional :rotate_worker_token, DockerEngineAPI::Internal::Type::Boolean
