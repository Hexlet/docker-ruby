...
module DockerEngineAPI
  module Models
    class Config < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::Config::Healthcheck, nil]
      optional :healthcheck, -> { DockerEngineAPI::Config::Healthcheck }, api_name: :Healthcheck
      ...
      #
      #   @return [Boolean, nil]
      optional :stdin_once, DockerEngineAPI::Internal::Type::Boolean, api_name: :StdinOnce
      ...
      #   {DockerEngineAPI::Models::Config} for more details.
      #
      ...
      #
      #   @param healthcheck [DockerEngineAPI::Models::Config::Healthcheck] A test to perform to check that the container is healthy.
      #
      ...
      # @see DockerEngineAPI::Models::Config#healthcheck
      class Healthcheck < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Config::Healthcheck} for more details.
        #
        #   A test to perform to check that the container is healthy. Healthcheck commands
        #   should be side-effect free.
        #
