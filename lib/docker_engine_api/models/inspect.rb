...
module DockerEngineAPI
  module Models
    ...
    class Inspect < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::Inspect::Descriptor]
      required :descriptor, -> { DockerEngineAPI::Inspect::Descriptor }, api_name: :Descriptor

      # @!attribute platforms
      #   An array containing all platforms supported by the image.
      #
      #   @return [Array<DockerEngineAPI::Models::Inspect::Platform, nil>]
      required :platforms,
               -> {
                 DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::Inspect::Platform, nil?: true]
               },
               api_name: :Platforms

      # @!method initialize(descriptor:, platforms:)
      #   Some parameter documentations has been truncated, see
      #   {DockerEngineAPI::Models::Inspect} for more details.
      #
      #   Describes the result obtained from contacting the registry to retrieve image
      #   metadata.
      #
      #   @param descriptor [DockerEngineAPI::Models::Inspect::Descriptor] A descriptor struct containing digest, media type, and size, as defined in
      #
      #   @param platforms [Array<DockerEngineAPI::Models::Inspect::Platform, nil>] An array containing all platforms supported by the image.

      # @see DockerEngineAPI::Models::Inspect#descriptor
      class Descriptor < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [DockerEngineAPI::Models::Inspect::Descriptor::Platform, nil]
        optional :platform, -> { DockerEngineAPI::Inspect::Descriptor::Platform }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Inspect::Descriptor} for more details.
        #
        #   A descriptor struct containing digest, media type, and size, as defined in the
        #   [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
        #
        ...
        #
        #   @param platform [DockerEngineAPI::Models::Inspect::Descriptor::Platform, nil] Describes the platform which the image in the manifest runs on, as defined
        #
        ...
        # @see DockerEngineAPI::Models::Inspect::Descriptor#platform
        class Platform < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::Inspect::Descriptor::Platform} for more details.
          #
          #   Describes the platform which the image in the manifest runs on, as defined in
          #   the
          #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
      ...
      class Platform < DockerEngineAPI::Internal::Type::BaseModel
        ...
        # @!method initialize(architecture: nil, os: nil, os_features: nil, os_version: nil, variant: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Inspect::Platform} for more details.
        #
        #   Describes the platform which the image in the manifest runs on, as defined in
        #   the
        #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
