...
module DockerEngineAPI
  module Models
    class CreateRequest < DockerEngineAPI::Internal::Type::BaseModel
      # @!attribute cluster_volume_spec
      #   Cluster-specific options used to create the volume.
      #
      #   @return [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec, nil]
      optional :cluster_volume_spec,
               -> { DockerEngineAPI::CreateRequest::ClusterVolumeSpec },
      ...
      #   {DockerEngineAPI::Models::CreateRequest} for more details.
      #
      #   Volume configuration
      #
      #   @param cluster_volume_spec [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec] Cluster-specific options used to create the volume.
      #
      ...
      # @see DockerEngineAPI::Models::CreateRequest#cluster_volume_spec
      class ClusterVolumeSpec < DockerEngineAPI::Internal::Type::BaseModel
        # @!attribute access_mode
        #   Defines how the volume is used by tasks.
        #
        #   @return [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode, nil]
        optional :access_mode,
                 -> { DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode },
                 api_name: :AccessMode
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec} for more details.
        #
        #   Cluster-specific options used to create the volume.
        #
        #   @param access_mode [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode] Defines how the volume is used by tasks.
        #
        #   @param group [String] Group defines the volume group of this volume. Volumes belonging to

        # @see DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec#access_mode
        class AccessMode < DockerEngineAPI::Internal::Type::BaseModel
          ...
          #   specification.
          #
          #   @return [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements, nil]
          optional :accessibility_requirements,
                   -> {
                     DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements
                   },
          ...
          #
          #   @return [Symbol, DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Availability, nil]
          optional :availability,
                   enum: -> { DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Availability },
          ...
          #
          #   @return [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange, nil]
          optional :capacity_range,
                   -> { DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange },
          ...
          #     time.
          #
          #   @return [Symbol, DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Scope, nil]
          optional :scope,
                   enum: -> { DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Scope },
                   api_name: :Scope
          ...
          #   volume.
          #
          #   @return [Array<DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Secret>, nil]
          optional :secrets,
                   -> {
                     DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Secret]
                   },
                   api_name: :Secrets
          ...
          #
          #   @return [Symbol, DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing, nil]
          optional :sharing,
                   enum: -> { DockerEngineAPI::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing },
                   api_name: :Sharing
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode} for more
          #   details.
          #
          #   Defines how the volume is used by tasks.
          #
          #   @param accessibility_requirements [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements] Requirements for the accessible topology of the volume. These
          #
          #   @param availability [Symbol, DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Availability] The availability of the volume for use in tasks.
          #
          #   @param capacity_range [DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange] The desired capacity that the volume should be created with. If
          #
          #   @param mount_volume [Object] Options for using this volume as a Mount-type volume.
          #
          #   @param scope [Symbol, DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Scope] The set of nodes this volume can be used on at one time.
          #
          #   @param secrets [Array<DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Secret>] Swarm Secrets that are passed to the CSI storage plugin when
          #
          #   @param sharing [Symbol, DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing] The number and way that different tasks can use this volume

          # @see DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode#accessibility_requirements
          class AccessibilityRequirements < DockerEngineAPI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements}
            #   for more details.
            #
            #   Requirements for the accessible topology of the volume. These fields are
            #   optional. For an in-depth description of what these fields mean, see the CSI
          ...
          #   no new ones should be started.
          #
          # @see DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode#availability
          module Availability
          ...
          # @see DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode#capacity_range
          class CapacityRange < DockerEngineAPI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange}
            #   for more details.
            #
            #   The desired capacity that the volume should be created with. If empty, the
            #   plugin will decide the capacity.
          ...
          #   time.
          #
          # @see DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode#scope
          module Scope
            extend DockerEngineAPI::Internal::Type::Enum
          ...
          class Secret < DockerEngineAPI::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Secret}
            #   for more details.
            #
          ...
          # - `all` The volume may have any number of readers and writers.
          #
          # @see DockerEngineAPI::Models::CreateRequest::ClusterVolumeSpec::AccessMode#sharing
          module Sharing
            extend DockerEngineAPI::Internal::Type::Enum
