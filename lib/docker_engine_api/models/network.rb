...
module DockerEngineAPI
  module Models
    class Network < DockerEngineAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngineAPI::Models::Network::ConfigFrom, nil]
      optional :config_from, -> { DockerEngineAPI::Network::ConfigFrom }, api_name: :ConfigFrom
      ...
      # @!attribute ipam
      #
      #   @return [DockerEngineAPI::Models::Network::Ipam, nil]
      optional :ipam, -> { DockerEngineAPI::Network::Ipam }, api_name: :IPAM
      ...
      #
      #   @return [Array<DockerEngineAPI::Models::Network::Peer>, nil]
      optional :peers,
               -> { DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::Network::Peer] },
               api_name: :Peers
      ...
      #   {DockerEngineAPI::Models::Network} for more details.
      #
      #   @param attachable [Boolean] Whether a global / swarm scope network is manually attachable by regular
      #
      #   @param config_from [DockerEngineAPI::Models::Network::ConfigFrom] The config-only network source to provide the configuration for
      #
      ...
      #
      #   @param ipam [DockerEngineAPI::Models::Network::Ipam]
      #
      ...
      #
      #   @param peers [Array<DockerEngineAPI::Models::Network::Peer>] List of peer nodes for an overlay network. This field is only present
      #
      #   @param scope [String] The level at which the network exists (e.g. `swarm` for cluster-wide

      # @see DockerEngineAPI::Models::Network#config_from
      class ConfigFrom < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Network::ConfigFrom} for more details.
        #
        #   The config-only network source to provide the configuration for this network.
        #
      ...
      # @see DockerEngineAPI::Models::Network#ipam
      class Ipam < DockerEngineAPI::Internal::Type::BaseModel
        ...
        #   ```
        #
        #   @return [Array<DockerEngineAPI::Models::Network::Ipam::Config>, nil]
        optional :config,
                 -> { DockerEngineAPI::Internal::Type::ArrayOf[DockerEngineAPI::Network::Ipam::Config] },
                 api_name: :Config
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngineAPI::Models::Network::Ipam} for more details.
        #
        #   @param config [Array<DockerEngineAPI::Models::Network::Ipam::Config>] List of IPAM configuration options, specified as a map:
        #
