...
module DockerEngine
  module Resources
    class Images
      ...
      # @param request_options [DockerEngine::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<DockerEngine::Models::DeleteItem>]
      #
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngine::Models::ImageBuildParams} for more details.
      #
      ...
      #
      # @param version [Symbol, DockerEngine::Models::ImageBuildParams::Version] Query param: Version of the builder backend to use.
      #
      ...
      # @return [nil]
      #
      # @see DockerEngine::Models::ImageBuildParams
      def build(params)
      ...
      # @param request_options [DockerEngine::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngine::Models::ImageBuildPruneResponse]
      #
      # @see DockerEngine::Models::ImageBuildPruneParams
      ...
      # Some parameter documentations has been truncated, see
      # {DockerEngine::Models::ImageCommitParams} for more details.
      #
      ...
      #
      # @param healthcheck [DockerEngine::Models::Config::Healthcheck] Body param: A test to perform to check that the container is healthy.
      #
      ...
      # @param request_options [DockerEngine::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngine::Models::ImageCommitResponse]
      #
      # @see DockerEngine::Models::ImageCommitParams
      def commit(params = {})
      ...
      # @return [StringIO]
      #
      # @see DockerEngine::Models::ImageGetParams
      def get(name, params = {})
      ...
      # @return [StringIO]
      #
      # @see DockerEngine::Models::ImageGetAllParams
      def get_all(params = {})
      ...
      # @param request_options [DockerEngine::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<DockerEngine::Models::HistoryItem>]
      #
      # @see DockerEngine::Models::ImageHistoryParams
      ...
      # @return [nil]
      #
      # @see DockerEngine::Models::ImageLoadParams
      def load_(params)
      ...
      # @param request_options [DockerEngine::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [DockerEngine::Models::ImagePruneResponse]
      #
      # @see DockerEngine::Models::ImagePruneParams
      def prune(params = {})
      ...
      # @return [nil]
      #
      # @see DockerEngine::Models::ImagePushParams
      ...
      # @param request_options [DockerEngine::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<DockerEngine::Models::ImageSearchResponseItem>]
      #
      # @see DockerEngine::Models::ImageSearchParams
      def search(params)
      ...
      # @return [nil]
      #
      # @see DockerEngine::Models::ImageTagParams
      def tag(name, params = {})
