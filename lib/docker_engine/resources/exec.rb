...
module DockerEngine
  module Resources
    class Exec
      ...
      #
      # @return [DockerEngine::Models::ExecInspectResponse]
      #
      # @see DockerEngine::Models::ExecInspectParams
      def inspect_(id, params = {})
        @client.request(
          method: :get,
          path: ["exec/%1$s/json", id],
          model: DockerEngine::Models::ExecInspectResponse,
      ...
      # @return [nil]
      #
      # @see DockerEngine::Models::ExecResizeParams
      def resize(id, params)
        parsed, options = DockerEngine::ExecResizeParams.dump_request(params)
        @client.request(
          method: :post,
      ...
      # @return [nil]
      #
      # @see DockerEngine::Models::ExecStartParams
      def start(id, params = {})
        parsed, options = DockerEngine::ExecStartParams.dump_request(params)
        @client.request(
          method: :post,
