    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { DockerEngine::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { DockerEngine::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            DockerEngine::FilePart.new(value)
          in DockerEngine::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in DockerEngine::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [DockerEngine::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: DockerEngine::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in DockerEngine::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in DockerEngine::Internal::Type::Converter
              ...
              DockerEngine::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(DockerEngine::Internal::Type::Converter, T::Class[T.anything]) }
        end
