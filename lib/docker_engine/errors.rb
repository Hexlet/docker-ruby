  ...
  module Errors
    ...
    class APIStatusError < DockerEngine::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          DockerEngine::Errors::BadRequestError.new(**kwargs)
        in 401
          DockerEngine::Errors::AuthenticationError.new(**kwargs)
        in 403
          DockerEngine::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          DockerEngine::Errors::NotFoundError.new(**kwargs)
        in 409
          DockerEngine::Errors::ConflictError.new(**kwargs)
        in 422
          DockerEngine::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          DockerEngine::Errors::RateLimitError.new(**kwargs)
        in (500..)
          DockerEngine::Errors::InternalServerError.new(**kwargs)
        else
          DockerEngine::Errors::APIStatusError.new(**kwargs)
        end
      end
