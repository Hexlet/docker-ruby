...
module DockerEngine
  module Models
    # @see DockerEngine::Resources::Secrets#inspect_
    class Secret < DockerEngine::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngine::Models::Secret::Version, nil]
      optional :version, -> { DockerEngine::Secret::Version }, api_name: :Version

      # @!method initialize(created_at: nil, id: nil, spec: nil, updated_at: nil, version: nil)
      #   Some parameter documentations has been truncated, see
      #   {DockerEngine::Models::Secret} for more details.
      #
      ...
      #
      #   @param version [DockerEngine::Models::Secret::Version] The version number of the object such as node, service, etc. This is needed

      # @see DockerEngine::Models::Secret#version
