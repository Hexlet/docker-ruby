...
module DockerEngine
  module Models
    # @see DockerEngine::Resources::Exec#inspect_
    class ExecInspectResponse < DockerEngine::Internal::Type::BaseModel
      # @!attribute can_remove
      #
      #   @return [Boolean, nil]
      optional :can_remove, DockerEngine::Internal::Type::Boolean, api_name: :CanRemove
      ...
      #
      #   @return [Boolean, nil]
      optional :open_stderr, DockerEngine::Internal::Type::Boolean, api_name: :OpenStderr
      ...
      #
      #   @return [Boolean, nil]
      optional :open_stdout, DockerEngine::Internal::Type::Boolean, api_name: :OpenStdout
      ...
      #
      #   @return [DockerEngine::Models::InspectResponse, nil]
      optional :process_config, -> { DockerEngine::InspectResponse }, api_name: :ProcessConfig
      ...
      #
      #   @param process_config [DockerEngine::Models::InspectResponse]
      #
