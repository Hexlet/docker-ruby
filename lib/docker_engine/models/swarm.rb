...
module DockerEngine
  module Models
    # @see DockerEngine::Resources::Swarm#inspect_
    class SwarmAPI < DockerEngine::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngine::Models::SwarmAPI::JoinTokens, nil]
      optional :join_tokens, -> { DockerEngine::SwarmAPI::JoinTokens }, api_name: :JoinTokens
      ...
      #   certificate.
      #
      #   @return [DockerEngine::Models::SwarmAPI::TlsInfo, nil]
      optional :tls_info, -> { DockerEngine::SwarmAPI::TlsInfo }, api_name: :TLSInfo
      ...
      #
      #   @return [DockerEngine::Models::SwarmAPI::Version, nil]
      optional :version, -> { DockerEngine::SwarmAPI::Version }, api_name: :Version
      ...
      #   {DockerEngine::Models::SwarmAPI} for more details.
      #
      ...
      #
      #   @param join_tokens [DockerEngine::Models::SwarmAPI::JoinTokens] JoinTokens contains the tokens workers and managers need to join the swarm.
      #
      ...
      #
      #   @param tls_info [DockerEngine::Models::SwarmAPI::TlsInfo] Information about the issuer of leaf TLS certificates and the trusted root
      #
      #   @param updated_at [String] Date and time at which the swarm was last updated in
      #
      #   @param version [DockerEngine::Models::SwarmAPI::Version] The version number of the object such as node, service, etc. This is needed

      # @see DockerEngine::Models::SwarmAPI#join_tokens
      class JoinTokens < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::SwarmAPI::JoinTokens} for more details.
        #
        #   JoinTokens contains the tokens workers and managers need to join the swarm.
        #
      ...
      # @see DockerEngine::Models::SwarmAPI#tls_info
      class TlsInfo < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::SwarmAPI::TlsInfo} for more details.
        #
        #   Information about the issuer of leaf TLS certificates and the trusted root CA
        #   certificate.
        #
      ...
      # @see DockerEngine::Models::SwarmAPI#version
