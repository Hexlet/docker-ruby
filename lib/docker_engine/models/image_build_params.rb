...
module DockerEngine
  module Models
    # @see DockerEngine::Resources::Images#build
    class ImageBuildParams < DockerEngine::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :forcerm, DockerEngine::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :nocache, DockerEngine::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :q, DockerEngine::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :rm, DockerEngine::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :squash, DockerEngine::Internal::Type::Boolean
      ...
      #
      #   @return [Symbol, DockerEngine::Models::ImageBuildParams::Version, nil]
      optional :version, enum: -> { DockerEngine::ImageBuildParams::Version }
      ...
      #
      #   @param version [Symbol, DockerEngine::Models::ImageBuildParams::Version] Version of the builder backend to use.
      #
