...
module DockerEngine
  module Models
    ...
    class StatsResponse < DockerEngine::Internal::Type::BaseModel
      ...
      #
      #   @return [DockerEngine::Models::StatsResponse::BlkioStats, nil]
      optional :blkio_stats, -> { DockerEngine::StatsResponse::BlkioStats }, nil?: true

      # @!attribute cpu_stats
      #   CPU related info of the container
      #
      #   @return [DockerEngine::Models::StatsResponse::CPUStats, nil]
      optional :cpu_stats, -> { DockerEngine::StatsResponse::CPUStats }, nil?: true
      ...
      #
      #   @return [DockerEngine::Models::StatsResponse::MemoryStats, nil]
      optional :memory_stats, -> { DockerEngine::StatsResponse::MemoryStats }
      ...
      #
      #   @return [Object, nil]
      optional :networks, DockerEngine::Internal::Type::Unknown, nil?: true
      ...
      #
      #   @return [DockerEngine::Models::StatsResponse::PidsStats, nil]
      optional :pids_stats, -> { DockerEngine::StatsResponse::PidsStats }, nil?: true

      # @!attribute precpu_stats
      #   CPU related info of the container
      #
      #   @return [DockerEngine::Models::StatsResponse::PrecpuStats, nil]
      optional :precpu_stats, -> { DockerEngine::StatsResponse::PrecpuStats }, nil?: true
      ...
      #
      #   @return [DockerEngine::Models::StatsResponse::StorageStats, nil]
      optional :storage_stats, -> { DockerEngine::StatsResponse::StorageStats }, nil?: true
      ...
      #   {DockerEngine::Models::StatsResponse} for more details.
      #
      #   Statistics sample for a container.
      #
      #   @param id [String, nil] ID of the container for which the stats were collected.
      #
      #   @param blkio_stats [DockerEngine::Models::StatsResponse::BlkioStats, nil] BlkioStats stores all IO service stats for data read and write.
      #
      #   @param cpu_stats [DockerEngine::Models::StatsResponse::CPUStats, nil] CPU related info of the container
      #
      #   @param memory_stats [DockerEngine::Models::StatsResponse::MemoryStats] Aggregates all memory stats since container inception on Linux.
      #
      ...
      #
      #   @param pids_stats [DockerEngine::Models::StatsResponse::PidsStats, nil] PidsStats contains Linux-specific stats of a container's process-IDs (PIDs).
      #
      #   @param precpu_stats [DockerEngine::Models::StatsResponse::PrecpuStats, nil] CPU related info of the container
      #
      ...
      #
      #   @param storage_stats [DockerEngine::Models::StatsResponse::StorageStats, nil] StorageStats is the disk I/O stats for read/write on Windows.

      # @see DockerEngine::Models::StatsResponse#blkio_stats
      class BlkioStats < DockerEngine::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoMergedRecursive, nil>, nil]
        optional :io_merged_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoMergedRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoQueueRecursive, nil>, nil]
        optional :io_queue_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoQueueRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoServiceBytesRecursive, nil>, nil]
        optional :io_service_bytes_recursive,
                 -> { DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoServiceBytesRecursive, nil?: true] }

        # @!attribute io_service_time_recursive
        #   This field is only available when using Linux containers with cgroups v1. It is
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoServiceTimeRecursive, nil>, nil]
        optional :io_service_time_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoServiceTimeRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoServicedRecursive, nil>, nil]
        optional :io_serviced_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoServicedRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoTimeRecursive, nil>, nil]
        optional :io_time_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoTimeRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoWaitTimeRecursive, nil>, nil]
        optional :io_wait_time_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::IoWaitTimeRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #   omitted or `null` when using cgroups v2.
        #
        #   @return [Array<DockerEngine::Models::StatsResponse::BlkioStats::SectorsRecursive, nil>, nil]
        optional :sectors_recursive,
                 -> {
                   DockerEngine::Internal::Type::ArrayOf[DockerEngine::StatsResponse::BlkioStats::SectorsRecursive,
                                                         nil?: true]
                 },
                 nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::StatsResponse::BlkioStats} for more details.
        #
        #   BlkioStats stores all IO service stats for data read and write.
        #
        #   This type is Linux-specific and holds many fields that are specific to cgroups
        ...
        #   This type is only populated on Linux and omitted for Windows containers.
        #
        #   @param io_merged_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoMergedRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_queue_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoQueueRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_service_bytes_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoServiceBytesRecursive, nil>]
        #
        #   @param io_service_time_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoServiceTimeRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_serviced_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoServicedRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_time_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoTimeRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param io_wait_time_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::IoWaitTimeRecursive, nil>, nil] This field is only available when using Linux containers with
        #
        #   @param sectors_recursive [Array<DockerEngine::Models::StatsResponse::BlkioStats::SectorsRecursive, nil>, nil] This field is only available when using Linux containers with
      ...
      # @see DockerEngine::Models::StatsResponse#cpu_stats
      class CPUStats < DockerEngine::Internal::Type::BaseModel
        # @!attribute cpu_usage
        #   All CPU stats aggregated since container inception.
        #
        #   @return [DockerEngine::Models::StatsResponse::CPUStats::CPUUsage, nil]
        optional :cpu_usage, -> { DockerEngine::StatsResponse::CPUStats::CPUUsage }, nil?: true
        ...
        #   This type is Linux-specific and omitted for Windows containers.
        #
        #   @return [DockerEngine::Models::StatsResponse::CPUStats::ThrottlingData, nil]
        optional :throttling_data, -> { DockerEngine::StatsResponse::CPUStats::ThrottlingData }, nil?: true

        # @!method initialize(cpu_usage: nil, online_cpus: nil, system_cpu_usage: nil, throttling_data: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::StatsResponse::CPUStats} for more details.
        #
        #   CPU related info of the container
        #
        #   @param cpu_usage [DockerEngine::Models::StatsResponse::CPUStats::CPUUsage, nil] All CPU stats aggregated since container inception.
        #
        #   @param online_cpus [Integer, nil] Number of online CPUs.
        #
        #   @param system_cpu_usage [Integer, nil] System Usage.
        #
        #   @param throttling_data [DockerEngine::Models::StatsResponse::CPUStats::ThrottlingData, nil] CPU throttling stats of the container.

        # @see DockerEngine::Models::StatsResponse::CPUStats#cpu_usage
        class CPUUsage < DockerEngine::Internal::Type::BaseModel
          ...
          optional :percpu_usage, DockerEngine::Internal::Type::ArrayOf[Integer], nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::StatsResponse::CPUStats::CPUUsage} for more details.
          #
          #   All CPU stats aggregated since container inception.
          #
        ...
        # @see DockerEngine::Models::StatsResponse::CPUStats#throttling_data
        class ThrottlingData < DockerEngine::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::StatsResponse::CPUStats::ThrottlingData} for more
          #   details.
          #
          #   CPU throttling stats of the container.
          #
      ...
      # @see DockerEngine::Models::StatsResponse#memory_stats
      class MemoryStats < DockerEngine::Internal::Type::BaseModel
        ...
        optional :stats, DockerEngine::Internal::Type::HashOf[Integer]
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::StatsResponse::MemoryStats} for more details.
        #
        #   Aggregates all memory stats since container inception on Linux. Windows returns
        #   stats for commit and private working set only.
        #
      ...
      # @see DockerEngine::Models::StatsResponse#pids_stats
      class PidsStats < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::StatsResponse::PidsStats} for more details.
        #
        #   PidsStats contains Linux-specific stats of a container's process-IDs (PIDs).
        #
        #   This type is Linux-specific and omitted for Windows containers.
      ...
      # @see DockerEngine::Models::StatsResponse#precpu_stats
      class PrecpuStats < DockerEngine::Internal::Type::BaseModel
        # @!attribute cpu_usage
        #   All CPU stats aggregated since container inception.
        #
        #   @return [DockerEngine::Models::StatsResponse::PrecpuStats::CPUUsage, nil]
        optional :cpu_usage, -> { DockerEngine::StatsResponse::PrecpuStats::CPUUsage }, nil?: true
        ...
        #   This type is Linux-specific and omitted for Windows containers.
        #
        #   @return [DockerEngine::Models::StatsResponse::PrecpuStats::ThrottlingData, nil]
        optional :throttling_data, -> { DockerEngine::StatsResponse::PrecpuStats::ThrottlingData }, nil?: true

        # @!method initialize(cpu_usage: nil, online_cpus: nil, system_cpu_usage: nil, throttling_data: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::StatsResponse::PrecpuStats} for more details.
        #
        #   CPU related info of the container
        #
        #   @param cpu_usage [DockerEngine::Models::StatsResponse::PrecpuStats::CPUUsage, nil] All CPU stats aggregated since container inception.
        #
        #   @param online_cpus [Integer, nil] Number of online CPUs.
        #
        #   @param system_cpu_usage [Integer, nil] System Usage.
        #
        #   @param throttling_data [DockerEngine::Models::StatsResponse::PrecpuStats::ThrottlingData, nil] CPU throttling stats of the container.

        # @see DockerEngine::Models::StatsResponse::PrecpuStats#cpu_usage
        class CPUUsage < DockerEngine::Internal::Type::BaseModel
          # @!attribute percpu_usage
          #   Total CPU time (in nanoseconds) consumed per core (Linux).
          #
          ...
          # @!method initialize(percpu_usage: nil, total_usage: nil, usage_in_kernelmode: nil, usage_in_usermode: nil)
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::StatsResponse::PrecpuStats::CPUUsage} for more details.
          #
          #   All CPU stats aggregated since container inception.
          #
          #   @param percpu_usage [Array<Integer>, nil] Total CPU time (in nanoseconds) consumed per core (Linux).
        ...
        # @see DockerEngine::Models::StatsResponse::PrecpuStats#throttling_data
        class ThrottlingData < DockerEngine::Internal::Type::BaseModel
          # @!attribute periods
          #   Number of periods with throttling active.
          #
          ...
          # @!method initialize(periods: nil, throttled_periods: nil, throttled_time: nil)
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::StatsResponse::PrecpuStats::ThrottlingData} for more
          #   details.
          #
          #   CPU throttling stats of the container.
          #
      ...
      # @see DockerEngine::Models::StatsResponse#storage_stats
