...
module DockerEngine
  module Models
    ...
    class Info < DockerEngine::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, DockerEngine::Models::Info::CgroupDriver, nil]
      optional :cgroup_driver, enum: -> { DockerEngine::Info::CgroupDriver }, api_name: :CgroupDriver

      # @!attribute cgroup_version
      #   The version of the cgroup.
      #
      #   @return [Symbol, DockerEngine::Models::Info::CgroupVersion, nil]
      optional :cgroup_version, enum: -> { DockerEngine::Info::CgroupVersion }, api_name: :CgroupVersion
      ...
      #
      #   @return [DockerEngine::Models::Info::Containerd, nil]
      optional :containerd, -> { DockerEngine::Info::Containerd }, api_name: :Containerd, nil?: true
      ...
      #
      #   @return [DockerEngine::Models::Info::ContainerdCommit, nil]
      optional :containerd_commit, -> { DockerEngine::Info::ContainerdCommit }, api_name: :ContainerdCommit
      ...
      #
      #   @return [Array<DockerEngine::Models::Info::DefaultAddressPool>, nil]
      optional :default_address_pools,
               -> { DockerEngine::Internal::Type::ArrayOf[DockerEngine::Info::DefaultAddressPool] },
      ...
      #
      #   @return [Array<DockerEngine::Models::Info::DiscoveredDevice>, nil]
      optional :discovered_devices,
               -> { DockerEngine::Internal::Type::ArrayOf[DockerEngine::Info::DiscoveredDevice] },
      ...
      #
      #   @return [DockerEngine::Models::Info::FirewallBackend, nil]
      ...
      #
      #   @return [Array<DockerEngine::Models::Info::GenericResource>, nil]
      optional :generic_resources,
               -> { DockerEngine::Internal::Type::ArrayOf[DockerEngine::Info::GenericResource] },
      ...
      #   the version-string of external tools, such as `containerd`, or `runC`.
      #
      #   @return [DockerEngine::Models::Info::InitCommit, nil]
      optional :init_commit, -> { DockerEngine::Info::InitCommit }, api_name: :InitCommit
      ...
      #
      #   @return [Symbol, DockerEngine::Models::Info::Isolation, nil]
      optional :isolation, enum: -> { DockerEngine::Info::Isolation }, api_name: :Isolation
      ...
      #
      #   @return [DockerEngine::Models::Info::Nri, nil]
      optional :nri, -> { DockerEngine::Info::Nri }, api_name: :NRI, nil?: true
      ...
      #   > using the plugin.
      #
      #   @return [DockerEngine::Models::Info::Plugins, nil]
      optional :plugins, -> { DockerEngine::Info::Plugins }, api_name: :Plugins
      ...
      #
      #   @return [DockerEngine::Models::Info::RegistryConfig, nil]
      ...
      #   the version-string of external tools, such as `containerd`, or `runC`.
      #
      #   @return [DockerEngine::Models::Info::RuncCommit, nil]
      optional :runc_commit, -> { DockerEngine::Info::RuncCommit }, api_name: :RuncCommit
      ...
      #
      #   @return [Hash{Symbol=>DockerEngine::Models::Info::Runtime}, nil]
      optional :runtimes,
               -> { DockerEngine::Internal::Type::HashOf[DockerEngine::Info::Runtime] },
               api_name: :Runtimes
      ...
      #
      #   @return [DockerEngine::Models::Info::Swarm, nil]
      optional :swarm, -> { DockerEngine::Info::Swarm }, api_name: :Swarm
      ...
      #   {DockerEngine::Models::Info} for more details.
      #
      ...
      #
      #   @param cgroup_driver [Symbol, DockerEngine::Models::Info::CgroupDriver] The driver to use for managing cgroups.
      #
      #   @param cgroup_version [Symbol, DockerEngine::Models::Info::CgroupVersion] The version of the cgroup.
      #
      #   @param containerd [DockerEngine::Models::Info::Containerd, nil] Information for connecting to the containerd instance that is used by the daemon
      #
      #   @param containerd_commit [DockerEngine::Models::Info::ContainerdCommit] Commit holds the Git-commit (SHA1) that a binary was built from, as
      #
      ...
      #
      #   @param default_address_pools [Array<DockerEngine::Models::Info::DefaultAddressPool>] List of custom default address pools for local networks, which can be
      #
      #   @param default_runtime [String] Name of the default OCI runtime that is used when starting containers.
      #
      #   @param discovered_devices [Array<DockerEngine::Models::Info::DiscoveredDevice>] List of devices discovered by device drivers.
      #
      ...
      #
      #   @param firewall_backend [DockerEngine::Models::Info::FirewallBackend, nil] Information about the daemon's firewalling configuration.
      #
      #   @param generic_resources [Array<DockerEngine::Models::Info::GenericResource>] User-defined resources can be either Integer resources (e.g, `SSD=3`) or
      #
      ...
      #
      #   @param init_commit [DockerEngine::Models::Info::InitCommit] Commit holds the Git-commit (SHA1) that a binary was built from, as
      #
      #   @param i_pv4_forwarding [Boolean] Indicates IPv4 forwarding is enabled.
      #
      #   @param isolation [Symbol, DockerEngine::Models::Info::Isolation] Represents the isolation technology to use as a default for containers.
      #
      ...
      #
      #   @param nri [DockerEngine::Models::Info::Nri, nil] Information about the Node Resource Interface (NRI).
      #
      ...
      #
      #   @param plugins [DockerEngine::Models::Info::Plugins] Available plugins per type.
      #
      #   @param product_license [String] Reports a summary of the product license on the daemon.
      #
      #   @param registry_config [DockerEngine::Models::Info::RegistryConfig, nil] RegistryServiceConfig stores daemon registry services configuration.
      #
      #   @param runc_commit [DockerEngine::Models::Info::RuncCommit] Commit holds the Git-commit (SHA1) that a binary was built from, as
      #
      #   @param runtimes [Hash{Symbol=>DockerEngine::Models::Info::Runtime}] List of [OCI compliant](https://github.com/opencontainers/runtime-spec)
      #
      ...
      #
      #   @param swarm [DockerEngine::Models::Info::Swarm] Represents generic information about swarm.
      #
      ...
      # The driver to use for managing cgroups.
      #
      # @see DockerEngine::Models::Info#cgroup_driver
      module CgroupDriver
      ...
      # The version of the cgroup.
      #
      # @see DockerEngine::Models::Info#cgroup_version
      ...
      # @see DockerEngine::Models::Info#containerd
      class Containerd < DockerEngine::Internal::Type::BaseModel
        ...
        #
        #   @return [DockerEngine::Models::Info::Containerd::Namespaces, nil]
        optional :namespaces, -> { DockerEngine::Info::Containerd::Namespaces }, api_name: :Namespaces

        # @!method initialize(address: nil, namespaces: nil)
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::Containerd} for more details.
        #
        #   Information for connecting to the containerd instance that is used by the
        #   daemon. This is included for debugging purposes only.
        #
        ...
        #
        #   @param namespaces [DockerEngine::Models::Info::Containerd::Namespaces] The namespaces that the daemon uses for running containers and

        # @see DockerEngine::Models::Info::Containerd#namespaces
        class Namespaces < DockerEngine::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::Info::Containerd::Namespaces} for more details.
          #
          #   The namespaces that the daemon uses for running containers and plugins in
          #   containerd. These namespaces can be configured in the daemon configuration, and
          #   are considered to be used exclusively by the daemon, Tampering with the
      ...
      # @see DockerEngine::Models::Info#containerd_commit
      ...
      class DiscoveredDevice < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::DiscoveredDevice} for more details.
        #
      ...
      # @see DockerEngine::Models::Info#firewall_backend
      class FirewallBackend < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::FirewallBackend} for more details.
        #
        #   Information about the daemon's firewalling configuration.
        #
        #   This field is currently only used on Linux, and omitted on other platforms.
      ...
      class GenericResource < DockerEngine::Internal::Type::BaseModel
        ...
        #
        #   @return [DockerEngine::Models::Info::GenericResource::DiscreteResourceSpec, nil]
        ...
        #
        #   @return [DockerEngine::Models::Info::GenericResource::NamedResourceSpec, nil]
        ...
        #   @param discrete_resource_spec [DockerEngine::Models::Info::GenericResource::DiscreteResourceSpec]
        #   @param named_resource_spec [DockerEngine::Models::Info::GenericResource::NamedResourceSpec]

        # @see DockerEngine::Models::Info::GenericResource#discrete_resource_spec
        ...
        # @see DockerEngine::Models::Info::GenericResource#named_resource_spec
      ...
      # @see DockerEngine::Models::Info#init_commit
      ...
      # This option is currently not used on other platforms.
      #
      # @see DockerEngine::Models::Info#isolation
      module Isolation
        extend DockerEngine::Internal::Type::Enum
      ...
      # @see DockerEngine::Models::Info#nri
      class Nri < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::Nri} for more details.
        #
        #   Information about the Node Resource Interface (NRI).
        #
        #   This field is only present if NRI is enabled.
      ...
      # @see DockerEngine::Models::Info#plugins
      ...
      # @see DockerEngine::Models::Info#registry_config
      class RegistryConfig < DockerEngine::Internal::Type::BaseModel
        # @!attribute index_configs
        #
        #   @return [Hash{Symbol=>DockerEngine::Models::Info::RegistryConfig::IndexConfig, nil}, nil]
        optional :index_configs,
                 -> {
                   DockerEngine::Internal::Type::HashOf[DockerEngine::Info::RegistryConfig::IndexConfig,
                                                        nil?: true]
                 },
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::RegistryConfig} for more details.
        #
        #   RegistryServiceConfig stores daemon registry services configuration.
        #
        #   @param index_configs [Hash{Symbol=>DockerEngine::Models::Info::RegistryConfig::IndexConfig, nil}]
        #
        ...
        class IndexConfig < DockerEngine::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::Info::RegistryConfig::IndexConfig} for more details.
          #
      ...
      # @see DockerEngine::Models::Info#runc_commit
      ...
      class Runtime < DockerEngine::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::Runtime} for more details.
        #
      ...
      # @see DockerEngine::Models::Info#swarm
      class Swarm < DockerEngine::Internal::Type::BaseModel
        ...
        #
        #   @return [DockerEngine::Models::Info::Swarm::Cluster, nil]
        optional :cluster, -> { DockerEngine::Info::Swarm::Cluster }, api_name: :Cluster, nil?: true
        ...
        #
        #   @return [Symbol, DockerEngine::Models::Info::Swarm::LocalNodeState, nil]
        optional :local_node_state,
                 enum: -> { DockerEngine::Info::Swarm::LocalNodeState },
        ...
        #
        #   @return [Array<DockerEngine::Models::Info::Swarm::RemoteManager>, nil]
        optional :remote_managers,
                 -> { DockerEngine::Internal::Type::ArrayOf[DockerEngine::Info::Swarm::RemoteManager] },
        ...
        #   Some parameter documentations has been truncated, see
        #   {DockerEngine::Models::Info::Swarm} for more details.
        #
        #   Represents generic information about swarm.
        #
        #   @param cluster [DockerEngine::Models::Info::Swarm::Cluster, nil] ClusterInfo represents information about the swarm as is returned by the
        #
        #   @param control_available [Boolean]
        #
        #   @param error [String]
        #
        #   @param local_node_state [Symbol, DockerEngine::Models::Info::Swarm::LocalNodeState] Current local status of this node.
        #
        ...
        #
        #   @param remote_managers [Array<DockerEngine::Models::Info::Swarm::RemoteManager>, nil] List of ID's and addresses of other managers in the swarm.

        # @see DockerEngine::Models::Info::Swarm#cluster
        class Cluster < DockerEngine::Internal::Type::BaseModel
          ...
          #   certificate.
          #
          #   @return [DockerEngine::Models::Info::Swarm::Cluster::TlsInfo, nil]
          optional :tls_info, -> { DockerEngine::Info::Swarm::Cluster::TlsInfo }, api_name: :TLSInfo
          ...
          #
          #   @return [DockerEngine::Models::Info::Swarm::Cluster::Version, nil]
          optional :version, -> { DockerEngine::Info::Swarm::Cluster::Version }, api_name: :Version
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::Info::Swarm::Cluster} for more details.
          #
          #   ClusterInfo represents information about the swarm as is returned by the "/info"
          #   endpoint. Join-tokens are not included.
          #
          ...
          #
          #   @param tls_info [DockerEngine::Models::Info::Swarm::Cluster::TlsInfo] Information about the issuer of leaf TLS certificates and the trusted root
          #
          #   @param updated_at [String] Date and time at which the swarm was last updated in
          #
          #   @param version [DockerEngine::Models::Info::Swarm::Cluster::Version] The version number of the object such as node, service, etc. This is needed

          # @see DockerEngine::Models::Info::Swarm::Cluster#tls_info
          class TlsInfo < DockerEngine::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {DockerEngine::Models::Info::Swarm::Cluster::TlsInfo} for more details.
            #
            #   Information about the issuer of leaf TLS certificates and the trusted root CA
            #   certificate.
            #
          ...
          # @see DockerEngine::Models::Info::Swarm::Cluster#version
        ...
        # Current local status of this node.
        #
        # @see DockerEngine::Models::Info::Swarm#local_node_state
        ...
        class RemoteManager < DockerEngine::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {DockerEngine::Models::Info::Swarm::RemoteManager} for more details.
          #
