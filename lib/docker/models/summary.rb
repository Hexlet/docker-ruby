...
module Docker
  module Models
    class Summary < Docker::Internal::Type::BaseModel
      ...
      #
      #   @return [Docker::Models::Summary::Health, nil]
      optional :health, -> { Docker::Summary::Health }, api_name: :Health
      ...
      #   "inspect" response.
      #
      #   @return [Docker::Models::Summary::HostConfig, nil]
      optional :host_config, -> { Docker::Summary::HostConfig }, api_name: :HostConfig
      ...
      #
      #   @return [Docker::Models::Summary::ImageManifestDescriptor, nil]
      ...
      #
      #   @return [Array<Docker::Models::Summary::Mount>, nil]
      optional :mounts, -> { Docker::Internal::Type::ArrayOf[Docker::Summary::Mount] }, api_name: :Mounts
      ...
      optional :names, Docker::Internal::Type::ArrayOf[String], api_name: :Names

      # @!attribute network_settings
      #   Summary of the container's network settings
      #
      #   @return [Docker::Models::Summary::NetworkSettings, nil]
      optional :network_settings, -> { Docker::Summary::NetworkSettings }, api_name: :NetworkSettings

      # @!attribute ports
      #   Port-mappings for the container.
      #
      #   @return [Array<Docker::Models::Summary::Port>, nil]
      optional :ports, -> { Docker::Internal::Type::ArrayOf[Docker::Summary::Port] }, api_name: :Ports
      ...
      #
      #   @return [Symbol, Docker::Models::Summary::State, nil]
      optional :state, enum: -> { Docker::Summary::State }, api_name: :State
      ...
      #   Some parameter documentations has been truncated, see {Docker::Models::Summary}
      #   for more details.
      #
      ...
      #
      #   @param health [Docker::Models::Summary::Health] Summary of health status
      #
      #   @param host_config [Docker::Models::Summary::HostConfig] Summary of host-specific runtime information of the container. This
      #
      ...
      #
      #   @param image_manifest_descriptor [Docker::Models::Summary::ImageManifestDescriptor] A descriptor struct containing digest, media type, and size, as defined in
      #
      #   @param labels [Hash{Symbol=>String}] User-defined key/value metadata.
      #
      #   @param mounts [Array<Docker::Models::Summary::Mount>] List of mounts used by the container.
      #
      #   @param names [Array<String>] The names associated with this container. Most containers have a single
      #
      #   @param network_settings [Docker::Models::Summary::NetworkSettings] Summary of the container's network settings
      #
      #   @param ports [Array<Docker::Models::Summary::Port>] Port-mappings for the container.
      #
      ...
      #
      #   @param state [Symbol, Docker::Models::Summary::State] The state of this container.
      #
      #   @param status [String] Additional human-readable status of this container (e.g. `Exit 0`)

      # @see Docker::Models::Summary#health
      class Health < Docker::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Docker::Models::Summary::Health::Status, nil]
        optional :status, enum: -> { Docker::Summary::Health::Status }, api_name: :Status
        ...
        #
        #   @param status [Symbol, Docker::Models::Summary::Health::Status] the health status of the container

        # the health status of the container
        #
        # @see Docker::Models::Summary::Health#status
        module Status
      ...
      # @see Docker::Models::Summary#host_config
      class HostConfig < Docker::Internal::Type::BaseModel
        # @!attribute annotations
        #   Arbitrary key-value metadata attached to the container.
        #
        #   @return [Hash{Symbol=>String}, nil]
        optional :annotations, Docker::Internal::Type::HashOf[String], api_name: :Annotations, nil?: true
        ...
        #   {Docker::Models::Summary::HostConfig} for more details.
        #
        #   Summary of host-specific runtime information of the container. This is a reduced
        #   set of information in the container's "HostConfig" as available in the container
        #   "inspect" response.
      ...
      # @see Docker::Models::Summary#image_manifest_descriptor
      class ImageManifestDescriptor < Docker::Internal::Type::BaseModel
        ...
        #
        #   @return [Docker::Models::Summary::ImageManifestDescriptor::Platform, nil]
        optional :platform, -> { Docker::Summary::ImageManifestDescriptor::Platform }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Summary::ImageManifestDescriptor} for more details.
        #
        #   A descriptor struct containing digest, media type, and size, as defined in the
        #   [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
        #
        ...
        #
        #   @param platform [Docker::Models::Summary::ImageManifestDescriptor::Platform, nil] Describes the platform which the image in the manifest runs on, as defined
        #
        ...
        # @see Docker::Models::Summary::ImageManifestDescriptor#platform
        class Platform < Docker::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Summary::ImageManifestDescriptor::Platform} for more details.
          #
          #   Describes the platform which the image in the manifest runs on, as defined in
          #   the
          #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
      ...
      class Mount < Docker::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Docker::Models::Summary::Mount::Type, nil]
        optional :type, enum: -> { Docker::Summary::Mount::Type }, api_name: :Type

        # @!method initialize(destination: nil, driver: nil, mode: nil, name: nil, propagation: nil, rw: nil, source: nil, type: nil)
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Summary::Mount} for more details.
        #
        ...
        #
        #   @param type [Symbol, Docker::Models::Summary::Mount::Type] The mount type. Available types:
        ...
        # - `volume` a docker volume with the given `Name`.
        #
        # @see Docker::Models::Summary::Mount#type
        module Type
          extend Docker::Internal::Type::Enum
      ...
      # @see Docker::Models::Summary#network_settings
      class NetworkSettings < Docker::Internal::Type::BaseModel
        ...
        #
        #   @return [Hash{Symbol=>Docker::Models::Summary::NetworkSettings::Network}, nil]
        optional :networks,
                 -> { Docker::Internal::Type::HashOf[Docker::Summary::NetworkSettings::Network] },
                 api_name: :Networks

        # @!method initialize(networks: nil)
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Summary::NetworkSettings} for more details.
        #
        #   Summary of the container's network settings
        #
        #   @param networks [Hash{Symbol=>Docker::Models::Summary::NetworkSettings::Network}] Summary of network-settings for each network the container is
        ...
        class Network < Docker::Internal::Type::BaseModel
          ...
          #
          #   @return [Docker::Models::Summary::NetworkSettings::Network::IpamConfig, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Summary::NetworkSettings::Network} for more details.
          #
          ...
          #
          #   @param ipam_config [Docker::Models::Summary::NetworkSettings::Network::IpamConfig, nil] EndpointIPAMConfig represents an endpoint's IPAM configuration.
          #
          ...
          # @see Docker::Models::Summary::NetworkSettings::Network#ipam_config
      ...
      class Port < Docker::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Docker::Models::Summary::Port::Type]
        required :type, enum: -> { Docker::Summary::Port::Type }, api_name: :Type
      ...
      # The state of this container.
      #
      # @see Docker::Models::Summary#state
      module State
        extend Docker::Internal::Type::Enum
