...
module Docker
  module Models
    class CreateRequest < Docker::Internal::Type::BaseModel
      # @!attribute cluster_volume_spec
      #   Cluster-specific options used to create the volume.
      #
      #   @return [Docker::Models::CreateRequest::ClusterVolumeSpec, nil]
      optional :cluster_volume_spec,
               -> { Docker::CreateRequest::ClusterVolumeSpec },
      ...
      #   {Docker::Models::CreateRequest} for more details.
      #
      #   Volume configuration
      #
      #   @param cluster_volume_spec [Docker::Models::CreateRequest::ClusterVolumeSpec] Cluster-specific options used to create the volume.
      #
      ...
      # @see Docker::Models::CreateRequest#cluster_volume_spec
      class ClusterVolumeSpec < Docker::Internal::Type::BaseModel
        # @!attribute access_mode
        #   Defines how the volume is used by tasks.
        #
        #   @return [Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode, nil]
        optional :access_mode,
                 -> {
                   Docker::CreateRequest::ClusterVolumeSpec::AccessMode
                 },
                 api_name: :AccessMode
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::CreateRequest::ClusterVolumeSpec} for more details.
        #
        #   Cluster-specific options used to create the volume.
        #
        #   @param access_mode [Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode] Defines how the volume is used by tasks.
        #
        #   @param group [String] Group defines the volume group of this volume. Volumes belonging to

        # @see Docker::Models::CreateRequest::ClusterVolumeSpec#access_mode
        class AccessMode < Docker::Internal::Type::BaseModel
          ...
          #   specification.
          #
          #   @return [Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements, nil]
          ...
          #
          #   @return [Symbol, Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Availability, nil]
          optional :availability,
                   enum: -> { Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Availability },
          ...
          #
          #   @return [Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange, nil]
          optional :capacity_range,
                   -> { Docker::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange },
          ...
          #     time.
          #
          #   @return [Symbol, Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Scope, nil]
          optional :scope,
                   enum: -> { Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Scope },
                   api_name: :Scope
          ...
          #   volume.
          #
          #   @return [Array<Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Secret>, nil]
          optional :secrets,
                   -> {
                     Docker::Internal::Type::ArrayOf[Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Secret]
                   },
                   api_name: :Secrets
          ...
          #
          #   @return [Symbol, Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing, nil]
          optional :sharing,
                   enum: -> { Docker::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing },
                   api_name: :Sharing
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode} for more details.
          #
          #   Defines how the volume is used by tasks.
          #
          #   @param accessibility_requirements [Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements] Requirements for the accessible topology of the volume. These
          #
          #   @param availability [Symbol, Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Availability] The availability of the volume for use in tasks.
          #
          #   @param capacity_range [Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange] The desired capacity that the volume should be created with. If
          #
          #   @param mount_volume [Object] Options for using this volume as a Mount-type volume.
          #
          #   @param scope [Symbol, Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Scope] The set of nodes this volume can be used on at one time.
          #
          #   @param secrets [Array<Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Secret>] Swarm Secrets that are passed to the CSI storage plugin when
          #
          #   @param sharing [Symbol, Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Sharing] The number and way that different tasks can use this volume

          # @see Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode#accessibility_requirements
          class AccessibilityRequirements < Docker::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::AccessibilityRequirements}
            #   for more details.
            #
            #   Requirements for the accessible topology of the volume. These fields are
            #   optional. For an in-depth description of what these fields mean, see the CSI
          ...
          #   no new ones should be started.
          #
          # @see Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode#availability
          module Availability
          ...
          # @see Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode#capacity_range
          class CapacityRange < Docker::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::CapacityRange}
            #   for more details.
            #
            #   The desired capacity that the volume should be created with. If empty, the
            #   plugin will decide the capacity.
          ...
          #   time.
          #
          # @see Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode#scope
          module Scope
            extend Docker::Internal::Type::Enum
          ...
          class Secret < Docker::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode::Secret} for more
            #   details.
            #
          ...
          # - `all` The volume may have any number of readers and writers.
          #
          # @see Docker::Models::CreateRequest::ClusterVolumeSpec::AccessMode#sharing
          module Sharing
            extend Docker::Internal::Type::Enum
