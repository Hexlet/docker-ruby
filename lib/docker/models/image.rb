...
module Docker
  module Models
    ...
    class Image < Docker::Internal::Type::BaseModel
      ...
      #
      #   @return [Docker::Models::Image::Config, nil]
      optional :config, -> { Docker::Image::Config }, api_name: :Config
      ...
      #
      #   @return [Docker::Models::Image::Descriptor, nil]
      optional :descriptor, -> { Docker::Image::Descriptor }, api_name: :Descriptor

      # @!attribute graph_driver
      #   Information about the storage driver used to store the container's and image's
      #   filesystem.
      #
      #   @return [Docker::Models::Image::GraphDriver, nil]
      optional :graph_driver, -> { Docker::Image::GraphDriver }, api_name: :GraphDriver
      ...
      #
      #   @return [Docker::Models::Image::Identity, nil]
      optional :identity, -> { Docker::Image::Identity }, api_name: :Identity
      ...
      #   compatibility.
      #
      #   @return [Array<Docker::Models::Image::Manifest>, nil]
      optional :manifests,
               -> { Docker::Internal::Type::ArrayOf[Docker::Image::Manifest] },
               api_name: :Manifests,
               nil?: true
      ...
      #
      #   @return [Docker::Models::Image::Metadata, nil]
      optional :metadata, -> { Docker::Image::Metadata }, api_name: :Metadata
      ...
      optional :repo_digests, Docker::Internal::Type::ArrayOf[String], api_name: :RepoDigests
      ...
      #
      #   @return [Array<String>, nil]
      optional :repo_tags, Docker::Internal::Type::ArrayOf[String], api_name: :RepoTags

      # @!attribute root_fs
      #   Information about the image's RootFS, including the layer IDs.
      #
      #   @return [Docker::Models::Image::RootFs, nil]
      optional :root_fs, -> { Docker::Image::RootFs }, api_name: :RootFS
      ...
      #   Some parameter documentations has been truncated, see {Docker::Models::Image}
      #   for more details.
      #
      ...
      #
      #   @param config [Docker::Models::Image::Config] Configuration of the image. These fields are used as defaults
      #
      #   @param created [String, nil] Date and time at which the image was created, formatted in
      #
      #   @param descriptor [Docker::Models::Image::Descriptor] A descriptor struct containing digest, media type, and size, as defined in
      #
      #   @param graph_driver [Docker::Models::Image::GraphDriver] Information about the storage driver used to store the container's and
      #
      #   @param id [String] ID is the content-addressable ID of an image.
      #
      #   @param identity [Docker::Models::Image::Identity] Identity holds information about the identity and origin of the image.
      #
      #   @param manifests [Array<Docker::Models::Image::Manifest>, nil] Manifests is a list of image manifests available in this image. It
      #
      #   @param metadata [Docker::Models::Image::Metadata] Additional metadata of the image in the local cache. This information
      #
      ...
      #
      #   @param root_fs [Docker::Models::Image::RootFs] Information about the image's RootFS, including the layer IDs.
      #
      ...
      # @see Docker::Models::Image#config
      class Config < Docker::Internal::Type::BaseModel
        # @!attribute args_escaped
        #   Command is already escaped (Windows only)
        #
        #   @return [Boolean, nil]
        optional :args_escaped, Docker::Internal::Type::Boolean, api_name: :ArgsEscaped, nil?: true

        # @!attribute cmd
        #   Command to run specified as a string or an array of strings.
        #
        #   @return [Array<String>, nil]
        optional :cmd, Docker::Internal::Type::ArrayOf[String], api_name: :Cmd
        ...
        #
        #   @return [Array<String>, nil]
        optional :entrypoint, Docker::Internal::Type::ArrayOf[String], api_name: :Entrypoint
        ...
        optional :exposed_ports,
                 Docker::Internal::Type::HashOf[Docker::Internal::Type::Unknown],
        ...
        #
        #   @return [Docker::Models::Image::Config::Healthcheck, nil]
        optional :healthcheck, -> { Docker::Image::Config::Healthcheck }, api_name: :Healthcheck
        ...
        #
        #   @return [Array<String>, nil]
        optional :on_build, Docker::Internal::Type::ArrayOf[String], api_name: :OnBuild, nil?: true

        # @!attribute shell
        #   Shell for when `RUN`, `CMD`, and `ENTRYPOINT` uses a shell.
        #
        #   @return [Array<String>, nil]
        optional :shell, Docker::Internal::Type::ArrayOf[String], api_name: :Shell, nil?: true
        ...
        #
        #   @return [Hash{Symbol=>Object}, nil]
        optional :volumes, Docker::Internal::Type::HashOf[Docker::Internal::Type::Unknown], api_name: :Volumes
        ...
        #   {Docker::Models::Image::Config} for more details.
        #
        #   Configuration of the image. These fields are used as defaults when starting a
        #   container from the image.
        #
        ...
        #
        #   @param healthcheck [Docker::Models::Image::Config::Healthcheck] A test to perform to check that the container is healthy.
        #
        ...
        # @see Docker::Models::Image::Config#healthcheck
        class Healthcheck < Docker::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Config::Healthcheck} for more details.
          #
          #   A test to perform to check that the container is healthy. Healthcheck commands
          #   should be side-effect free.
          #
      ...
      # @see Docker::Models::Image#descriptor
      class Descriptor < Docker::Internal::Type::BaseModel
        ...
        #
        #   @return [Docker::Models::Image::Descriptor::Platform, nil]
        optional :platform, -> { Docker::Image::Descriptor::Platform }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Image::Descriptor} for more details.
        #
        #   A descriptor struct containing digest, media type, and size, as defined in the
        #   [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
        #
        ...
        #
        #   @param platform [Docker::Models::Image::Descriptor::Platform, nil] Describes the platform which the image in the manifest runs on, as defined
        #
        ...
        # @see Docker::Models::Image::Descriptor#platform
        class Platform < Docker::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Descriptor::Platform} for more details.
          #
          #   Describes the platform which the image in the manifest runs on, as defined in
          #   the
          #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
      ...
      # @see Docker::Models::Image#graph_driver
      class GraphDriver < Docker::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Image::GraphDriver} for more details.
        #
        #   Information about the storage driver used to store the container's and image's
        #   filesystem.
        #
      ...
      # @see Docker::Models::Image#identity
      class Identity < Docker::Internal::Type::BaseModel
        # @!attribute build
        #   Build contains build reference information if image was created via build.
        #
        #   @return [Array<Docker::Models::Image::Identity::Build>, nil]
        optional :build,
                 -> {
                   Docker::Internal::Type::ArrayOf[Docker::Image::Identity::Build]
                 },
                 api_name: :Build
        ...
        #
        #   @return [Array<Docker::Models::Image::Identity::Pull>, nil]
        optional :pull, -> { Docker::Internal::Type::ArrayOf[Docker::Image::Identity::Pull] }, api_name: :Pull

        # @!attribute signature
        #   Signature contains the properties of verified signatures for the image.
        #
        #   @return [Array<Docker::Models::Image::Identity::Signature>, nil]
        optional :signature,
                 -> { Docker::Internal::Type::ArrayOf[Docker::Image::Identity::Signature] },
                 api_name: :Signature

        # @!method initialize(build: nil, pull: nil, signature: nil)
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Image::Identity} for more details.
        #
        #   Identity holds information about the identity and origin of the image. This is
        #   trusted information verified by the daemon and cannot be modified by tagging an
        #   image to a different name.
        #
        #   @param build [Array<Docker::Models::Image::Identity::Build>] Build contains build reference information if image was created via build.
        #
        #   @param pull [Array<Docker::Models::Image::Identity::Pull>] Pull contains remote location information if image was created via pull.
        #
        #   @param signature [Array<Docker::Models::Image::Identity::Signature>] Signature contains the properties of verified signatures for the image.

        class Build < Docker::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Identity::Build} for more details.
          #
        ...
        class Pull < Docker::Internal::Type::BaseModel
        ...
        class Signature < Docker::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Docker::Models::Image::Identity::Signature::KnownSigner, nil]
          optional :known_signer,
                   enum: -> { Docker::Image::Identity::Signature::KnownSigner },
          ...
          #
          #   @return [Symbol, Docker::Models::Image::Identity::Signature::SignatureType, nil]
          optional :signature_type,
                   enum: -> { Docker::Image::Identity::Signature::SignatureType },
          ...
          #   the image.
          #
          #   @return [Docker::Models::Image::Identity::Signature::Signer, nil]
          optional :signer, -> { Docker::Image::Identity::Signature::Signer }, api_name: :Signer

          # @!attribute timestamps
          #   Timestamps contains a list of verified signed timestamps for the signature.
          #
          #   @return [Array<Docker::Models::Image::Identity::Signature::Timestamp>, nil]
          optional :timestamps,
                   -> { Docker::Internal::Type::ArrayOf[Docker::Image::Identity::Signature::Timestamp] },
                   api_name: :Timestamps
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Identity::Signature} for more details.
          #
          ...
          #
          #   @param known_signer [Symbol, Docker::Models::Image::Identity::Signature::KnownSigner] KnownSignerIdentity is an identifier for a special signer identity that is known
          #
          #   @param name [String] Name is a textual description summarizing the type of signature.
          #
          #   @param signature_type [Symbol, Docker::Models::Image::Identity::Signature::SignatureType] SignatureType is the type of signature format.
          #
          #   @param signer [Docker::Models::Image::Identity::Signature::Signer] SignerIdentity contains information about the signer certificate used to sign th
          #
          #   @param timestamps [Array<Docker::Models::Image::Identity::Signature::Timestamp>] Timestamps contains a list of verified signed timestamps for the signature.
          #
          ...
          # to the implementation.
          #
          # @see Docker::Models::Image::Identity::Signature#known_signer
          module KnownSigner
          ...
          # SignatureType is the type of signature format.
          #
          # @see Docker::Models::Image::Identity::Signature#signature_type
          ...
          # @see Docker::Models::Image::Identity::Signature#signer
          class Signer < Docker::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::Image::Identity::Signature::Signer} for more details.
            #
            #   SignerIdentity contains information about the signer certificate used to sign
            #   the image.
            #
          ...
          class Timestamp < Docker::Internal::Type::BaseModel
            # @!attribute timestamp
            #
            #   @return [Time, nil]
            ...
            #
            #   @return [Symbol, Docker::Models::Image::Identity::Signature::Timestamp::Type, nil]
            optional :type, enum: -> { Docker::Image::Identity::Signature::Timestamp::Type }, api_name: :Type
            ...
            #
            #   @param type [Symbol, Docker::Models::Image::Identity::Signature::Timestamp::Type] SignatureTimestampType is the type of timestamp used in the signature.
            #
            #   @param uri [String]

            # SignatureTimestampType is the type of timestamp used in the signature.
            #
            # @see Docker::Models::Image::Identity::Signature::Timestamp#type
            module Type
              extend Docker::Internal::Type::Enum
      ...
      class Manifest < Docker::Internal::Type::BaseModel
        # @!attribute available
        #   Indicates whether all the child content (image config, layers) is fully
        #   available locally.
        #
        #   @return [Boolean]
        required :available, Docker::Internal::Type::Boolean, api_name: :Available

        # @!attribute descriptor
        #   A descriptor struct containing digest, media type, and size, as defined in the
        #   [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
        #
        #   @return [Docker::Models::Image::Manifest::Descriptor]
        required :descriptor, -> { Docker::Image::Manifest::Descriptor }, api_name: :Descriptor
        ...
        #
        #   @return [Symbol, Docker::Models::Image::Manifest::Kind]
        required :kind, enum: -> { Docker::Image::Manifest::Kind }, api_name: :Kind

        # @!attribute size
        #
        #   @return [Docker::Models::Image::Manifest::Size]
        required :size, -> { Docker::Image::Manifest::Size }, api_name: :Size

        # @!attribute attestation_data
        #   The image data for the attestation manifest. This field is only populated when
        #   Kind is "attestation".
        #
        #   @return [Docker::Models::Image::Manifest::AttestationData, nil]
        optional :attestation_data,
                 -> { Docker::Image::Manifest::AttestationData },
        ...
        #   "image".
        #
        #   @return [Docker::Models::Image::Manifest::ImageData, nil]
        optional :image_data, -> { Docker::Image::Manifest::ImageData }, api_name: :ImageData, nil?: true

        # @!method initialize(available:, descriptor:, id:, kind:, size:, attestation_data: nil, image_data: nil)
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Image::Manifest} for more details.
        #
        #   ImageManifestSummary represents a summary of an image manifest.
        #
        #   @param available [Boolean] Indicates whether all the child content (image config, layers) is fully availabl
        #
        #   @param descriptor [Docker::Models::Image::Manifest::Descriptor] A descriptor struct containing digest, media type, and size, as defined in
        #
        #   @param id [String] ID is the content-addressable ID of an image and is the same as the
        #
        #   @param kind [Symbol, Docker::Models::Image::Manifest::Kind] The kind of the manifest.
        #
        #   @param size [Docker::Models::Image::Manifest::Size]
        #
        #   @param attestation_data [Docker::Models::Image::Manifest::AttestationData, nil] The image data for the attestation manifest.
        #
        #   @param image_data [Docker::Models::Image::Manifest::ImageData, nil] The image data for the image manifest.

        # @see Docker::Models::Image::Manifest#descriptor
        class Descriptor < Docker::Internal::Type::BaseModel
          # @!attribute annotations
          #   Arbitrary metadata relating to the targeted content.
          #
          ...
          #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
          #
          #   @return [Docker::Models::Image::Manifest::Descriptor::Platform, nil]
          optional :platform, -> { Docker::Image::Manifest::Descriptor::Platform }, nil?: true
          ...
          # @!method initialize(annotations: nil, artifact_type: nil, data: nil, digest: nil, media_type: nil, platform: nil, size: nil, urls: nil)
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Manifest::Descriptor} for more details.
          #
          #   A descriptor struct containing digest, media type, and size, as defined in the
          #   [OCI Content Descriptors Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/descriptor.md).
          #
          ...
          #   @param media_type [String] The media type of the object this schema refers to.
          #
          #   @param platform [Docker::Models::Image::Manifest::Descriptor::Platform, nil] Describes the platform which the image in the manifest runs on, as defined
          #
          #   @param size [Integer] The size in bytes of the blob.
          #
          #   @param urls [Array<String>, nil] List of URLs from which this object MAY be downloaded.

          # @see Docker::Models::Image::Manifest::Descriptor#platform
          class Platform < Docker::Internal::Type::BaseModel
            # @!attribute architecture
            #   The CPU architecture, for example `amd64` or `ppc64`.
            #
            ...
            # @!method initialize(architecture: nil, os: nil, os_features: nil, os_version: nil, variant: nil)
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::Image::Manifest::Descriptor::Platform} for more details.
            #
            #   Describes the platform which the image in the manifest runs on, as defined in
            #   the
            #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
        ...
        # | attestation | Attestation manifest produced by the Buildkit builder for a specific image manifest. |
        #
        # @see Docker::Models::Image::Manifest#kind
        module Kind
          extend Docker::Internal::Type::Enum
        ...
        # @see Docker::Models::Image::Manifest#size
        class Size < Docker::Internal::Type::BaseModel
          # @!attribute content
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Manifest::Size} for more details.
          #
        ...
        # @see Docker::Models::Image::Manifest#attestation_data
        class AttestationData < Docker::Internal::Type::BaseModel
          # @!attribute for_
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Manifest::AttestationData} for more details.
          #
          #   The image data for the attestation manifest. This field is only populated when
          #   Kind is "attestation".
          #
        ...
        # @see Docker::Models::Image::Manifest#image_data
        class ImageData < Docker::Internal::Type::BaseModel
          # @!attribute containers
          #   The IDs of the containers that are using this image.
          #
          #   @return [Array<String>]
          required :containers, Docker::Internal::Type::ArrayOf[String], api_name: :Containers
          ...
          #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
          #
          #   @return [Docker::Models::Image::Manifest::ImageData::Platform, nil]
          required :platform,
                   -> {
                     Docker::Image::Manifest::ImageData::Platform
                   },
                   api_name: :Platform,
                   nil?: true
          ...
          # @!attribute size
          #
          #   @return [Docker::Models::Image::Manifest::ImageData::Size]
          required :size, -> { Docker::Image::Manifest::ImageData::Size }, api_name: :Size

          # @!method initialize(containers:, platform:, size:)
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Image::Manifest::ImageData} for more details.
          #
          #   The image data for the image manifest. This field is only populated when Kind is
          #   "image".
          #
          ...
          #
          #   @param platform [Docker::Models::Image::Manifest::ImageData::Platform, nil] Describes the platform which the image in the manifest runs on, as defined
          #
          #   @param size [Docker::Models::Image::Manifest::ImageData::Size]

          # @see Docker::Models::Image::Manifest::ImageData#platform
          class Platform < Docker::Internal::Type::BaseModel
            # @!attribute architecture
            #   The CPU architecture, for example `amd64` or `ppc64`.
            #
            ...
            # @!method initialize(architecture: nil, os: nil, os_features: nil, os_version: nil, variant: nil)
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::Image::Manifest::ImageData::Platform} for more details.
            #
            #   Describes the platform which the image in the manifest runs on, as defined in
            #   the
            #   [OCI Image Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
          ...
          # @see Docker::Models::Image::Manifest::ImageData#size
          class Size < Docker::Internal::Type::BaseModel
            # @!attribute unpacked
            ...
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::Image::Manifest::ImageData::Size} for more details.
            #
      ...
      # @see Docker::Models::Image#metadata
      class Metadata < Docker::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Image::Metadata} for more details.
        #
        #   Additional metadata of the image in the local cache. This information is local
        #   to the daemon, and not part of the image itself.
        #
      ...
      # @see Docker::Models::Image#root_fs
      class RootFs < Docker::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<String>, nil]
        optional :layers, Docker::Internal::Type::ArrayOf[String], api_name: :Layers
