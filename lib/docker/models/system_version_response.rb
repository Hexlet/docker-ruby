...
module Docker
  module Models
    # @see Docker::Resources::System#version
    class SystemVersionResponse < Docker::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Docker::Models::SystemVersionResponse::Component>, nil]
      optional :components,
               -> { Docker::Internal::Type::ArrayOf[Docker::Models::SystemVersionResponse::Component] },
               api_name: :Components
      ...
      #
      #   @return [Boolean, nil]
      optional :experimental, Docker::Internal::Type::Boolean, api_name: :Experimental
      ...
      # @!attribute platform
      #
      #   @return [Docker::Models::SystemVersionResponse::Platform, nil]
      optional :platform, -> { Docker::Models::SystemVersionResponse::Platform }, api_name: :Platform
      ...
      #   {Docker::Models::SystemVersionResponse} for more details.
      #
      ...
      #
      #   @param components [Array<Docker::Models::SystemVersionResponse::Component>] Information about system components
      #
      ...
      #
      #   @param platform [Docker::Models::SystemVersionResponse::Platform]
      #
      #   @param version [String] The version of the daemon

      class Component < Docker::Internal::Type::BaseModel
        # @!attribute name
        ...
        #
        #   @return [Object, nil]
        optional :details, Docker::Internal::Type::Unknown, api_name: :Details, nil?: true

        # @!method initialize(name:, version:, details: nil)
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::SystemVersionResponse::Component} for more details.
        #
      ...
      # @see Docker::Models::SystemVersionResponse#platform
