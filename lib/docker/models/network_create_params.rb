...
module Docker
  module Models
    # @see Docker::Resources::Networks#create
    class NetworkCreateParams < Docker::Internal::Type::BaseModel
      ...
      #
      #   @return [Docker::Models::NetworkCreateParams::ConfigFrom, nil]
      optional :config_from, -> { Docker::NetworkCreateParams::ConfigFrom }, api_name: :ConfigFrom
      ...
      # @!attribute ipam
      #
      #   @return [Docker::Models::NetworkCreateParams::Ipam, nil]
      optional :ipam, -> { Docker::NetworkCreateParams::Ipam }, api_name: :IPAM
      ...
      class ConfigFrom < Docker::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::NetworkCreateParams::ConfigFrom} for more details.
        #
        #   The config-only network source to provide the configuration for this network.
        #
      ...
      class Ipam < Docker::Internal::Type::BaseModel
        ...
        #   ```
        #
        #   @return [Array<Docker::Models::NetworkCreateParams::Ipam::Config>, nil]
        optional :config,
                 -> { Docker::Internal::Type::ArrayOf[Docker::NetworkCreateParams::Ipam::Config] },
                 api_name: :Config
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::NetworkCreateParams::Ipam} for more details.
        #
        #   @param config [Array<Docker::Models::NetworkCreateParams::Ipam::Config>] List of IPAM configuration options, specified as a map:
        #
