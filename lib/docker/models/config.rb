...
module Docker
  module Models
    class Config < Docker::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :attach_stderr, Docker::Internal::Type::Boolean, api_name: :AttachStderr

      # @!attribute attach_stdin
      #   Whether to attach to `stdin`.
      #
      #   @return [Boolean, nil]
      optional :attach_stdin, Docker::Internal::Type::Boolean, api_name: :AttachStdin

      # @!attribute attach_stdout
      #   Whether to attach to `stdout`.
      #
      #   @return [Boolean, nil]
      optional :attach_stdout, Docker::Internal::Type::Boolean, api_name: :AttachStdout
      ...
      #
      #   @return [Docker::Models::Config::Healthcheck, nil]
      optional :healthcheck, -> { Docker::Config::Healthcheck }, api_name: :Healthcheck
      ...
      #
      #   @return [Boolean, nil]
      optional :network_disabled, Docker::Internal::Type::Boolean, api_name: :NetworkDisabled, nil?: true
      ...
      #
      #   @return [Boolean, nil]
      optional :stdin_once, Docker::Internal::Type::Boolean, api_name: :StdinOnce
      ...
      #   Some parameter documentations has been truncated, see {Docker::Models::Config}
      #   for more details.
      #
      ...
      #
      #   @param healthcheck [Docker::Models::Config::Healthcheck] A test to perform to check that the container is healthy.
      #
      ...
      # @see Docker::Models::Config#healthcheck
      class Healthcheck < Docker::Internal::Type::BaseModel
        ...
        #   {Docker::Models::Config::Healthcheck} for more details.
        #
        #   A test to perform to check that the container is healthy. Healthcheck commands
        #   should be side-effect free.
        #
