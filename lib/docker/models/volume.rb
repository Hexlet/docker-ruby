...
module Docker
  module Models
    # @see Docker::Resources::Volumes#create
    class Volume < Docker::Internal::Type::BaseModel
      # @!attribute driver
      ...
      required :labels, Docker::Internal::Type::HashOf[String], api_name: :Labels
      ...
      #
      #   @return [Hash{Symbol=>String}]
      required :options, Docker::Internal::Type::HashOf[String], api_name: :Options

      # @!attribute scope
      #   The level at which the volume exists. Either `global` for cluster-wide, or
      #   `local` for machine level.
      #
      #   @return [Symbol, Docker::Models::Volume::Scope]
      required :scope, enum: -> { Docker::Volume::Scope }, api_name: :Scope

      # @!attribute cluster_volume
      #   Options and information specific to, and only present on, Swarm CSI cluster
      #   volumes.
      #
      #   @return [Docker::Models::Volume::ClusterVolume, nil]
      optional :cluster_volume, -> { Docker::Volume::ClusterVolume }, api_name: :ClusterVolume
      ...
      optional :status, Docker::Internal::Type::HashOf[Docker::Internal::Type::Unknown], api_name: :Status
      ...
      #
      #   @return [Docker::Models::Volume::UsageData, nil]
      optional :usage_data, -> { Docker::Volume::UsageData }, api_name: :UsageData, nil?: true
      ...
      #   Some parameter documentations has been truncated, see {Docker::Models::Volume}
      #   for more details.
      #
      ...
      #
      #   @param scope [Symbol, Docker::Models::Volume::Scope] The level at which the volume exists. Either `global` for cluster-wide,
      #
      #   @param cluster_volume [Docker::Models::Volume::ClusterVolume] Options and information specific to, and only present on, Swarm CSI
      #
      ...
      #
      #   @param usage_data [Docker::Models::Volume::UsageData, nil] Usage details about the volume. This information is used by the

      # The level at which the volume exists. Either `global` for cluster-wide, or
      # `local` for machine level.
      #
      # @see Docker::Models::Volume#scope
      module Scope
      ...
      # @see Docker::Models::Volume#cluster_volume
      class ClusterVolume < Docker::Internal::Type::BaseModel
        # @!attribute created_at
        #
        #   @return [String, nil]
        optional :created_at, String, api_name: :CreatedAt
        ...
        #
        #   @return [Docker::Models::Volume::ClusterVolume::Info, nil]
        optional :info, -> { Docker::Volume::ClusterVolume::Info }, api_name: :Info

        # @!attribute publish_status
        #   The status of the volume as it pertains to its publishing and use on specific
        #   nodes
        #
        #   @return [Array<Docker::Models::Volume::ClusterVolume::PublishStatus>, nil]
        optional :publish_status,
                 -> { Docker::Internal::Type::ArrayOf[Docker::Volume::ClusterVolume::PublishStatus] },
                 api_name: :PublishStatus

        # @!attribute spec
        #   Cluster-specific options used to create the volume.
        #
        #   @return [Docker::Models::Volume::ClusterVolume::Spec, nil]
        optional :spec, -> { Docker::Volume::ClusterVolume::Spec }, api_name: :Spec
        ...
        #
        #   @return [Docker::Models::Volume::ClusterVolume::Version, nil]
        optional :version, -> { Docker::Volume::ClusterVolume::Version }, api_name: :Version

        # @!method initialize(created_at: nil, id: nil, info: nil, publish_status: nil, spec: nil, updated_at: nil, version: nil)
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Volume::ClusterVolume} for more details.
        #
        #   Options and information specific to, and only present on, Swarm CSI cluster
        #   volumes.
        #
        ...
        #
        #   @param info [Docker::Models::Volume::ClusterVolume::Info] Information about the global status of the volume.
        #
        #   @param publish_status [Array<Docker::Models::Volume::ClusterVolume::PublishStatus>] The status of the volume as it pertains to its publishing and use on
        #
        #   @param spec [Docker::Models::Volume::ClusterVolume::Spec] Cluster-specific options used to create the volume.
        #
        #   @param updated_at [String]
        #
        #   @param version [Docker::Models::Volume::ClusterVolume::Version] The version number of the object such as node, service, etc. This is needed

        # @see Docker::Models::Volume::ClusterVolume#info
        class Info < Docker::Internal::Type::BaseModel
          # @!attribute accessible_topology
          #   The topology this volume is actually accessible from.
          #
          #   @return [Array<Hash{Symbol=>String}>, nil]
          optional :accessible_topology,
                   Docker::Internal::Type::ArrayOf[Docker::Internal::Type::HashOf[String]],
          ...
          optional :volume_context, Docker::Internal::Type::HashOf[String], api_name: :VolumeContext
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Volume::ClusterVolume::Info} for more details.
          #
          #   Information about the global status of the volume.
          #
        ...
        class PublishStatus < Docker::Internal::Type::BaseModel
          # @!attribute node_id
          ...
          #
          #   @return [Hash{Symbol=>String}, nil]
          optional :publish_context, Docker::Internal::Type::HashOf[String], api_name: :PublishContext
          ...
          #
          #   @return [Symbol, Docker::Models::Volume::ClusterVolume::PublishStatus::State, nil]
          optional :state, enum: -> { Docker::Volume::ClusterVolume::PublishStatus::State }, api_name: :State

          # @!method initialize(node_id: nil, publish_context: nil, state: nil)
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Volume::ClusterVolume::PublishStatus} for more details.
          #
          ...
          #
          #   @param state [Symbol, Docker::Models::Volume::ClusterVolume::PublishStatus::State] The published state of the volume.
          ...
          #   node, but has not yet been successfully unpublished on the controller.
          #
          # @see Docker::Models::Volume::ClusterVolume::PublishStatus#state
          module State
            extend Docker::Internal::Type::Enum
        ...
        # @see Docker::Models::Volume::ClusterVolume#spec
        class Spec < Docker::Internal::Type::BaseModel
          # @!attribute access_mode
          #   Defines how the volume is used by tasks.
          #
          #   @return [Docker::Models::Volume::ClusterVolume::Spec::AccessMode, nil]
          optional :access_mode, -> { Docker::Volume::ClusterVolume::Spec::AccessMode }, api_name: :AccessMode
          ...
          #   Some parameter documentations has been truncated, see
          #   {Docker::Models::Volume::ClusterVolume::Spec} for more details.
          #
          #   Cluster-specific options used to create the volume.
          #
          #   @param access_mode [Docker::Models::Volume::ClusterVolume::Spec::AccessMode] Defines how the volume is used by tasks.
          #
          #   @param group [String] Group defines the volume group of this volume. Volumes belonging to

          # @see Docker::Models::Volume::ClusterVolume::Spec#access_mode
          class AccessMode < Docker::Internal::Type::BaseModel
            ...
            #   specification.
            #
            #   @return [Docker::Models::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements, nil]
            optional :accessibility_requirements,
                     -> { Docker::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements },
            ...
            #
            #   @return [Symbol, Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Availability, nil]
            optional :availability,
                     enum: -> { Docker::Volume::ClusterVolume::Spec::AccessMode::Availability },
            ...
            #
            #   @return [Docker::Models::Volume::ClusterVolume::Spec::AccessMode::CapacityRange, nil]
            optional :capacity_range,
                     -> { Docker::Volume::ClusterVolume::Spec::AccessMode::CapacityRange },
            ...
            #
            #   @return [Object, nil]
            optional :mount_volume, Docker::Internal::Type::Unknown, api_name: :MountVolume
            ...
            #     time.
            #
            #   @return [Symbol, Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Scope, nil]
            optional :scope,
                     enum: -> {
                       Docker::Volume::ClusterVolume::Spec::AccessMode::Scope
                     },
                     api_name: :Scope
            ...
            #   volume.
            #
            #   @return [Array<Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Secret>, nil]
            optional :secrets,
                     -> {
                       Docker::Internal::Type::ArrayOf[Docker::Volume::ClusterVolume::Spec::AccessMode::Secret]
                     },
                     api_name: :Secrets
            ...
            #
            #   @return [Symbol, Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Sharing, nil]
            optional :sharing,
                     enum: -> { Docker::Volume::ClusterVolume::Spec::AccessMode::Sharing },
                     api_name: :Sharing
            ...
            #   Some parameter documentations has been truncated, see
            #   {Docker::Models::Volume::ClusterVolume::Spec::AccessMode} for more details.
            #
            #   Defines how the volume is used by tasks.
            #
            #   @param accessibility_requirements [Docker::Models::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements] Requirements for the accessible topology of the volume. These
            #
            #   @param availability [Symbol, Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Availability] The availability of the volume for use in tasks.
            #
            #   @param capacity_range [Docker::Models::Volume::ClusterVolume::Spec::AccessMode::CapacityRange] The desired capacity that the volume should be created with. If
            #
            #   @param mount_volume [Object] Options for using this volume as a Mount-type volume.
            #
            #   @param scope [Symbol, Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Scope] The set of nodes this volume can be used on at one time.
            #
            #   @param secrets [Array<Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Secret>] Swarm Secrets that are passed to the CSI storage plugin when
            #
            #   @param sharing [Symbol, Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Sharing] The number and way that different tasks can use this volume

            # @see Docker::Models::Volume::ClusterVolume::Spec::AccessMode#accessibility_requirements
            class AccessibilityRequirements < Docker::Internal::Type::BaseModel
              # @!attribute preferred
              ...
              #   Some parameter documentations has been truncated, see
              #   {Docker::Models::Volume::ClusterVolume::Spec::AccessMode::AccessibilityRequirements}
              #   for more details.
              #
              #   Requirements for the accessible topology of the volume. These fields are
              #   optional. For an in-depth description of what these fields mean, see the CSI
            ...
            #   no new ones should be started.
            #
            # @see Docker::Models::Volume::ClusterVolume::Spec::AccessMode#availability
            module Availability
              extend Docker::Internal::Type::Enum
            ...
            # @see Docker::Models::Volume::ClusterVolume::Spec::AccessMode#capacity_range
            class CapacityRange < Docker::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Docker::Models::Volume::ClusterVolume::Spec::AccessMode::CapacityRange} for
              #   more details.
              #
              #   The desired capacity that the volume should be created with. If empty, the
              #   plugin will decide the capacity.
            ...
            #   time.
            #
            # @see Docker::Models::Volume::ClusterVolume::Spec::AccessMode#scope
            module Scope
              extend Docker::Internal::Type::Enum
            ...
            class Secret < Docker::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Docker::Models::Volume::ClusterVolume::Spec::AccessMode::Secret} for more
              #   details.
              #
            ...
            # - `all` The volume may have any number of readers and writers.
            #
            # @see Docker::Models::Volume::ClusterVolume::Spec::AccessMode#sharing
            module Sharing
              extend Docker::Internal::Type::Enum
        ...
        # @see Docker::Models::Volume::ClusterVolume#version
      ...
      # @see Docker::Models::Volume#usage_data
      class UsageData < Docker::Internal::Type::BaseModel
        # @!attribute ref_count
        ...
        #   Some parameter documentations has been truncated, see
        #   {Docker::Models::Volume::UsageData} for more details.
        #
        #   Usage details about the volume. This information is used by the `GET /system/df`
        #   endpoint, and omitted in other endpoints.
        #
